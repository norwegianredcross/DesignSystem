import{r as c,j as l}from"./iframe-BagKezlM.js";import{C as oe}from"./Checkbox-c46ZpNA4.js";import{F as ne}from"./index-Ccxk52eI.js";import{V as se}from"./index-DlJoMtjN.js";import"./preload-helper-C1FmrZbK.js";import"./Input-N4joLLuD.js";import"./lite-DaUVFjkg.js";import"./Label-DpgYB1kF.js";import"./index-UUdmfCXh.js";import"./Paragraph-D6aNOb5O.js";import"./floating-ui.react-KqRGCIp5.js";import"./index-CINeIW-J.js";import"./index-BYMxJ67J.js";const F=(e,r)=>{const p=e(),t=!!r(!0).length,o=!!r(!1).length;for(const n of p)n.indeterminate=o&&t,n.checked=!o&&t};function de(e){const{error:r,name:p,onChange:t,value:o=[],disabled:n,readOnly:Y,required:Z}=e||{},[b,I]=c.useState(o),ee=c.useId(),_=c.useId(),D=c.useRef(new Set),O=c.useRef(new Set),g=c.useRef(new Map),h=f=>Array.from(D.current.values()).filter(R=>R.checked===f),S=()=>Array.from(O.current.values());return c.useEffect(()=>{F(S,h)},[b]),{value:b,setValue:I,getCheckboxProps:f=>{const R=typeof f=="string"?{value:f}:f||{},{allowIndeterminate:E=!1,ref:y=void 0,value:m="",...d}=R,ae=a=>{if(a)(E?O:D).current.add(a),g.current.set(m,a),S().length&&F(S,h);else{const s=g.current.get(m);s&&(D.current.delete(s),O.current.delete(s),g.current.delete(m))}y&&(typeof y=="function"?y(a):y.current=a)},te=()=>{const a=Array.from(h(!0),({value:s})=>s);I(a),t==null||t(a,b)},le=()=>{const a=g.current.get(m);if(!a)return;const s=!!a.checked;for(const re of h(!s))re.click()};return{...d,"aria-describedby":`${r?_:""} ${d["aria-describedby"]||""}`.trim()||void 0,"aria-invalid":!!r||d["aria-invalid"],checked:E?void 0:b.includes(m),name:d.name||p||ee,onChange:a=>{var s;(s=d.onChange)==null||s.call(d,a),!a.defaultPrevented&&(E&&le(),te())},ref:ae,value:m,disabled:n||d.disabled,readOnly:Y||d.readOnly,required:Z||d.required}},validationMessageProps:{children:r,hidden:!r,id:_}}}const i=oe,u=ne,X=de;i.displayName="Checkbox";u.displayName="Fieldset";try{i.displayName="Checkbox",i.__docgenInfo={description:"",displayName:"Checkbox",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"string"}},"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},disabled:{defaultValue:null,description:`Disables element
...
}`,...(T=(w=k.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};var G,N,A;v.parameters={...v.parameters,docs:{...(G=v.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(A=(N=v.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};var L,$,H;C.parameters={...C.parameters,docs:{...(L=C.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(H=($=C.parameters)==null?void 0:$.docs)==null?void 0:H.source}}};var U,W,B;V.parameters={...V.parameters,docs:{...(U=V.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Example Group',
  // Renamed
  render: args => {
...
}`,...(Q=(K=z.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const Ve=["Default","WithDescription","Disabled","ReadOnly","CheckboxGroup","Indeterminate"];export{V as CheckboxGroup,x as Default,v as Disabled,z as Indeterminate,C as ReadOnly,k as WithDescription,Ve as __namedExportsOrder,Ce as default};
