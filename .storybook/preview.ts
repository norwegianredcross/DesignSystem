...
      toolbar: {
        icon: 'paintbrush', // ** CHANGED: More thematic icon **
        items: [
...
      toolbar: {
        icon: 'mirror', // ** CHANGED: More thematic icon **
        items: [
...
    },
    options: {
      // ** CHANGED: This creates a much better navigation flow **
      storySort: {
        method: 'alphabetical',
        order: [
          'Designsystem', // Your top-level category
          [
            // Order pages *within* Designsystem
            'Introduksjon',
            'Kom i gang (Getting Started)',
            'Farger (Colors)',
            'Typografi (Typography)',
            'Tilgjengelighet (Accessibility)',
            '*', // All other pages in this category
          ],
          'Components', // Your components category
          '*', // All other top-level categories
        ],
      },
    },
  },
