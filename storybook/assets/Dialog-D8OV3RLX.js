import{j as e}from"./iframe-yuJj-q-m.js";import{useMDXComponents as i}from"./index-BENPqNmu.js";import{M as s,P as d,C as a,a as l,A as t}from"./WithTooltip-SK46ZJ2J-2bbRu1qe.js";import{D as c,P as k,C as g,a as h,W as m,N as j,b as x}from"./Dialog.stories-xTeuLlPZ.js";import"./preload-helper-Dp1pzeXC.js";import"./index-kBCu6VdG.js";import"./index-DyDqdOhL.js";import"./lite-DaUVFjkg.js";import"./button-B5DFRZ-D.js";import"./spinner-Dag5YAuz.js";import"./use-merge-refs-BIg4rOM6.js";import"./index-_ZYWTlG2.js";import"./heading-BQhHti1Z.js";import"./paragraph-Chxt0G_v.js";import"./textfield-Dk_pirts.js";import"./index-Detsxgv5.js";import"./input-CdTGtl3H.js";import"./label-DxNDIOdc.js";import"./textarea-B3GSgIHn.js";function o(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:c}),`
...
\r
    <Dialog.Block>\r
\r
      <Heading data-size="xs">Header</Heading>\r
\r
    </Dialog.Block>\r
\r
    <Dialog.Block>Content</Dialog.Block>\r
\r
    <Dialog.Block>Footer</Dialog.Block>\r
\r
  </Dialog>\r
\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`const dialogRef = useRef<HTMLDialogElement>(null);\r
\r
...\r
\r
<Button onClick={() => dialogRef.current?.showModal()}>Open Dialog</Button>\r
<Dialog ref={dialogRef}>\r
  Content\r
</Dialog>
`})}),`
...
`,e.jsxs(n.p,{children:["For å legge til egen lukk knapp, kan du enten bruke ",e.jsx(n.code,{children:"ref"})," og ",e.jsx(n.code,{children:"Dialog.close()"})," på en knapp du lager selv, eller legge på ",e.jsx(n.code,{children:'data-command="close"'}),` på en knapp inni dialogen.\r
Dersom knappen er tom vil den få et ikon.\r
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`<Dialog>\r
  <Dialog.Block>\r
    <Heading>Header</Heading>\r
  </Dialog.Block>\r
  <Dialog.Block>\r
    <Button data-command="close">Lukk</Button>\r
  </Dialog.Block>\r
</Dialog>
`})}),`
`,e.jsx(n.h2,{id:"eksempler",children:"Eksempler"}),`
`,e.jsx(n.h3,{id:"lukk-ved-klikk-utenfor",children:"Lukk ved klikk utenfor"}),`
`,e.jsxs(n.p,{children:["Vi bruker ",e.jsx(n.code,{children:'closedby="any"'}),` for å lukke dialogen når brukeren klikker utenfor.\r
