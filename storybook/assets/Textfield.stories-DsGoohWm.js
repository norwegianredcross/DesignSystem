import{r as re,j as e}from"./iframe-C1QSOCmb.js";import{T as ae}from"./textfield-DqCsVOm1.js";import{D as te}from"./divider-CAlm6Cl2.js";import{P as ne}from"./paragraph-F1LdzfTX.js";import{B as le}from"./button-iz7om0PE.js";const u=ae;try{u.displayName="Textfield",u.__docgenInfo={description:"",displayName:"Textfield",props:{className:{defaultValue:null,description:"Classname on the wrapper element `Field`",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:{value:"undefined"},description:"Style on the wrapper element `Field`",name:"style",required:!1,type:{name:"CSSProperties"}},label:{defaultValue:null,description:"Label",name:"label",required:!1,type:{name:"ReactNode"}},description:{defaultValue:null,description:"Description",name:"description",required:!1,type:{name:"ReactNode"}},prefix:{defaultValue:null,description:"Prefix",name:"prefix",required:!1,type:{name:"string"}},suffix:{defaultValue:null,description:"Suffix",name:"suffix",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Error message for field",name:"error",required:!1,type:{name:"ReactNode"}},counter:{defaultValue:null,description:"Uses `Field.Counter` to display a character counter\nPass a number to set a limit, or an object to configure the counter",name:"counter",required:!1,type:{name:"number | FieldCounterProps"}},"aria-label":{defaultValue:null,description:`Defines a string value that labels the current element.
...
}`,...(y=(x=a.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var v,k,S;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.source}}};const se=["Default","Multiline","WithAffixes","WithCounter","WithDescription","WithError","Disabled","ReadOnly","Controlled"],pe=Object.freeze(Object.defineProperty({__proto__:null,Controlled:d,Default:r,Disabled:s,Multiline:a,ReadOnly:o,WithAffixes:t,WithCounter:n,WithDescription:l,WithError:i,__namedExportsOrder:se,default:ie},Symbol.toStringTag,{value:"Module"}));export{d as C,s as D,a as M,o as R,pe as T,t as W,n as a,l as b,i as c};
