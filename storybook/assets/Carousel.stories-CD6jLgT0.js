import{r as H,j as v,R as Qe}from"./iframe-Dm7Vn_HN.js";import{B as ft}from"./index-BVQB68o3.js";import{S as Qn}from"./index-DA714vt9.js";import{u as uo}from"./LanguageContext-CnPFEAGK.js";import{S as po,a as fo,b as go,c as mo}from"./Play-Cpxutm_a.js";function ho(e){return Object.prototype.toString.call(e)==="[object Object]"}function gt(e){return ho(e)||Array.isArray(e)}function yo(){return!!(typeof window<"u"&&window.document&&window.document.createElement)}function Ze(e,t){const n=Object.keys(e),o=Object.keys(t);if(n.length!==o.length)return!1;const s=JSON.stringify(Object.keys(e.breakpoints||{})),a=JSON.stringify(Object.keys(t.breakpoints||{}));return s!==a?!1:n.every(r=>{const c=e[r],i=t[r];return typeof c=="function"?`${c}`==`${i}`:!gt(c)||!gt(i)?c===i:Ze(c,i)})}function mt(e){return e.concat().sort((t,n)=>t.name>n.name?1:-1).map(t=>t.options)}function bo(e,t){if(e.length!==t.length)return!1;const n=mt(e),o=mt(t);return n.every((s,a)=>{const r=o[a];return Ze(s,r)})}function et(e){return typeof e=="number"}function Je(e){return typeof e=="string"}function Ve(e){return typeof e=="boolean"}function ht(e){return Object.prototype.toString.call(e)==="[object Object]"}function L(e){return Math.abs(e)}function tt(e){return Math.sign(e)}function Oe(e,t){return L(e-t)}function vo(e,t){if(e===0||t===0||L(e)<=L(t))return 0;const n=Oe(L(e),L(t));return L(n/e)}function wo(e){return Math.round(e*100)/100}function _e(e){return $e(e).map(Number)}function te(e){return e[qe(e)]}function qe(e){return Math.max(0,e.length-1)}function nt(e,t){return t===qe(e)}function yt(e,t=0){return Array.from(Array(e),(n,o)=>t+o)}function $e(e){return Object.keys(e)}function Jn(e,t){return[e,t].reduce((n,o)=>($e(o).forEach(s=>{const a=n[s],r=o[s],c=ht(a)&&ht(r);n[s]=c?Jn(a,r):r}),n),{})}function Ye(e,t){return typeof t.MouseEvent<"u"&&e instanceof t.MouseEvent}function xo(e,t){const n={start:o,center:s,end:a};function o(){return 0}function s(i){return a(i)/2}function a(i){return t-i}function r(i,l){return Je(e)?n[e](i):e(t,i,l)}return{measure:r}}function Ne(){let e=[];function t(s,a,r,c={passive:!0}){let i;if("addEventListener"in s)s.addEventListener(a,r,c),i=()=>s.removeEventListener(a,r,c);else{const l=s;l.addListener(r),i=()=>l.removeListener(r)}return e.push(i),o}function n(){e=e.filter(s=>s())}const o={add:t,clear:n};return o}function Ao(e,t,n,o){const s=Ne(),a=1e3/60;let r=null,c=0,i=0;function l(){s.add(e,"visibilitychange",()=>{e.hidden&&f()})}function h(){y(),s.clear()}function p(u){if(!i)return;r||(r=u,n(),n());const d=u-r;for(r=u,c+=d;c>=a;)n(),c-=a;const b=c/a;o(b),i&&(i=t.requestAnimationFrame(p))}function g(){i||(i=t.requestAnimationFrame(p))}function y(){t.cancelAnimationFrame(i),r=null,c=0,i=0}function f(){r=null,c=0}return{init:l,destroy:h,start:g,stop:y,update:n,render:o}}function So(e,t){const n=t==="rtl",o=e==="y",s=o?"y":"x",a=o?"x":"y",r=!o&&n?-1:1,c=h(),i=p();function l(f){const{height:m,width:u}=f;return o?m:u}function h(){return o?"top":n?"right":"left"}function p(){return o?"bottom":n?"left":"right"}function g(f){return f*r}return{scroll:s,cross:a,startEdge:c,endEdge:i,measureSize:l,direction:g}}function ge(e=0,t=0){const n=L(e-t);function o(l){return l<e}function s(l){return l>t}function a(l){return o(l)||s(l)}function r(l){return a(l)?o(l)?e:t:l}function c(l){return n?l-n*Math.ceil((l-t)/n):l}return{length:n,max:t,min:e,constrain:r,reachedAny:a,reachedMax:s,reachedMin:o,removeOffset:c}}function Yn(e,t,n){const{constrain:o}=ge(0,e),s=e+1;let a=r(t);function r(g){return n?L((s+g)%s):o(g)}function c(){return a}function i(g){return a=r(g),p}function l(g){return h().set(c()+g)}function h(){return Yn(e,c(),n)}const p={get:c,set:i,add:l,clone:h};return p}function Bo(e,t,n,o,s,a,r,c,i,l,h,p,g,y,f,m,u,d,b){const{cross:A,direction:D}=e,R=["INPUT","SELECT","TEXTAREA"],I={passive:!1},B=Ne(),E=Ne(),C=ge(50,225).constrain(y.measure(20)),O={mouse:300,touch:400},k={mouse:500,touch:600},V=f?43:25;let q=!1,K=0,X=0,re=!1,U=!1,Z=!1,ee=!1;function le(x){if(!b)return;function j(T){(Ve(b)||b(x,T))&&se(T)}const S=t;B.add(S,"dragstart",T=>T.preventDefault(),I).add(S,"touchmove",()=>{},I).add(S,"touchend",()=>{}).add(S,"touchstart",j).add(S,"mousedown",j).add(S,"touchcancel",z).add(S,"contextmenu",z).add(S,"click",J,!0)}function Q(){B.clear(),E.clear()}function ae(){const x=ee?n:t;E.add(x,"touchmove",G,I).add(x,"touchend",z).add(x,"mousemove",G,I).add(x,"mouseup",z)}function oe(x){const j=x.nodeName||"";return R.includes(j)}function W(){return(f?k:O)[ee?"mouse":"touch"]}function de(x,j){const S=p.add(tt(x)*-1),T=h.byDistance(x,!f).distance;return f||L(x)<C?T:u&&j?T*.5:h.byIndex(S.get(),0).distance}function se(x){const j=Ye(x,o);ee=j,Z=f&&j&&!x.buttons&&q,q=Oe(s.get(),r.get())>=2,!(j&&x.button!==0)&&(oe(x.target)||(re=!0,a.pointerDown(x),l.useFriction(0).useDuration(0),s.set(r),ae(),K=a.readPoint(x),X=a.readPoint(x,A),g.emit("pointerDown")))}function G(x){if(!Ye(x,o)&&x.touches.length>=2)return z(x);const S=a.readPoint(x),T=a.readPoint(x,A),P=Oe(S,K),ie=Oe(T,X);if(!U&&!ee&&(!x.cancelable||(U=P>ie,!U)))return z(x);const pe=a.pointerMove(x);P>m&&(Z=!0),l.useFriction(.3).useDuration(.75),c.start(),s.add(D(pe)),x.preventDefault()}function z(x){const S=h.byDistance(0,!1).index!==p.get(),T=a.pointerUp(x)*W(),P=de(D(T),S),ie=vo(T,P),pe=V-10*ie,ue=d+ie/50;U=!1,re=!1,E.clear(),l.useDuration(pe).useFriction(ue),i.distance(P,!f),ee=!1,g.emit("pointerUp")}function J(x){Z&&(x.stopPropagation(),x.preventDefault(),Z=!1)}function M(){return re}return{init:le,destroy:Q,pointerDown:M}}function To(e,t){let o,s;function a(p){return p.timeStamp}function r(p,g){const f=`client${(g||e.scroll)==="x"?"X":"Y"}`;return(Ye(p,t)?p:p.touches[0])[f]}function c(p){return o=p,s=p,r(p)}function i(p){const g=r(p)-r(s),y=a(p)-a(o)>170;return s=p,y&&(o=p),g}function l(p){if(!o||!s)return 0;const g=r(s)-r(o),y=a(p)-a(o),f=a(p)-a(s)>170,m=g/y;return y&&!f&&L(m)>.1?m:0}return{pointerDown:c,pointerMove:i,pointerUp:l,readPoint:r}}function Eo(){function e(n){const{offsetTop:o,offsetLeft:s,offsetWidth:a,offsetHeight:r}=n;return{top:o,right:s+a,bottom:o+r,left:s,width:a,height:r}}return{measure:e}}function Do(e){function t(o){return e*(o/100)}return{measure:t}}function Io(e,t,n,o,s,a,r){const c=[e].concat(o);let i,l,h=[],p=!1;function g(u){return s.measureSize(r.measure(u))}function y(u){if(!a)return;l=g(e),h=o.map(g);function d(b){for(const A of b){if(p)return;const D=A.target===e,R=o.indexOf(A.target),I=D?l:h[R],B=g(D?e:o[R]);if(L(B-I)>=.5){u.reInit(),t.emit("resize");break}}}i=new ResizeObserver(b=>{(Ve(a)||a(u,b))&&d(b)}),n.requestAnimationFrame(()=>{c.forEach(b=>i.observe(b))})}function f(){p=!0,i&&i.disconnect()}return{init:y,destroy:f}}function Co(e,t,n,o,s,a){let r=0,c=0,i=s,l=a,h=e.get(),p=0;function g(){const I=o.get()-e.get(),B=!i;let E=0;return B?(r=0,n.set(o),e.set(o),E=I):(n.set(e),r+=I/i,r*=l,h+=r,e.add(r),E=h-p),c=tt(E),p=h,R}function y(){const I=o.get()-t.get();return L(I)<.001}function f(){return i}function m(){return c}function u(){return r}function d(){return A(s)}function b(){return D(a)}function A(I){return i=I,R}function D(I){return l=I,R}const R={direction:m,duration:f,velocity:u,seek:g,settled:y,useBaseFriction:b,useBaseDuration:d,useFriction:D,useDuration:A};return R}function ko(e,t,n,o,s){const a=s.measure(10),r=s.measure(50),c=ge(.1,.99);let i=!1;function l(){return!(i||!e.reachedAny(n.get())||!e.reachedAny(t.get()))}function h(y){if(!l())return;const f=e.reachedMin(t.get())?"min":"max",m=L(e[f]-t.get()),u=n.get()-t.get(),d=c.constrain(m/r);n.subtract(u*d),!y&&L(u)<a&&(n.set(e.constrain(n.get())),o.useDuration(25).useBaseFriction())}function p(y){i=!y}return{shouldConstrain:l,constrain:h,toggleActive:p}}function jo(e,t,n,o,s){const a=ge(-t+e,0),r=p(),c=h(),i=g();function l(f,m){return Oe(f,m)<=1}function h(){const f=r[0],m=te(r),u=r.lastIndexOf(f),d=r.indexOf(m)+1;return ge(u,d)}function p(){return n.map((f,m)=>{const{min:u,max:d}=a,b=a.constrain(f),A=!m,D=nt(n,m);return A?d:D||l(u,b)?u:l(d,b)?d:b}).map(f=>parseFloat(f.toFixed(3)))}function g(){if(t<=e+s)return[a.max];if(o==="keepSnaps")return r;const{min:f,max:m}=c;return r.slice(f,m)}return{snapsContained:i,scrollContainLimit:c}}function Ro(e,t,n){const o=t[0],s=n?o-e:te(t);return{limit:ge(s,o)}}function Po(e,t,n,o){const a=t.min+.1,r=t.max+.1,{reachedMin:c,reachedMax:i}=ge(a,r);function l(g){return g===1?i(n.get()):g===-1?c(n.get()):!1}function h(g){if(!l(g))return;const y=e*(g*-1);o.forEach(f=>f.add(y))}return{loop:h}}function Fo(e){const{max:t,length:n}=e;function o(a){const r=a-t;return n?r/-n:0}return{get:o}}function Ho(e,t,n,o,s){const{startEdge:a,endEdge:r}=e,{groupSlides:c}=s,i=p().map(t.measure),l=g(),h=y();function p(){return c(o).map(m=>te(m)[r]-m[0][a]).map(L)}function g(){return o.map(m=>n[a]-m[a]).map(m=>-L(m))}function y(){return c(l).map(m=>m[0]).map((m,u)=>m+i[u])}return{snaps:l,snapsAligned:h}}function Lo(e,t,n,o,s,a){const{groupSlides:r}=s,{min:c,max:i}=o,l=h();function h(){const g=r(a),y=!e||t==="keepSnaps";return n.length===1?[a]:y?g:g.slice(c,i).map((f,m,u)=>{const d=!m,b=nt(u,m);if(d){const A=te(u[0])+1;return yt(A)}if(b){const A=qe(a)-te(u)[0]+1;return yt(A,te(u)[0])}return f})}return{slideRegistry:l}}function Oo(e,t,n,o,s){const{reachedAny:a,removeOffset:r,constrain:c}=o;function i(f){return f.concat().sort((m,u)=>L(m)-L(u))[0]}function l(f){const m=e?r(f):c(f),u=t.map((b,A)=>({diff:h(b-m,0),index:A})).sort((b,A)=>L(b.diff)-L(A.diff)),{index:d}=u[0];return{index:d,distance:m}}function h(f,m){const u=[f,f+n,f-n];if(!e)return f;if(!m)return i(u);const d=u.filter(b=>tt(b)===m);return d.length?i(d):te(u)-n}function p(f,m){const u=t[f]-s.get(),d=h(u,m);return{index:f,distance:d}}function g(f,m){const u=s.get()+f,{index:d,distance:b}=l(u),A=!e&&a(u);if(!m||A)return{index:d,distance:f};const D=t[d]-b,R=f+h(D,0);return{index:d,distance:R}}return{byDistance:g,byIndex:p,shortcut:h}}function _o(e,t,n,o,s,a,r){function c(p){const g=p.distance,y=p.index!==t.get();a.add(g),g&&(o.duration()?e.start():(e.update(),e.render(1),e.update())),y&&(n.set(t.get()),t.set(p.index),r.emit("select"))}function i(p,g){const y=s.byDistance(p,g);c(y)}function l(p,g){const y=t.clone().set(p),f=s.byIndex(y.get(),g);c(f)}return{distance:i,index:l}}function $o(e,t,n,o,s,a,r,c){const i={passive:!0,capture:!0};let l=0;function h(y){if(!c)return;function f(m){if(new Date().getTime()-l>10)return;r.emit("slideFocusStart"),e.scrollLeft=0;const b=n.findIndex(A=>A.includes(m));et(b)&&(s.useDuration(0),o.index(b,0),r.emit("slideFocus"))}a.add(document,"keydown",p,!1),t.forEach((m,u)=>{a.add(m,"focus",d=>{(Ve(c)||c(y,d))&&f(u)},i)})}function p(y){y.code==="Tab"&&(l=new Date().getTime())}return{init:h}}function Pe(e){let t=e;function n(){return t}function o(i){t=r(i)}function s(i){t+=r(i)}function a(i){t-=r(i)}function r(i){return et(i)?i:i.get()}return{get:n,set:o,add:s,subtract:a}}function Zn(e,t){const n=e.scroll==="x"?r:c,o=t.style;let s=null,a=!1;function r(g){return`translate3d(${g}px,0px,0px)`}function c(g){return`translate3d(0px,${g}px,0px)`}function i(g){if(a)return;const y=wo(e.direction(g));y!==s&&(o.transform=n(y),s=y)}function l(g){a=!g}function h(){a||(o.transform="",t.getAttribute("style")||t.removeAttribute("style"))}return{clear:h,to:i,toggleActive:l}}function No(e,t,n,o,s,a,r,c,i){const h=_e(s),p=_e(s).reverse(),g=d().concat(b());function y(B,E){return B.reduce((C,O)=>C-s[O],E)}function f(B,E){return B.reduce((C,O)=>y(C,E)>0?C.concat([O]):C,[])}function m(B){return a.map((E,C)=>({start:E-o[C]+.5+B,end:E+t-.5+B}))}function u(B,E,C){const O=m(E);return B.map(k=>{const V=C?0:-n,q=C?n:0,K=C?"end":"start",X=O[k][K];return{index:k,loopPoint:X,slideLocation:Pe(-1),translate:Zn(e,i[k]),target:()=>c.get()>X?V:q}})}function d(){const B=r[0],E=f(p,B);return u(E,n,!1)}function b(){const B=t-r[0]-1,E=f(h,B);return u(E,-n,!0)}function A(){return g.every(({index:B})=>{const E=h.filter(C=>C!==B);return y(E,t)<=.1})}function D(){g.forEach(B=>{const{target:E,translate:C,slideLocation:O}=B,k=E();k!==O.get()&&(C.to(k),O.set(k))})}function R(){g.forEach(B=>B.translate.clear())}return{canLoop:A,clear:R,loop:D,loopPoints:g}}function qo(e,t,n){let o,s=!1;function a(i){if(!n)return;function l(h){for(const p of h)if(p.type==="childList"){i.reInit(),t.emit("slidesChanged");break}}o=new MutationObserver(h=>{s||(Ve(n)||n(i,h))&&l(h)}),o.observe(e,{childList:!0})}function r(){o&&o.disconnect(),s=!0}return{init:a,destroy:r}}function zo(e,t,n,o){const s={};let a=null,r=null,c,i=!1;function l(){c=new IntersectionObserver(f=>{i||(f.forEach(m=>{const u=t.indexOf(m.target);s[u]=m}),a=null,r=null,n.emit("slidesInView"))},{root:e.parentElement,threshold:o}),t.forEach(f=>c.observe(f))}function h(){c&&c.disconnect(),i=!0}function p(f){return $e(s).reduce((m,u)=>{const d=parseInt(u),{isIntersecting:b}=s[d];return(f&&b||!f&&!b)&&m.push(d),m},[])}function g(f=!0){if(f&&a)return a;if(!f&&r)return r;const m=p(f);return f&&(a=m),f||(r=m),m}return{init:l,destroy:h,get:g}}function Mo(e,t,n,o,s,a){const{measureSize:r,startEdge:c,endEdge:i}=e,l=n[0]&&s,h=f(),p=m(),g=n.map(r),y=u();function f(){if(!l)return 0;const b=n[0];return L(t[c]-b[c])}function m(){if(!l)return 0;const b=a.getComputedStyle(te(o));return parseFloat(b.getPropertyValue(`margin-${i}`))}function u(){return n.map((b,A,D)=>{const R=!A,I=nt(D,A);return R?g[A]+h:I?g[A]+p:D[A+1][c]-b[c]}).map(L)}return{slideSizes:g,slideSizesWithGaps:y,startGap:h,endGap:p}}function Vo(e,t,n,o,s,a,r,c,i){const{startEdge:l,endEdge:h,direction:p}=e,g=et(n);function y(d,b){return _e(d).filter(A=>A%b===0).map(A=>d.slice(A,A+b))}function f(d){return d.length?_e(d).reduce((b,A,D)=>{const R=te(b)||0,I=R===0,B=A===qe(d),E=s[l]-a[R][l],C=s[l]-a[A][h],O=!o&&I?p(r):0,k=!o&&B?p(c):0,V=L(C-k-(E+O));return D&&V>t+i&&b.push(A),B&&b.push(d.length),b},[]).map((b,A,D)=>{const R=Math.max(D[A-1]||0);return d.slice(R,b)}):[]}function m(d){return g?y(d,n):f(d)}return{groupSlides:m}}function Go(e,t,n,o,s,a,r){const{align:c,axis:i,direction:l,startIndex:h,loop:p,duration:g,dragFree:y,dragThreshold:f,inViewThreshold:m,slidesToScroll:u,skipSnaps:d,containScroll:b,watchResize:A,watchSlides:D,watchDrag:R,watchFocus:I}=a,B=2,E=Eo(),C=E.measure(t),O=n.map(E.measure),k=So(i,l),V=k.measureSize(C),q=Do(V),K=xo(c,V),X=!p&&!!b,re=p||!!b,{slideSizes:U,slideSizesWithGaps:Z,startGap:ee,endGap:le}=Mo(k,C,O,n,re,s),Q=Vo(k,V,u,p,C,O,ee,le,B),{snaps:ae,snapsAligned:oe}=Ho(k,K,C,O,Q),W=-te(ae)+te(Z),{snapsContained:de,scrollContainLimit:se}=jo(V,W,oe,b,B),G=X?de:oe,{limit:z}=Ro(W,G,p),J=Yn(qe(G),h,p),M=J.clone(),F=_e(n),x=({dragHandler:he,scrollBody:Ke,scrollBounds:Xe,options:{loop:ze}})=>{ze||Xe.constrain(he.pointerDown()),Ke.seek()},j=({scrollBody:he,translate:Ke,location:Xe,offsetLocation:ze,previousLocation:no,scrollLooper:oo,slideLooper:so,dragHandler:ro,animation:ao,eventHandler:it,scrollBounds:io,options:{loop:ct}},lt)=>{const ut=he.settled(),co=!io.shouldConstrain(),dt=ct?ut:ut&&co,pt=dt&&!ro.pointerDown();pt&&ao.stop();const lo=Xe.get()*lt+no.get()*(1-lt);ze.set(lo),ct&&(oo.loop(he.direction()),so.loop()),Ke.to(ze.get()),pt&&it.emit("settle"),dt||it.emit("scroll")},S=Ao(o,s,()=>x(We),he=>j(We,he)),T=.68,P=G[J.get()],ie=Pe(P),pe=Pe(P),ue=Pe(P),fe=Pe(P),Re=Co(ie,ue,pe,fe,g,T),Ge=Oo(p,G,W,z,fe),Ue=_o(S,J,M,Re,Ge,fe,r),st=Fo(z),rt=Ne(),eo=zo(t,n,r,m),{slideRegistry:at}=Lo(X,b,G,se,Q,F),to=$o(e,n,at,Ue,Re,rt,r,I),We={ownerDocument:o,ownerWindow:s,eventHandler:r,containerRect:C,slideRects:O,animation:S,axis:k,dragHandler:Bo(k,e,o,s,fe,To(k,s),ie,S,Ue,Re,Ge,J,r,q,y,f,d,T,R),eventStore:rt,percentOfView:q,index:J,indexPrevious:M,limit:z,location:ie,offsetLocation:ue,previousLocation:pe,options:a,resizeHandler:Io(t,r,s,n,k,A,E),scrollBody:Re,scrollBounds:ko(z,ue,fe,Re,q),scrollLooper:Po(W,z,ue,[ie,ue,pe,fe]),scrollProgress:st,scrollSnapList:G.map(st.get),scrollSnaps:G,scrollTarget:Ge,scrollTo:Ue,slideLooper:No(k,V,W,U,Z,ae,G,ue,n),slideFocus:to,slidesHandler:qo(t,r,D),slidesInView:eo,slideIndexes:F,slideRegistry:at,slidesToScroll:Q,target:fe,translate:Zn(k,t)};return We}function Uo(){let e={},t;function n(l){t=l}function o(l){return e[l]||[]}function s(l){return o(l).forEach(h=>h(t,l)),i}function a(l,h){return e[l]=o(l).concat([h]),i}function r(l,h){return e[l]=o(l).filter(p=>p!==h),i}function c(){e={}}const i={init:n,emit:s,off:r,on:a,clear:c};return i}const Wo={align:"center",axis:"x",container:null,slides:null,containScroll:"trimSnaps",direction:"ltr",slidesToScroll:1,inViewThreshold:0,breakpoints:{},dragFree:!1,dragThreshold:10,loop:!1,skipSnaps:!1,duration:25,startIndex:0,active:!0,watchDrag:!0,watchResize:!0,watchSlides:!0,watchFocus:!0};function Ko(e){function t(a,r){return Jn(a,r||{})}function n(a){const r=a.breakpoints||{},c=$e(r).filter(i=>e.matchMedia(i).matches).map(i=>r[i]).reduce((i,l)=>t(i,l),{});return t(a,c)}function o(a){return a.map(r=>$e(r.breakpoints||{})).reduce((r,c)=>r.concat(c),[]).map(e.matchMedia)}return{mergeOptions:t,optionsAtMedia:n,optionsMediaQueries:o}}function Xo(e){let t=[];function n(a,r){return t=r.filter(({options:c})=>e.optionsAtMedia(c).active!==!1),t.forEach(c=>c.init(a,e)),r.reduce((c,i)=>Object.assign(c,{[i.name]:i}),{})}function o(){t=t.filter(a=>a.destroy())}return{init:n,destroy:o}}function Me(e,t,n){const o=e.ownerDocument,s=o.defaultView,a=Ko(s),r=Xo(a),c=Ne(),i=Uo(),{mergeOptions:l,optionsAtMedia:h,optionsMediaQueries:p}=a,{on:g,off:y,emit:f}=i,m=k;let u=!1,d,b=l(Wo,Me.globalOptions),A=l(b),D=[],R,I,B;function E(){const{container:F,slides:x}=A;I=(Je(F)?e.querySelector(F):F)||e.children[0];const S=Je(x)?I.querySelectorAll(x):x;B=[].slice.call(S||I.children)}function C(F){const x=Go(e,I,B,o,s,F,i);if(F.loop&&!x.slideLooper.canLoop()){const j=Object.assign({},F,{loop:!1});return C(j)}return x}function O(F,x){u||(b=l(b,F),A=h(b),D=x||D,E(),d=C(A),p([b,...D.map(({options:j})=>j)]).forEach(j=>c.add(j,"change",k)),A.active&&(d.translate.to(d.location.get()),d.animation.init(),d.slidesInView.init(),d.slideFocus.init(M),d.eventHandler.init(M),d.resizeHandler.init(M),d.slidesHandler.init(M),d.options.loop&&d.slideLooper.loop(),I.offsetParent&&B.length&&d.dragHandler.init(M),R=r.init(M,D)))}function k(F,x){const j=Q();V(),O(l({startIndex:j},F),x),i.emit("reInit")}function V(){d.dragHandler.destroy(),d.eventStore.clear(),d.translate.clear(),d.slideLooper.clear(),d.resizeHandler.destroy(),d.slidesHandler.destroy(),d.slidesInView.destroy(),d.animation.destroy(),r.destroy(),c.clear()}function q(){u||(u=!0,c.clear(),V(),i.emit("destroy"),i.clear())}function K(F,x,j){!A.active||u||(d.scrollBody.useBaseFriction().useDuration(x===!0?0:A.duration),d.scrollTo.index(F,j||0))}function X(F){const x=d.index.add(1).get();K(x,F,-1)}function re(F){const x=d.index.add(-1).get();K(x,F,1)}function U(){return d.index.add(1).get()!==Q()}function Z(){return d.index.add(-1).get()!==Q()}function ee(){return d.scrollSnapList}function le(){return d.scrollProgress.get(d.offsetLocation.get())}function Q(){return d.index.get()}function ae(){return d.indexPrevious.get()}function oe(){return d.slidesInView.get()}function W(){return d.slidesInView.get(!1)}function de(){return R}function se(){return d}function G(){return e}function z(){return I}function J(){return B}const M={canScrollNext:U,canScrollPrev:Z,containerNode:z,internalEngine:se,destroy:q,off:y,on:g,emit:f,plugins:de,previousScrollSnap:ae,reInit:m,rootNode:G,scrollNext:X,scrollPrev:re,scrollProgress:le,scrollSnapList:ee,scrollTo:K,selectedScrollSnap:Q,slideNodes:J,slidesInView:oe,slidesNotInView:W};return O(t,n),setTimeout(()=>i.emit("init"),0),M}Me.globalOptions=void 0;function ot(e={},t=[]){const n=H.useRef(e),o=H.useRef(t),[s,a]=H.useState(),[r,c]=H.useState(),i=H.useCallback(()=>{s&&s.reInit(n.current,o.current)},[s]);return H.useEffect(()=>{Ze(n.current,e)||(n.current=e,i())},[e,i]),H.useEffect(()=>{bo(o.current,t)||(o.current=t,i())},[t,i]),H.useEffect(()=>{if(yo()&&r){Me.globalOptions=ot.globalOptions;const l=Me(r,n.current,o.current);return a(l),()=>l.destroy()}else a(void 0)},[r,a]),[c,s]}ot.globalOptions=void 0;const Qo="_carouselContainer_1qjfm_5",Jo="_viewport_1qjfm_18",Yo="_slides_1qjfm_24",Zo="_slide_1qjfm_24",es="_slideInner_1qjfm_44",ts="_loaderOverlay_1qjfm_52",ns="_image_1qjfm_62",os="_loaded_1qjfm_73",ss="_loading_1qjfm_77",rs="_empty_1qjfm_85",as="_srOnly_1qjfm_95",is="_controls_1qjfm_107",cs="_arrows_1qjfm_117",ls="_dots_1qjfm_127",us="_playPause_1qjfm_142",ds="_dotGroup_1qjfm_169",ps="_dot_1qjfm_127",fs="_dotActive_1qjfm_200",_={carouselContainer:Qo,viewport:Jo,slides:Yo,slide:Zo,slideInner:es,loaderOverlay:ts,image:ns,loaded:os,loading:ss,empty:rs,srOnly:as,controls:is,arrows:cs,dots:ls,playPause:us,dotGroup:ds,dot:ps,dotActive:fs},N=({images:e,autoPlay:t=!1,autoDelay:n=5,showArrows:o=!0,showDots:s=!0,variant:a,slidesPerView:r=1,slideSpacing:c=16,cornerRadius:i=0,"aria-label":l,crossOrigin:h,"data-color":p,"data-size":g})=>{var j;const{t:y}=uo();H.useEffect(()=>{const S="rk-carousel-inline-styles";if(typeof document>"u"||document.getElementById(S))return;const T=gs(_),P=document.createElement("style");P.id=S,P.textContent=T,document.head.prepend(P)},[]);const f={loop:!0,align:"start",containScroll:"trimSnaps",slidesToScroll:1},[m,u]=ot(f),[d,b]=H.useState(0),[A,D]=H.useState([]),[R,I]=H.useState([]),[B,E]=H.useState([]),C=H.useRef([]),O=(e??[]).map(S=>S.src).join(`
`);H.useEffect(()=>{E((e??[]).map((S,T)=>{const P=C.current[T];return!!(P&&P.complete&&P.naturalWidth>0)}))},[O]);const k=H.useCallback(S=>{E(T=>{if(T[S])return T;const P=[...T];return P[S]=!0,P})},[]),V=H.useMemo(()=>n*1e3,[n]),q=H.useCallback(()=>{u&&(b(u.selectedScrollSnap()),I(u.slidesInView()))},[u]),K=H.useCallback(S=>u&&u.scrollTo(S),[u]),X=H.useCallback(()=>u&&u.scrollPrev(),[u]),re=H.useCallback(()=>u&&u.scrollNext(),[u]);H.useEffect(()=>{if(u)return u.on("select",q),u.on("reInit",q),u.on("slidesInView",q),D(u.scrollSnapList()),I(u.slidesInView()),()=>{u.off("select",q),u.off("reInit",q),u.off("slidesInView",q)}},[u,q]),H.useEffect(()=>{u&&(u.reInit(),D(u.scrollSnapList()))},[u,e,r,c]);const[U,Z]=H.useState(!1),[ee,le]=H.useState(!1),[Q,ae]=H.useState(!1),oe=t&&!U&&!ee&&!Q;H.useEffect(()=>{if(!oe||!u||!e||e.length<=1)return;const S=window.setInterval(()=>{u.canScrollNext()&&u.scrollNext()},V);return()=>{window.clearInterval(S)}},[oe,V,u,e]);const W=Math.max(1,r),de=`${100/W}%`,se=c/2,G=S=>R.length>0?R.includes(S):S<W,z=(e==null?void 0:e.length)??0,J=S=>y("carousel.slideOf").replace("{index}",String(S+1)).replace("{total}",String(z)),M=z>1,F=t&&M,x=s&&M;return v.jsxs("div",{className:_.carouselContainer,role:"region","aria-roledescription":"carousel","aria-label":l??y("carousel.label"),"data-color":p,"data-size":g,"data-variant":a,onMouseEnter:t?()=>le(!0):void 0,onMouseLeave:t?()=>le(!1):void 0,onFocus:t?()=>ae(!0):void 0,onBlur:t?S=>{S.currentTarget.contains(S.relatedTarget)||ae(!1)}:void 0,children:[v.jsx("div",{className:_.viewport,ref:m,children:v.jsx("div",{className:_.slides,style:{marginLeft:`-${se}px`,marginRight:`-${se}px`},children:e&&e.length>0?e.map((S,T)=>v.jsx("div",{className:_.slide,role:"group","aria-roledescription":"slide","aria-label":J(T),"aria-hidden":G(T)?void 0:!0,style:{flex:`0 0 ${de}`,paddingLeft:`${se}px`,paddingRight:`${se}px`,borderRadius:i>0?`${i}px`:void 0,overflow:"hidden"},children:v.jsxs("div",{className:_.slideInner,style:{borderRadius:`${i}px`,overflow:"hidden",position:"relative",width:"100%",height:"100%"},children:[!B[T]&&v.jsx("div",{className:_.loaderOverlay,children:v.jsx(Qn,{"aria-label":y("carousel.loading")})}),v.jsx("img",{ref:P=>{C.current[T]=P},className:`${_.image} ${B[T]?_.loaded:_.loadingImage}`,src:S.src,alt:S.alt,loading:T<W?"eager":"lazy",crossOrigin:h,onLoad:()=>k(T),onError:P=>{P.target.style.display="none",k(T)}})]})},`image-${T}-${S.src}`)):v.jsx("div",{className:_.slide,style:{flex:"0 0 100%"},children:v.jsx("div",{className:_.empty,children:y("carousel.empty")})})})}),M&&v.jsxs("div",{role:"status","aria-live":oe?"off":"polite",className:_.srOnly,children:[J(d),(j=e[d])!=null&&j.alt?`: ${e[d].alt}`:""]}),(o||x||F)&&v.jsxs("div",{className:_.controls,"aria-hidden":"false",children:[o&&v.jsxs("div",{className:_.arrows,children:[v.jsx(ft,{variant:"primary",icon:!0,"aria-label":y("carousel.previousImage"),onClick:X,disabled:!M,children:v.jsx(po,{"aria-hidden":!0})}),v.jsx(ft,{variant:"primary",icon:!0,"aria-label":y("carousel.nextImage"),onClick:re,disabled:!M,children:v.jsx(fo,{"aria-hidden":!0})})]}),(x||F)&&v.jsxs("div",{className:_.dots,children:[F&&v.jsx("button",{type:"button",className:_.playPause,onClick:()=>Z(S=>!S),"aria-label":y(U?"carousel.resumeAutoplay":"carousel.pauseAutoplay"),"aria-pressed":U,children:U?v.jsx(go,{"aria-hidden":!0}):v.jsx(mo,{"aria-hidden":!0})}),x&&v.jsx("div",{className:_.dotGroup,role:"group","aria-label":y("carousel.imagePosition"),children:A.map((S,T)=>{const P=T===d;return v.jsx("button",{type:"button",className:`${_.dot} ${P?_.dotActive:""}`,onClick:()=>K(T),"aria-label":`${y("carousel.goToImage")} ${T+1}`,"aria-current":P||void 0},`dot-${T}`)})})]})]})]})};N.displayName="Carousel";function gs(e){return`
.${e.carouselContainer} {
  position: relative;
  display: block;
  width: 100%;
...
}`,...(Et=(Tt=Fe.parameters)==null?void 0:Tt.docs)==null?void 0:Et.source}}};var Dt,It,Ct;He.parameters={...He.parameters,docs:{...(Dt=He.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
  args: {
    autoPlay: false,
    autoDelay: 4,
    showArrows: true,
...
}`,...(Ct=(It=He.parameters)==null?void 0:It.docs)==null?void 0:Ct.source}}};var kt,jt,Rt,Pt,Ft;ye.parameters={...ye.parameters,docs:{...(kt=ye.parameters)==null?void 0:kt.docs,source:{originalSource:`{
...
}`,...(Rt=(jt=ye.parameters)==null?void 0:jt.docs)==null?void 0:Rt.source},description:{story:"Tests that next/previous arrow buttons navigate between slides.",...(Ft=(Pt=ye.parameters)==null?void 0:Pt.docs)==null?void 0:Ft.description}}};var Ht,Lt,Ot,_t,$t;be.parameters={...be.parameters,docs:{...(Ht=be.parameters)==null?void 0:Ht.docs,source:{originalSource:`{
...
}`,...(Ot=(Lt=be.parameters)==null?void 0:Lt.docs)==null?void 0:Ot.source},description:{story:"Tests that clicking on dots navigates to the corresponding slide.",...($t=(_t=be.parameters)==null?void 0:_t.docs)==null?void 0:$t.description}}};var Nt,qt,zt,Mt,Vt;ve.parameters={...ve.parameters,docs:{...(Nt=ve.parameters)==null?void 0:Nt.docs,source:{originalSource:`{
...
resuming starts it again.`,...(En=(Tn=Ee.parameters)==null?void 0:Tn.docs)==null?void 0:En.description}}};var Dn,In,Cn;Le.parameters={...Le.parameters,docs:{...(Dn=Le.parameters)==null?void 0:Dn.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    try {
      ...
      const [hi = 0, lo = 0] = [luminance(parse(style.color)), luminance(parse(style.backgroundColor))].sort((a, b) => b - a);
...
}`,...(Cn=(In=Le.parameters)==null?void 0:In.docs)==null?void 0:Cn.source}}};var kn,jn,Rn,Pn,Fn;De.parameters={...De.parameters,docs:{...(kn=De.parameters)==null?void 0:kn.docs,source:{originalSource:`{
...
so autoPlay with showDots={false} produced motion nobody could stop.`,...(Fn=(Pn=De.parameters)==null?void 0:Pn.docs)==null?void 0:Fn.description}}};var Hn,Ln,On,_n,$n;Ie.parameters={...Ie.parameters,docs:{...(Hn=Ie.parameters)==null?void 0:Hn.docs,source:{originalSource:`{
...
}`,...(On=(Ln=Ie.parameters)==null?void 0:Ln.docs)==null?void 0:On.source},description:{story:`Tests the APG carousel semantics: a labelled region with the carousel role
...
follows navigation.`,...($n=(_n=Ie.parameters)==null?void 0:_n.docs)==null?void 0:$n.description}}};var Nn,qn,zn,Mn,Vn;Ce.parameters={...Ce.parameters,docs:{...(Nn=Ce.parameters)==null?void 0:Nn.docs,source:{originalSource:`{
...
}`,...(zn=(qn=Ce.parameters)==null?void 0:qn.docs)==null?void 0:zn.source},description:{story:`Regression test: images are plain <img> requests unless the consumer opts
in. crossOrigin="anonymous" used to be forced, which made every image from
a host without CORS headers fail to load.`,...(Vn=(Mn=Ce.parameters)==null?void 0:Mn.docs)==null?void 0:Vn.description}}};var Gn,Un,Wn,Kn,Xn;ke.parameters={...ke.parameters,docs:{...(Gn=ke.parameters)==null?void 0:Gn.docs,source:{originalSource:`{
...
but each button's hit area is at least 24x24 CSS pixels.`,...(Xn=(Kn=ke.parameters)==null?void 0:Kn.docs)==null?void 0:Xn.description}}};const js=Object.freeze(Object.defineProperty({__proto__:null,Default:je,MultipleSlides:Fe,TestArrowNavigation:ye,TestAutoplayPauseControl:Ee,TestCarouselSemantics:Ie,TestControlContrastInDarkMode:Le,TestDotNavigation:be,TestDotTargetSize:ke,TestDotsAccessibility:Be,TestEmptyState:Ae,TestHiddenArrows:we,TestHiddenDots:xe,TestImageAltText:Se,TestNoForcedCrossOrigin:Ce,TestPauseControlWithoutDots:De,TestRerenderKeepsSlides:Te,TestSingleImageDisabledArrows:ve,WithSupabase:He,__namedExportsOrder:Ts,default:bs},Symbol.toStringTag,{value:"Module"}));export{js as C};
