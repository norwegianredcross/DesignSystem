import{r as U,j as e}from"./iframe-ChmhbHcN.js";import{T as a}from"./index-BGZHXd9p.js";import{B as X}from"./tooltip-Dtx4fO_9.js";import{S as Y,a as q,b as G}from"./Newspaper-Ch8ghdUC.js";const{expect:n,within:x,userEvent:J,waitFor:i,fn:Q,fireEvent:u}=__STORYBOOK_MODULE_TEST__,Z={title:"Components/Tabs",component:a,tags:["autodocs"],parameters:{docs:{description:{component:"Tabs allow users to navigate between related sections of content, displaying one section at a time."}},layout:"padded"},argTypes:{defaultValue:{control:"text",description:"Default selected tab value (uncontrolled mode)."},value:{control:"text",description:"Selected tab value (controlled mode).",table:{disable:!0}},onChange:{action:"changed",description:"Callback with selected Tab value.",table:{disable:!0}},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},children:{control:!1}}},b={render:t=>e.jsxs(a,{...t,children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"value1",children:"Tab 1"}),e.jsx(a.Tab,{value:"value2",children:"Tab 2"}),e.jsx(a.Tab,{value:"value3",children:"Tab 3"})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Tab 1"}),e.jsx(a.Panel,{value:"value2",children:"Content for Tab 2"}),e.jsx(a.Panel,{value:"value3",children:"Content for Tab 3"})]}),args:{defaultValue:"value1","data-size":"md","data-color":"neutral"}},v={render:t=>e.jsxs(a,{...t,children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"value1","aria-label":"Airplane",children:e.jsx(Y,{"aria-hidden":!0})}),e.jsx(a.Tab,{value:"value2","aria-label":"Newspaper",children:e.jsx(q,{"aria-hidden":!0})}),e.jsx(a.Tab,{value:"value3","aria-label":"Dog",children:e.jsx(G,{"aria-hidden":!0})})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Airplane"}),e.jsx(a.Panel,{value:"value2",children:"Content for Newspaper"}),e.jsx(a.Panel,{value:"value3",children:"Content for Dog"})]}),args:{defaultValue:"value1","data-size":"md","data-color":"primary-color-red"},name:"Icons Only"},d={render:t=>{const[r,s]=U.useState("value1");return e.jsxs(e.Fragment,{children:[e.jsx(X,{"data-size":"sm",onClick:()=>s("value3"),style:{marginBottom:"1rem"},children:"Choose Tab 3"}),e.jsxs(a,{...t,value:r,onChange:s,children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"value1",children:"Tab 1"}),e.jsx(a.Tab,{value:"value2",children:"Tab 2"}),e.jsx(a.Tab,{value:"value3",children:"Tab 3"})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Tab 1 (Controlled)"}),e.jsx(a.Panel,{value:"value2",children:"Content for Tab 2 (Controlled)"}),e.jsx(a.Panel,{value:"value3",children:"Content for Tab 3 (Controlled)"})]})]})},args:{"data-size":"md","data-color":"secondary-color-rust"}},T={render:t=>e.jsxs(a,{...t,children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"value1",children:"Large Tab 1"}),e.jsx(a.Tab,{value:"value2",children:"Large Tab 2"})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Large Tab 1"}),e.jsx(a.Panel,{value:"value2",children:"Content for Large Tab 2"})]}),args:{defaultValue:"value1","data-size":"lg","data-color":"neutral"},name:"Large Size"},m={render:t=>e.jsxs(a,{...t,children:[e.jsxs(a.List,{children:[e.jsxs(a.Tab,{value:"value1",children:[e.jsx(Y,{"aria-hidden":!0,style:{marginRight:6}}),"Fly"]}),e.jsxs(a.Tab,{value:"value2",children:[e.jsx(q,{"aria-hidden":!0,style:{marginRight:6}}),"Nyheter"]}),e.jsxs(a.Tab,{value:"value3",children:[e.jsx(G,{"aria-hidden":!0,style:{marginRight:6}}),"Hund"]})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Fly"}),e.jsx(a.Panel,{value:"value2",children:"Content for Nyheter"}),e.jsx(a.Panel,{value:"value3",children:"Content for Hund"})]}),args:{defaultValue:"value1","data-size":"md","data-color":"neutral"},name:"Icons with Text"},g={name:"Test: Interaction",render:()=>e.jsxs(a,{defaultValue:"value1",children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"value1",children:"Tab 1"}),e.jsx(a.Tab,{value:"value2",children:"Tab 2"}),e.jsx(a.Tab,{value:"value3",children:"Tab 3"})]}),e.jsx(a.Panel,{value:"value1",children:"Content for Tab 1"}),e.jsx(a.Panel,{value:"value2",children:"Content for Tab 2"}),e.jsx(a.Panel,{value:"value3",children:"Content for Tab 3"})]}),play:async({canvasElement:t})=>{const r=x(t);n(r.getByText("Content for Tab 1")).toBeVisible();const s=r.getByRole("tab",{name:/tab 1/i});n(s).toHaveAttribute("aria-selected","true");const l=r.getByRole("tab",{name:/tab 2/i});await J.click(l),await i(()=>{n(l).toHaveAttribute("aria-selected","true")}),n(s).toHaveAttribute("aria-selected","false"),n(r.getByText("Content for Tab 2")).toBeVisible()}},h={name:"Test: Aria Wiring And Keyboard Navigation",render:t=>e.jsxs(a,{...t,defaultValue:"overview",children:[e.jsxs(a.List,{"aria-label":"Saksinformasjon",children:[e.jsx(a.Tab,{value:"overview",children:"Oversikt"}),e.jsx(a.Tab,{value:"activity",children:"Aktivitet"}),e.jsx(a.Tab,{value:"documents",children:"Dokumenter"})]}),e.jsx(a.Panel,{value:"overview",children:"Innhold: oversikt"}),e.jsx(a.Panel,{value:"activity",children:"Innhold: aktivitet"}),e.jsx(a.Panel,{value:"documents",children:"Innhold: dokumenter"})]}),args:{onChange:Q()},play:async({canvasElement:t,args:r})=>{const s=x(t);n(s.getByRole("tablist",{name:"Saksinformasjon"})).toBeInTheDocument();const l=s.getByRole("tab",{name:"Oversikt"}),o=s.getByRole("tab",{name:"Aktivitet"}),c=s.getByRole("tab",{name:"Dokumenter"}),y=s.getByRole("tabpanel",{name:"Oversikt"});n(l).toHaveAttribute("aria-controls",y.id),n(y).toHaveAttribute("aria-labelledby",l.id),n(l).toHaveAttribute("aria-selected","true"),l.focus(),await u.keyDown(l,{key:"ArrowRight"}),await i(()=>{n(o).toHaveFocus()}),n(l).toHaveAttribute("aria-selected","true"),n(r.onChange).not.toHaveBeenCalled(),await u.keyDown(o,{key:"Enter"}),await i(()=>n(o).toHaveAttribute("aria-selected","true")),n(r.onChange).toHaveBeenLastCalledWith("activity"),n(s.getByRole("tabpanel",{name:"Aktivitet"})).toBeVisible(),await u.keyDown(o,{key:"End"}),await i(()=>n(c).toHaveFocus()),n(o).toHaveAttribute("aria-selected","true"),await u.keyDown(c,{key:" "}),await i(()=>n(c).toHaveAttribute("aria-selected","true")),n(r.onChange).toHaveBeenLastCalledWith("documents"),await u.keyDown(c,{key:"ArrowRight"}),await i(()=>n(l).toHaveFocus()),n(c).toHaveAttribute("aria-selected","true"),await u.keyDown(l,{key:"Enter"}),await i(()=>n(l).toHaveAttribute("aria-selected","true")),n(r.onChange).toHaveBeenCalledTimes(3)}},p={name:"Test: Controlled Selection",render:t=>{const[r,s]=U.useState("one");return e.jsxs(a,{...t,value:r,onChange:l=>{var o;(o=t.onChange)==null||o.call(t,l),s(l)},children:[e.jsxs(a.List,{children:[e.jsx(a.Tab,{value:"one",children:"Ett"}),e.jsx(a.Tab,{value:"two",children:"To"})]}),e.jsx(a.Panel,{value:"one",children:"Første panel"}),e.jsx(a.Panel,{value:"two",children:"Andre panel"})]})},args:{onChange:Q()},play:async({canvasElement:t,args:r})=>{const s=x(t),l=s.getByRole("tab",{name:"To"});await J.click(l),await i(()=>{n(l).toHaveAttribute("aria-selected","true"),n(s.getByText("Andre panel")).toBeVisible()}),n(r.onChange).toHaveBeenCalledTimes(1),n(r.onChange).toHaveBeenCalledWith("two")}},$=["Default","IconsOnly","Controlled","LargeSize","IconsWithText","TestInteraction","TestAriaWiringAndKeyboardNavigation","TestControlledSelection"];var w,C,f;b.parameters={...b.parameters,docs:{...(w=b.parameters)==null?void 0:w.docs,source:{originalSource:`{
