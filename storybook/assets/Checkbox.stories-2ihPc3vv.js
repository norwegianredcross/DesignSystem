import{r as c,j as l}from"./iframe-DBDi7EGQ.js";import{C as oe}from"./checkbox-C3vChmmq.js";import{F as ne}from"./index-CqeHyGqw.js";import{V as se}from"./index-G1VDXBmN.js";const F=(e,r)=>{const p=e(),t=!!r(!0).length,o=!!r(!1).length;for(const n of p)n.indeterminate=o&&t,n.checked=!o&&t};function de(e){const{error:r,name:p,onChange:t,value:o=[],disabled:n,readOnly:Y,required:Z}=e||{},[C,E]=c.useState(o),ee=c.useId(),I=c.useId(),D=c.useRef(new Set),O=c.useRef(new Set),v=c.useRef(new Map),V=f=>Array.from(D.current.values()).filter(R=>R.checked===f),S=()=>Array.from(O.current.values());return c.useEffect(()=>{F(S,V)},[C]),{value:C,setValue:E,getCheckboxProps:f=>{const R=typeof f=="string"?{value:f}:f||{},{allowIndeterminate:_=!1,ref:z=void 0,value:m="",...d}=R,ae=a=>{if(a)(_?O:D).current.add(a),v.current.set(m,a),S().length&&F(S,V);else{const s=v.current.get(m);s&&(D.current.delete(s),O.current.delete(s),v.current.delete(m))}z&&(typeof z=="function"?z(a):z.current=a)},te=()=>{const a=Array.from(V(!0),({value:s})=>s);E(a),t==null||t(a,C)},le=()=>{const a=v.current.get(m);if(!a)return;const s=!!a.checked;for(const re of V(!s))re.click()};return{...d,"aria-describedby":`${r?I:""} ${d["aria-describedby"]||""}`.trim()||void 0,"aria-invalid":!!r||d["aria-invalid"],checked:_?void 0:C.includes(m),name:d.name||p||ee,onChange:a=>{var s;(s=d.onChange)==null||s.call(d,a),!a.defaultPrevented&&(_&&le(),te())},ref:ae,value:m,disabled:n||d.disabled,readOnly:Y||d.readOnly,required:Z||d.required}},validationMessageProps:{children:r,hidden:!r,id:I}}}const i=oe,u=ne,X=de;i.displayName="Checkbox";u.displayName="Fieldset";try{i.displayName="Checkbox",i.__docgenInfo={description:"",displayName:"Checkbox",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
