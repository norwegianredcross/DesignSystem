...
}`,...(K=(N=V.parameters)==null?void 0:N.docs)==null?void 0:K.source}}};var U,z,P;E.parameters={...E.parameters,docs:{...(U=E.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    label: 'Velg dato',
    id: 'suffix-date',
...
}`,...(P=(z=E.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};var q,G,Y;S.parameters={...S.parameters,docs:{...(q=S.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Startdato',
    id: 'disabled-date',
    disabled: true,
...
}`,...(Y=(G=S.parameters)==null?void 0:G.docs)==null?void 0:Y.source}}};var J,Q,X;I.parameters={...I.parameters,docs:{...(J=I.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
...
from the referenced element, and that element keeps its own id.`,...(Be=(we=v.parameters)==null?void 0:we.docs)==null?void 0:Be.description}}};var Ve,Ee,Se,Ie,De;y.parameters={...y.parameters,docs:{...(Ve=y.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
...
}`,...(Se=(Ee=y.parameters)==null?void 0:Ee.docs)==null?void 0:Se.source},description:{story:`Without an id prop the component generates stable ids — never the literal
"undefined-label"/"undefined-desc" — and label/description stay linked.`,...(De=(Ie=y.parameters)==null?void 0:Ie.docs)==null?void 0:De.description}}};var He,Re,je,Ae,Fe;f.parameters={...f.parameters,docs:{...(He=f.parameters)==null?void 0:He.docs,source:{originalSource:`{
...
}`,...(je=(Re=f.parameters)==null?void 0:Re.docs)==null?void 0:je.source},description:{story:"Tests that onChange is called with the formatted value.",...(Fe=(Ae=f.parameters)==null?void 0:Ae.docs)==null?void 0:Fe.description}}};var Le,_e,We,Oe,Me;b.parameters={...b.parameters,docs:{...(Le=b.parameters)==null?void 0:Le.docs,source:{originalSource:`{
...
with rich text had no accessible name.`,...(ot=(rt=T.parameters)==null?void 0:rt.docs)==null?void 0:ot.description}}};const gt=Object.freeze(Object.defineProperty({__proto__:null,Controlled:D,CustomSizeAndColor:I,Default:w,Disabled:S,TestAutoFormatting:u,TestAutoGeneratedIds:y,TestCalendarValidation:g,TestControlledMode:C,TestDisabledState:x,TestErrorState:b,TestEventTargetIntegrity:m,TestExternalAriaLabelledby:v,TestOnChangeCallback:f,TestPreservesInput:p,TestRichLabelIsAssociated:T,TestSuffixClick:h,WithDescription:B,WithError:V,WithSuffix:E,__namedExportsOrder:ct,default:lt},Symbol.toStringTag,{value:"Module"}));export{gt as D,w as a};
