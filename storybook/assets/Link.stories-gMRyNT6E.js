import{j as d}from"./iframe-D-CvsFF9.js";import{L as c}from"./index-CqbHnEZN.js";import{P as T}from"./tooltip-VS67X2YO.js";import{S as C}from"./EnvelopeClosed-a6W7QNpN.js";const{expect:t,within:H}=__STORYBOOK_MODULE_TEST__,j={title:"Components/Link",component:c,tags:["autodocs"],parameters:{docs:{description:{component:"Link is a clickable text or graphic for navigation, based on the anchor tag."}}},argTypes:{children:{control:"text",description:"The content to display inside the link.",defaultValue:"Gå til designsystemet"},href:{control:"text",description:"The URL the link points to.",defaultValue:"https://designsystemet.no/"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"primary-color-red"},asChild:{control:"boolean",description:"Render as child element",defaultValue:!1},target:{control:"text"},rel:{control:"text"}}},a={name:"Example Default",args:{children:"Gå til designsystemet",href:"https://designsystemet.no/"}},O=e=>e==="sm"||e==="md"||e==="lg"?e:void 0,n={name:"Example Link within Text",render:e=>d.jsxs(T,{"data-size":O(e["data-size"]),"data-color":e["data-color"],children:["Vi bruker komponenter fra et"," ",d.jsx(c,{...e,children:"fantastisk designsystem"}),"."]}),args:{children:"fantastisk designsystem",href:"https://designsystemet.no/","data-size":"md","data-color":"neutral"}},o={name:"Example Link with Icon",render:e=>d.jsxs(c,{...e,children:[d.jsx(C,{"aria-hidden":!0,style:{marginRight:"var(--ds-size-1, 4px)",verticalAlign:"middle"}}),e.children," "]}),args:{children:"Kontakt oss",href:"mailto:designsystem@digdir.no","data-size":"md","data-color":"primary-color-red"}},s={name:"Example Large Neutral",args:{children:"Stor nøytral lenke",href:"#","data-size":"lg","data-color":"neutral"}},i={name:"Example External Link",args:{children:"Ekstern Lenke (Ny Fane)",href:"https://www.digdir.no/",target:"_blank",rel:"noopener noreferrer"}},l={name:"Test: Anchor Contract",tags:["!autodocs"],args:{children:"Åpne ekstern ressurs",href:"https://www.digdir.no/",target:"_blank",rel:"noopener noreferrer","data-color":"primary-color-red","data-size":"lg"},play:async({canvasElement:e})=>{const r=H(e).getByRole("link",{name:"Åpne ekstern ressurs"});await t(r).toHaveAttribute("href","https://www.digdir.no/"),await t(r).toHaveAttribute("target","_blank"),await t(r).toHaveAttribute("rel","noopener noreferrer"),await t(r).toHaveAttribute("data-color","primary-color-red"),await t(r).toHaveAttribute("data-size","lg")}},I=["Default","InText","WithIcon","LargeNeutral","External","TestAnchorContract"];var m,p,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...
  render: args => <Paragraph data-size={paragraphSizeOf(args['data-size'])} data-color={args['data-color']}>
...
}`,...(k=(u=n.parameters)==null?void 0:u.docs)==null?void 0:k.source}}};var f,x,y;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...(y=(x=o.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var w,E,b;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(b=(E=s.parameters)==null?void 0:E.docs)==null?void 0:b.source}}};var L,v,z;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(S=(A=l.parameters)==null?void 0:A.docs)==null?void 0:S.source}}};const P=Object.freeze(Object.defineProperty({__proto__:null,Default:a,External:i,InText:n,LargeNeutral:s,TestAnchorContract:l,WithIcon:o,__namedExportsOrder:I,default:j},Symbol.toStringTag,{value:"Module"}));export{i as E,n as I,P as L,o as W,s as a};
