import{r as ae,j as e}from"./iframe-D-CvsFF9.js";import{o as oe,p as re,B as y}from"./tooltip-VS67X2YO.js";import{S as ne,a as se,b as ie,c as v}from"./Video-avri6jBm.js";const n=ae.forwardRef((t,h)=>e.jsx(re,{ref:h,...t}));n.displayName="Badge";const o=oe,{expect:a,within:f}=__STORYBOOK_MODULE_TEST__,de={title:"Components/Badge",component:n,tags:["autodocs"],argTypes:{count:{control:"number",description:"The number to display in the badge"},maxCount:{control:"number",description:'Maximum count before showing "+"'},"data-size":{control:"select",options:["sm","md","lg"],description:"Component size",defaultValue:"md"},variant:{control:"select",options:["base","tinted"],description:"Background color style",defaultValue:"base"},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral","danger","info","success","warning"],description:"Color scheme",defaultValue:"primary-color-red"}}},c={name:"Example Default (Status)",args:{"data-color":"danger"}},l={name:"Example with Count",args:{count:7,"data-color":"primary-color-red"}},m={name:"Example with Max Count",args:{count:150,maxCount:99,"data-color":"neutral"}},g={name:"Example Large Danger Tinted",args:{count:99,"data-size":"lg","data-color":"danger",variant:"tinted"}},u={name:"Example Status Only",args:{"data-color":"success"}},p={name:"Example Floating Over Element",render:t=>e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{count:t.count,maxCount:t.maxCount,"data-size":t["data-size"],variant:t.variant,"data-color":t["data-color"]}),e.jsx("span",{style:{display:"inline-block",width:40,height:40,background:"#eee",borderRadius:"50%",marginLeft:16,marginRight:16,marginTop:16,marginBottom:16}})]}),args:{count:3,"data-color":"info","data-size":"md"}},b={name:"Example On Icon Buttons",render:t=>e.jsxs("div",{style:{display:"flex",gap:"1rem",alignItems:"center"},children:[e.jsx(y,{icon:!0,variant:"tertiary",children:e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{...t,count:1e3,maxCount:99,"data-color":"danger"}),e.jsx(ne,{title:"Innboks",fontSize:"1.5rem"})]})}),e.jsx(y,{icon:!0,variant:"tertiary",children:e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{...t,count:10,"data-color":"danger"}),e.jsx(se,{title:"Meldinger",fontSize:"1.5rem"})]})}),e.jsx(y,{icon:!0,variant:"tertiary",children:e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{...t,"data-color":"danger"}),e.jsx(ie,{title:"Skru på video",fontSize:"1.5rem"})]})})]}),args:{"data-size":"md",variant:"base"},argTypes:{count:{control:!1},maxCount:{control:!1},"data-color":{control:!1}}},x={name:"Example Placements",render:t=>e.jsxs("div",{style:{display:"flex",gap:"2rem",flexWrap:"wrap",padding:"2rem"},children:[e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{...t}),e.jsx(v,{title:"Meldinger",fontSize:"2rem"})]}),e.jsxs(o,{placement:"top-left",children:[e.jsx(n,{...t}),e.jsx(v,{title:"Meldinger",fontSize:"2rem"})]}),e.jsxs(o,{placement:"bottom-right",children:[e.jsx(n,{...t}),e.jsx(v,{title:"Meldinger",fontSize:"2rem"})]}),e.jsxs(o,{placement:"bottom-left",children:[e.jsx(n,{...t}),e.jsx(v,{title:"Meldinger",fontSize:"2rem"})]}),e.jsx("div",{style:{width:"100%",height:"1rem"}}),e.jsxs(o,{placement:"top-right",overlap:"circle",children:[e.jsx(n,{...t}),e.jsx("div",{style:{width:"2rem",height:"2rem",borderRadius:"50%",backgroundColor:"var(--ds-color-brand2-base-default)"}})]}),e.jsxs(o,{placement:"top-left",overlap:"circle",children:[e.jsx(n,{...t}),e.jsx("div",{style:{width:"2rem",height:"2rem",borderRadius:"50%",backgroundColor:"var(--ds-color-brand2-base-default)"}})]}),e.jsxs(o,{placement:"bottom-right",overlap:"circle",children:[e.jsx(n,{...t}),e.jsx("div",{style:{width:"2rem",height:"2rem",borderRadius:"50%",backgroundColor:"var(--ds-color-brand2-base-default)"}})]}),e.jsxs(o,{placement:"bottom-left",overlap:"circle",children:[e.jsx(n,{...t}),e.jsx("div",{style:{width:"2rem",height:"2rem",borderRadius:"50%",backgroundColor:"var(--ds-color-brand2-base-default)"}})]})]}),args:{"data-color":"primary-color-red","data-size":"md"},argTypes:{count:{control:!1},maxCount:{control:!1}}},s={name:"Test: Count And MaxCount Formatting",render:()=>e.jsxs("div",{style:{display:"flex",gap:"1rem",alignItems:"center"},children:[e.jsx("span",{"data-testid":"badge-count",children:e.jsx(n,{count:7,"data-color":"primary-color-red"})}),e.jsx("span",{"data-testid":"badge-capped",children:e.jsx(n,{count:150,maxCount:99,"data-color":"danger"})}),e.jsx("span",{"data-testid":"badge-at-max",children:e.jsx(n,{count:99,maxCount:99,"data-color":"neutral"})}),e.jsx("span",{"data-testid":"badge-dot",children:e.jsx(n,{"data-color":"success"})})]}),play:async({canvasElement:t})=>{const h=f(t),r=d=>h.getByTestId(d).firstElementChild;a(r("badge-count")).toHaveAttribute("data-count","7"),a(r("badge-capped")).toHaveAttribute("data-count","99+"),a(r("badge-at-max")).toHaveAttribute("data-count","99"),a(r("badge-dot")).not.toHaveAttribute("data-count"),a(r("badge-count").textContent).toBe(""),a(r("badge-count")).not.toHaveAttribute("role"),a(r("badge-count")).not.toHaveAttribute("tabindex")}},i={name:"Test: Positioned Badge Accessibility",render:()=>e.jsx(y,{icon:!0,variant:"tertiary","aria-label":"Innboks, 12 uleste meldinger",children:e.jsxs(o,{placement:"top-right",children:[e.jsx(n,{count:12,maxCount:9,"data-color":"danger"}),e.jsx(ne,{title:"Innboks",fontSize:"1.5rem"})]})}),play:async({canvasElement:t})=>{const r=f(t).getByRole("button",{name:"Innboks, 12 uleste meldinger"});a(f(r).getByRole("img",{name:"Innboks"})).toBeInTheDocument();const d=t.querySelector(".ds-badge--position");a(d).toHaveAttribute("data-placement","top-right"),a(d).not.toHaveAttribute("role"),a(d).not.toHaveAttribute("aria-hidden");const B=t.querySelector(".ds-badge");a(B).toHaveAttribute("data-count","9+"),a(B.textContent).toBe(""),a(B).not.toHaveAttribute("aria-hidden")}},ce=["Default","WithCount","WithMaxCount","LargeDangerTinted","StatusOnly","FloatingOverElement","OnIconButtons","Placements","TestCountAndMaxCount","TestPositionedBadgeAccessibility"];var C,j,S;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
