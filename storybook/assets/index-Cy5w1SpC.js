import{r as b,j as s}from"./iframe-IFdhC9hQ.js";const z="_graphicElement_134cx_1",I="_shape_134cx_12",W="_faceFront_134cx_28",T="_faceTop_134cx_32",N="_faceRight_134cx_36",o={graphicElement:z,shape:I,faceFront:W,faceTop:T,faceRight:N};function F(t){return`
.${t.graphicElement} {
...
corner, angle, heart and bar.`,name:"variant",required:!1,type:{name:"enum",value:[{value:'"solid"'},{value:'"outline"'},{value:'"isometric"'}]}},shape:{defaultValue:{value:"corner"},description:`Which graphic element to render. All shapes are derived from
...
Only applies to the isometric heart.`,name:"mirrored",required:!1,type:{name:"boolean"}}}}}catch{}export{h as G};
