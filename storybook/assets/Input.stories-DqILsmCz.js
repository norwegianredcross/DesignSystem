import{r as N,j as e}from"./iframe-D-CvsFF9.js";import{I as t}from"./index-BbjaWRUh.js";import{c as n,P as Y}from"./tooltip-VS67X2YO.js";const{expect:y,within:K,userEvent:q}=__STORYBOOK_MODULE_TEST__,G={title:"Components/Input",component:t,tags:["autodocs"],parameters:{docs:{description:{component:"Input is a basic form element for collecting user data. Use Label for accessibility."}},layout:"padded"},argTypes:{"aria-invalid":{control:"boolean",description:"Indicates an error state for accessibility",defaultValue:!1},disabled:{control:"boolean",description:"Disables element",defaultValue:!1},readOnly:{control:"boolean",description:"Toggle readOnly",defaultValue:!1},type:{control:"select",options:["text","number","email","password","search","tel","url","date","datetime-local","month","week","time","color","file","hidden"],description:"Supported input types",defaultValue:"text"},name:{control:"text",description:"Name attribute for the input"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},size:{control:"number",description:"HTML size attribute (input width in characters)."},value:{control:"text"},placeholder:{control:"text"},id:{control:"text"},"aria-labelledby":{control:"text"}}},i={name:"Example Basic",render:a=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-default-label",htmlFor:"input-default",children:"Input Label"}),e.jsx(t,{id:"input-default","aria-labelledby":"input-default-label",placeholder:"Type something...",...a})]}),args:{type:"text",name:"default-input","data-size":"md"}},r={name:"Example Email Type",render:a=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-email-label",htmlFor:"input-email",children:"Email Address"}),e.jsx(t,{id:"input-email","aria-labelledby":"input-email-label",placeholder:"your.email@example.com",...a})]}),args:{type:"email",name:"email-input","data-size":"md"}},s={name:"Example HTML Size Attribute",render:a=>e.jsxs("div",{children:[e.jsx(n,{id:"input-size-label",htmlFor:"input-size",children:"Input with size=10"}),e.jsx(t,{id:"input-size","aria-labelledby":"input-size-label",...a})]}),args:{type:"text",name:"size-input",size:10,"data-size":"md"}},d={name:"Example Disabled",render:a=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-disabled-label",htmlFor:"input-disabled",children:"Disabled Input"}),e.jsx(t,{id:"input-disabled","aria-labelledby":"input-disabled-label",value:"Cannot edit",...a})]}),args:{type:"text",name:"disabled-input",disabled:!0,"data-size":"md"}},o={name:"Example ReadOnly",render:a=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-readonly-label",htmlFor:"input-readonly",children:"Read Only Input"}),e.jsx(t,{id:"input-readonly","aria-labelledby":"input-readonly-label",value:"Cannot change, but can copy",...a})]}),args:{type:"text",name:"readonly-input",readOnly:!0,"data-size":"md"}},p={name:"Example Invalid State",render:a=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-invalid-label",htmlFor:"input-invalid",children:"Invalid Input"}),e.jsx(t,{id:"input-invalid","aria-labelledby":"input-invalid-label",value:"Incorrect value",...a})]}),args:{type:"text",name:"invalid-input","aria-invalid":!0,"data-size":"md"}},u={name:"Example Controlled",render:a=>{const[b,l]=N.useState("Initial Value");return e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"input-controlled-label",htmlFor:"input-controlled",children:"Kontroller meg!"}),e.jsx(t,{id:"input-controlled","aria-labelledby":"input-controlled-label",value:b,onChange:U=>l(U.target.value),...a}),e.jsxs(Y,{style:{marginTop:"8px"},children:["Du har skrevet inn: ",b]})]})},args:{type:"text",name:"controlled-input","data-size":"md"}},c={name:"Test: Interaction",render:()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"test-input-label",htmlFor:"test-input",children:"Test Input"}),e.jsx(t,{id:"test-input","aria-labelledby":"test-input-label",type:"text",name:"test-input"})]}),play:async({canvasElement:a})=>{const l=K(a).getByRole("textbox",{name:/test input/i});y(l).toBeInTheDocument(),await q.type(l,"Hello World"),y(l).toHaveValue("Hello World")}},m={name:"Test: Disabled State",render:()=>e.jsxs(e.Fragment,{children:[e.jsx(n,{id:"test-input-disabled-label",htmlFor:"test-input-disabled",children:"Disabled Input"}),e.jsx(t,{id:"test-input-disabled","aria-labelledby":"test-input-disabled-label",disabled:!0,value:"Cannot edit"})]}),play:async({canvasElement:a})=>{const l=K(a).getByRole("textbox",{name:/disabled input/i});y(l).toBeDisabled()}},J=["Default","EmailType","HtmlSize","Disabled","ReadOnly","Invalid","Controlled","TestInteraction","TestDisabledState"];var x,g,h;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Example Basic',
  render: args => <>
...
}`,...(P=(M=c.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};var k,A,W;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
