import{r as re,j as e}from"./iframe-CPHme1m9.js";import{T as ae}from"./textfield-By1KVakp.js";import{D as te}from"./divider-CtRCEpoc.js";import{P as ne}from"./paragraph-CqJMYiw6.js";import{B as le}from"./button-DkocdPAo.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BmgjQPBU.js";import"./index-BnaP7-jq.js";import"./lite-DaUVFjkg.js";import"./use-merge-refs-DbrxZOKK.js";import"./input-BnLy8kIA.js";import"./label-DiNTPziq.js";import"./textarea-DmlQ0Bpw.js";import"./spinner-ntMQ3Ifm.js";const u=ae;try{u.displayName="Textfield",u.__docgenInfo={description:"",displayName:"Textfield",props:{className:{defaultValue:null,description:"Classname on the wrapper element `Field`",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:{value:"undefined"},description:"Style on the wrapper element `Field`",name:"style",required:!1,type:{name:"CSSProperties"}},label:{defaultValue:null,description:"Label",name:"label",required:!1,type:{name:"ReactNode"}},description:{defaultValue:null,description:"Description",name:"description",required:!1,type:{name:"ReactNode"}},prefix:{defaultValue:null,description:"Prefix",name:"prefix",required:!1,type:{name:"string"}},suffix:{defaultValue:null,description:"Suffix",name:"suffix",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Error message for field",name:"error",required:!1,type:{name:"ReactNode"}},counter:{defaultValue:null,description:"Uses `Field.Counter` to display a character counter\nPass a number to set a limit, or an object to configure the counter",name:"counter",required:!1,type:{name:"number | FieldCounterProps"}},"aria-label":{defaultValue:null,description:`Defines a string value that labels the current element.
