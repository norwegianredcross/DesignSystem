import{j as e}from"./iframe-m11y8uAU.js";import{s as te,i as x,b as F,M as p,R as C,j as ae}from"./tooltip-YDsOyFXp.js";import{F as v}from"./index-K9v9ecyp.js";const s=te;try{s.displayName="Fieldset",s.__docgenInfo={description:"",displayName:"Fieldset",props:{"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}}}}}catch{}const{expect:t,within:f,userEvent:i,waitFor:y,fn:B}=__STORYBOOK_MODULE_TEST__,se={title:"Components/Fieldset",component:s,tags:["autodocs"],parameters:{docs:{description:{component:"Fieldset groups related form controls, often with a legend."}}},argTypes:{"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},children:{control:!1,description:"Fieldset content, typically Fieldset.Legend, Fieldset.Description, and form controls."},legend:{table:{disable:!0}},description:{table:{disable:!0}},error:{table:{disable:!0}}}},b={render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Skriv inn dine svar"}),e.jsx(s.Description,{children:"Gi en kort beskrivelse i begge feltene"}),e.jsxs(v,{children:[e.jsx(x,{id:"short-desc-label",htmlFor:"short-desc",children:"Kort beskrivelse"}),e.jsx(F,{id:"short-desc","aria-labelledby":"short-desc-label"})]}),e.jsxs(v,{children:[e.jsx(x,{id:"long-desc-label",htmlFor:"long-desc",children:"Lang beskrivelse"}),e.jsx(ae,{id:"long-desc","aria-labelledby":"long-desc-label"})]})]})}),args:{"data-size":"md","data-color":"secondary-color-rust"},name:"With Textfields"},k={render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Hvilke nyhetsbrev ønsker du?"}),e.jsx(s.Description,{children:"Velg ett eller flere alternativer"}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Produktnyheter"]}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Blogginnlegg"]}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Invitasjoner til webinar"]})]})}),args:{"data-size":"md","data-color":"neutral"},name:"With Checkbox"},u={render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{asChild:!0,children:e.jsx("h3",{style:{margin:0},children:"Hvor bor du nå?"})}),e.jsxs(v,{children:[e.jsx(x,{id:"address-line1-label",htmlFor:"address-line1",children:"Adresse"}),e.jsx(F,{id:"address-line1","aria-labelledby":"address-line1-label"})]}),e.jsxs(v,{children:[e.jsx(x,{id:"zip-label",htmlFor:"zip",children:"Postnummer"}),e.jsx(F,{id:"zip","aria-labelledby":"zip-label",size:6})]})]})}),args:{"data-size":"md"},name:"Legend as Heading"},d={name:"Test: Legend And Group Semantics",render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Kontaktinformasjon"}),e.jsx(s.Description,{children:"Vi bruker dette til å kontakte deg om medlemskapet"}),e.jsx(p,{label:"E-post",value:"epost",name:"kontakt-kanal"}),e.jsx(p,{label:"Post",value:"post",name:"kontakt-kanal"})]})}),args:{"data-size":"md"},play:async({canvasElement:a})=>{const l=f(a),r=l.getByRole("group",{name:/Kontaktinformasjon/}),o=l.getByText("Kontaktinformasjon"),n=l.getByText("Vi bruker dette til å kontakte deg om medlemskapet");await y(()=>{t(o).toHaveAttribute("id"),t(n).toHaveAttribute("id");const j=r.getAttribute("aria-labelledby")??"";t(j).toContain(o.id),t(j).toContain(n.id)});const h=await y(()=>l.getByRole("checkbox",{name:"E-post"}));t(r).toContainElement(h)}},c={name:"Test: Disabled Propagates To Children",render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Samtykker"}),e.jsx(p,{label:"Nyhetsbrev",value:"nyhetsbrev",name:"samtykke"}),e.jsx(p,{label:"SMS-varsler",value:"sms",name:"samtykke"})]})}),args:{"data-size":"md",disabled:!0,onChange:B()},play:async({canvasElement:a,args:l})=>{const r=f(a),o=await y(()=>r.getByRole("checkbox",{name:"Nyhetsbrev"})),n=r.getByRole("checkbox",{name:"SMS-varsler"});t(o).toBeDisabled(),t(n).toBeDisabled(),await i.click(o),t(o).not.toBeChecked(),t(l.onChange).not.toHaveBeenCalled()}},m={name:"Test: Checkbox Operability Within Fieldset",render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Hvilke nyhetsbrev ønsker du?"}),e.jsx(s.Description,{children:"Velg ett eller flere alternativer"}),e.jsx(p,{label:"Produktnyheter",value:"produkt",name:"nyhetsbrev"}),e.jsx(p,{label:"Blogginnlegg",value:"blogg",name:"nyhetsbrev"})]})}),args:{"data-size":"md",onChange:B()},play:async({canvasElement:a,args:l})=>{const r=f(a),o=await y(()=>r.getByRole("checkbox",{name:"Produktnyheter"})),n=r.getByRole("checkbox",{name:"Blogginnlegg"});await i.click(o),t(o).toBeChecked(),t(l.onChange).toHaveBeenCalledTimes(1),n.focus(),await i.keyboard(" "),t(n).toBeChecked(),t(l.onChange).toHaveBeenCalledTimes(2),await i.click(o),t(o).not.toBeChecked(),t(n).toBeChecked(),t(l.onChange).toHaveBeenCalledTimes(3)}},g={name:"Test: Radio Group Within Fieldset",render:a=>e.jsx("form",{children:e.jsxs(s,{...a,children:[e.jsx(s.Legend,{children:"Foretrukket kontaktmåte"}),e.jsx(C,{label:"E-post",value:"epost",name:"kontaktmaate"}),e.jsx(C,{label:"Telefon",value:"telefon",name:"kontaktmaate"}),e.jsx(C,{label:"SMS",value:"sms",name:"kontaktmaate"})]})}),args:{"data-size":"md",onChange:B()},play:async({canvasElement:a,args:l})=>{const r=f(a),o=await y(()=>r.getByRole("radio",{name:"E-post"})),n=r.getByRole("radio",{name:"Telefon"}),h=r.getByRole("radio",{name:"SMS"});await i.click(n),t(n).toBeChecked(),t(l.onChange).toHaveBeenCalledTimes(1),await i.click(h),t(h).toBeChecked(),t(n).not.toBeChecked(),await i.keyboard("{ArrowUp}"),t(n).toBeChecked(),t(n).toHaveFocus(),t(h).not.toBeChecked(),t(o).not.toBeChecked()}};var T,w,S;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => <form>
      <Fieldset {...args}>
...
}`,...(S=(w=b.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};var L,z,E;k.parameters={...k.parameters,docs:{...(L=k.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: args => <form>
      <Fieldset {...args}>
