import{r as u,j as t}from"./iframe-ChOOMmW6.js";import{M as ue,s as pe,V as me}from"./tooltip-ad4DlScQ.js";const w=(e,o)=>{const r=e(),a=!!o(!0).length,n=!!o(!1).length;for(const c of r)c.indeterminate=n&&a,c.checked=!n&&a};function be(e){const{error:o,name:r,onChange:a,value:n=[],disabled:c,readOnly:le,required:ne}=e||{},[V,I]=u.useState(n),re=u.useId(),j=u.useId(),S=u.useRef(new Set),R=u.useRef(new Set),D=u.useRef(new Map),O=f=>Array.from(S.current.values()).filter(_=>_.checked===f),E=()=>Array.from(R.current.values());return u.useEffect(()=>{w(E,O)},[V]),{value:V,setValue:I,getCheckboxProps:f=>{const _=typeof f=="string"?{value:f}:f||{},{allowIndeterminate:B=!1,ref:z=void 0,value:m="",...i}=_,se=l=>{if(l)(B?R:S).current.add(l),D.current.set(m,l),E().length&&w(E,O);else{const d=D.current.get(m);d&&(S.current.delete(d),R.current.delete(d),D.current.delete(m))}z&&(typeof z=="function"?z(l):z.current=l)},ce=()=>{const l=Array.from(O(!0),({value:d})=>d);I(l),a==null||a(l,V)},de=()=>{const l=D.current.get(m);if(!l)return;const d=!!l.checked;for(const ie of O(!d))ie.click()};return{...i,"aria-describedby":`${o?j:""} ${i["aria-describedby"]||""}`.trim()||void 0,"aria-invalid":!!o||i["aria-invalid"],checked:B?void 0:V.includes(m),name:i.name||r||re,onChange:l=>{var d;(d=i.onChange)==null||d.call(i,l),!l.defaultPrevented&&(B&&de(),ce())},ref:se,value:m,disabled:c||i.disabled,readOnly:le||i.readOnly,required:ne||i.required}},validationMessageProps:{children:o,hidden:!o,id:j}}}const s=ue,p=pe,oe=be;s.displayName="Checkbox";p.displayName="Fieldset";try{s.displayName="Checkbox",s.__docgenInfo={description:"",displayName:"Checkbox",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"any"}},"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"any"}},disabled:{defaultValue:null,description:`Disables element
...
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}}}}}catch{}const{expect:b,within:fe,userEvent:F}=__STORYBOOK_MODULE_TEST__,he={title:"Components/Checkbox",component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"Checkbox label",defaultValue:"Checkbox label"},description:{control:"text",description:"Description for field"},disabled:{control:"boolean",description:"Disables element",defaultValue:!1},readOnly:{control:"boolean",description:"Toggle readOnly",defaultValue:!1},value:{control:"text",description:"Value of the input element"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"primary-color-red"},error:{control:"text",description:"Error message for field (often used with Fieldset)"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},checked:{control:!1},defaultChecked:{control:!1}}},h={name:"Example Default",args:{label:"Default Checkbox",value:"default"}},g={name:"Example with Description",args:{label:"Checkbox with Description",description:"This explains the checkbox choice.",value:"description"}},x={name:"Example Disabled",args:{label:"Disabled Checkbox",disabled:!0,value:"disabled",checked:!0}},k={name:"Example ReadOnly",args:{label:"Read Only Checkbox",readOnly:!0,value:"readonly",checked:!0}},y={name:"Example Group",render:e=>{const[o,r]=u.useState(["email"]),a=e.error?"Du må velge minst ett alternativ":void 0,{getCheckboxProps:n,validationMessageProps:c}=oe({name:"contact-preference",value:o,onChange:r,error:a});return t.jsxs(p,{children:[t.jsx(p.Legend,{children:"Hvordan vil du helst at vi skal kontakte deg?"}),t.jsx(p.Description,{children:"Velg alle alternativene som er relevante for deg."}),t.jsx(s,{label:"E-post",...n("email"),"data-size":e["data-size"],"data-color":e["data-color"],disabled:e.disabled,readOnly:e.readOnly}),t.jsx(s,{label:"Telefon",...n("phone"),"data-size":e["data-size"],"data-color":e["data-color"],disabled:e.disabled,readOnly:e.readOnly}),t.jsx(s,{label:"SMS",...n("sms"),"data-size":e["data-size"],"data-color":e["data-color"],disabled:e.disabled,readOnly:e.readOnly}),a&&t.jsx(me,{...c,children:a})]})},argTypes:{label:{control:!1},description:{control:!1},value:{control:!1},checked:{control:!1},defaultChecked:{control:!1},error:{control:"boolean",defaultValue:!1},disabled:{control:"boolean",defaultValue:!1},readOnly:{control:"boolean",defaultValue:!1},"data-size":{control:"select",options:["sm","md","lg"]},"data-color":{control:"select",options:["primary-color-red","neutral"]}},args:{error:!1,disabled:!1,readOnly:!1,"data-size":"md","data-color":"primary-color-red"}},C={name:"Example Indeterminate",render:e=>{const[o,r]=u.useState(["content1","content3"]),a=["content1","content2","content3","content4"],{getCheckboxProps:n}=oe({name:"indeterminate-group",value:o,onChange:r});return t.jsxs(p,{children:[t.jsx(p.Legend,{children:"Select Items"}),t.jsx(s,{label:"Select All",...n({allowIndeterminate:!0}),"data-size":e["data-size"],"data-color":e["data-color"]}),t.jsx("div",{style:{marginLeft:"20px",display:"flex",flexDirection:"column"},children:a.map(c=>t.jsx(s,{label:c.charAt(0).toUpperCase()+c.slice(1),...n(c),"data-size":e["data-size"],"data-color":e["data-color"]},c))})]})},argTypes:{label:{control:!1},description:{control:!1},value:{control:!1},checked:{control:!1},defaultChecked:{control:!1},error:{control:!1},disabled:{control:!1},readOnly:{control:!1}},args:{"data-size":"md","data-color":"primary-color-red"}},v={name:"Test: Interaction",render:()=>t.jsxs(p,{children:[t.jsx(s,{label:"Option A",value:"a",name:"test-checkbox"}),t.jsx(s,{label:"Option B",value:"b",name:"test-checkbox"}),t.jsx(s,{label:"Disabled",value:"c",name:"test-checkbox",disabled:!0})]}),play:async({canvasElement:e})=>{const o=fe(e),r=o.getByRole("checkbox",{name:/option a/i}),a=o.getByRole("checkbox",{name:/option b/i}),n=o.getByRole("checkbox",{name:/disabled/i});b(r).not.toBeChecked(),b(a).not.toBeChecked(),await F.click(r),b(r).toBeChecked(),await F.click(a),b(r).toBeChecked(),b(a).toBeChecked(),b(n).toBeDisabled()}};var M,T,q;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`{
...
}`,...(q=(T=h.parameters)==null?void 0:T.docs)==null?void 0:q.source}}};var A,P,G;g.parameters={...g.parameters,docs:{...(A=g.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(G=(P=g.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var N,L,$;x.parameters={...x.parameters,docs:{...(N=x.parameters)==null?void 0:N.docs,source:{originalSource:`{
