import{r as m,j as e}from"./iframe-DW8ODVLP.js";import{a0 as Y,a1 as G,a2 as J,a3 as Q,a4 as X}from"./tooltip-lraEXxJj.js";import{L as B}from"./index-BJ2OpBBA.js";const Z=({currentPage:n=1,setCurrentPage:a,onChange:l,totalPages:i=1,showPages:c=7})=>m.useMemo(()=>{const{next:d,prev:o,pages:s}=Y({current:n,total:i,show:c}),r=u=>p=>{if(u<1||u>i)return p.preventDefault();l==null||l(p,u),p.defaultPrevented||a==null||a(u)};return{pages:s.map(({page:u,current:p},S)=>({page:u||"ellipsis",itemKey:u?`page-${u}`:`ellipsis-${S}`,buttonProps:u?{"aria-current":p?"true":void 0,onClick:r(u)}:null})),prevButtonProps:{"aria-hidden":!o,onClick:r(o),variant:"tertiary"},nextButtonProps:{"aria-hidden":!d,onClick:r(d),variant:"tertiary"},hasPrev:!!o,hasNext:!!d}},[n,i,c]),t=G,_=J,k=Q,L=X,x=Z;t.displayName="Pagination";try{t.displayName="Pagination",t.__docgenInfo={description:"",displayName:"Pagination",props:{"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
