import{r as re,j as e}from"./iframe-BTDH1vlx.js";import{T as ae}from"./textfield-DQLTy081.js";import{D as te}from"./divider-CoX6OFX0.js";import{P as ne}from"./paragraph-s6O_YDUR.js";import{B as le}from"./button-DDpK-shN.js";import"./preload-helper-Dp1pzeXC.js";import"./index-D12YomW6.js";import"./index-DtYqqhaU.js";import"./lite-DaUVFjkg.js";import"./use-merge-refs-D5nZ8Qxv.js";import"./input-DWENZWG6.js";import"./label-DwcluwtY.js";import"./textarea-CReFwaSy.js";import"./spinner-DeYBvfBJ.js";const u=ae;try{u.displayName="Textfield",u.__docgenInfo={description:"",displayName:"Textfield",props:{className:{defaultValue:null,description:"Classname on the wrapper element `Field`",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:{value:"undefined"},description:"Style on the wrapper element `Field`",name:"style",required:!1,type:{name:"CSSProperties"}},label:{defaultValue:null,description:"Label",name:"label",required:!1,type:{name:"ReactNode"}},description:{defaultValue:null,description:"Description",name:"description",required:!1,type:{name:"ReactNode"}},prefix:{defaultValue:null,description:"Prefix",name:"prefix",required:!1,type:{name:"string"}},suffix:{defaultValue:null,description:"Suffix",name:"suffix",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Error message for field",name:"error",required:!1,type:{name:"ReactNode"}},counter:{defaultValue:null,description:"Uses `Field.Counter` to display a character counter\nPass a number to set a limit, or an object to configure the counter",name:"counter",required:!1,type:{name:"number | FieldCounterProps"}},"aria-label":{defaultValue:null,description:`Defines a string value that labels the current element.
