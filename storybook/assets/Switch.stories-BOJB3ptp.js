import{r as V,j as a}from"./iframe-ChmhbHcN.js";import{S as s,F as G}from"./index-D7c5bbrs.js";const{expect:p,within:N,userEvent:h}=__STORYBOOK_MODULE_TEST__,P={title:"Components/Switch",component:s,tags:["autodocs"],parameters:{docs:{description:{component:"Switch allows users to toggle between two states, typically on or off."}}},argTypes:{label:{control:"text",description:"Switch label (use this OR aria-label, not both)",defaultValue:"Switch Label"},description:{control:"text",description:"Description for field"},disabled:{control:"boolean",description:"Disables element",defaultValue:!1},readOnly:{control:"boolean",description:"Toggle readOnly",defaultValue:!1},position:{control:"select",options:["start","end"],description:"Position of switch relative to label",defaultValue:"start"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"primary-color-red"},value:{control:"text",description:"Value of the input element"},checked:{control:"boolean"},defaultChecked:{control:"boolean"},name:{control:"text"}}},o={args:{label:"Mørk modus",value:"dark_mode_toggle",name:"theme-toggle",defaultChecked:!1}},r={parameters:{a11y:{config:{rules:[{id:"aria-allowed-role",enabled:!1},{id:"color-contrast",selector:'*:not([data-field="description"])'}]}}},render:i=>{const{"data-size":t,"data-color":e,position:n}=i;return a.jsxs(G,{children:[a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 1",description:"Beskrivelse av innstilling",value:"setting1",name:"settings-group",defaultChecked:!0}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 2",value:"setting2",name:"settings-group"}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 3",value:"setting3",name:"settings-group",defaultChecked:!0}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 4",description:"Du mangler rettigheter for denne instillingen",value:"setting4",name:"settings-group",disabled:!0})]})},args:{"data-size":"md","data-color":"neutral",position:"start"}},l={parameters:{a11y:{config:{rules:[{id:"aria-allowed-role",enabled:!1},{id:"color-contrast",selector:'*:not([data-field="description"])'}]}}},render:i=>{const{"data-size":t,"data-color":e,position:n}=i;return a.jsxs(G,{children:[a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 1",description:"Beskrivelse av innstilling",value:"setting1-right",name:"settings-group-right",defaultChecked:!0}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 2",value:"setting2-right",name:"settings-group-right"}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 3",value:"setting3-right",name:"settings-group-right",defaultChecked:!0}),a.jsx(s,{"data-size":t,"data-color":e,position:n,label:"Innstilling 4",description:"Du mangler rettigheter for denne instillingen",value:"setting4-right",name:"settings-group-right",disabled:!0})]})},args:{"data-size":"md","data-color":"neutral",position:"end"},name:"Right Positioned"},d={args:{label:"Disabled Switch",value:"disabled_toggle",name:"disabled-state",disabled:!0,checked:!0}},c={args:{label:"Read Only Switch",value:"readonly_toggle",name:"readonly-state",readOnly:!0,checked:!0}},g={render:i=>{const[t,e]=V.useState(!1);return a.jsxs("div",{children:[a.jsx(s,{...i,checked:t,onChange:n=>e(n.target.checked)}),a.jsxs("p",{style:{marginTop:"8px",fontSize:"0.9em"},children:["Current state: ",t?"Checked (On)":"Unchecked (Off)"]})]})},args:{label:"Kontrollert Switch",value:"controlled_toggle",name:"controlled-switch"}},u={name:"Test: Interaction",args:{label:"Test Switch",value:"test_toggle",name:"test-switch",defaultChecked:!1},play:async({canvasElement:i})=>{const e=N(i).getByRole("switch",{name:/test switch/i});p(e).toBeInTheDocument(),p(e).not.toBeChecked(),await h.click(e),p(e).toBeChecked(),await h.click(e),p(e).not.toBeChecked()}},L=["Default","Grouped","RightPositioned","Disabled","ReadOnly","Controlled","TestInteraction"];var m,f,b;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: 'Mørk modus',
...
}`,...(b=(f=o.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var w,k,S;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(F=(R=u.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};const U=Object.freeze(Object.defineProperty({__proto__:null,Controlled:g,Default:o,Disabled:d,Grouped:r,ReadOnly:c,RightPositioned:l,TestInteraction:u,__namedExportsOrder:L,default:P},Symbol.toStringTag,{value:"Module"}));export{g as C,d as D,r as G,l as R,U as S,c as a};
