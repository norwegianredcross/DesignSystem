import{r as g,j as e}from"./iframe-BC5HkS_i.js";import{S as b}from"./index-DWKGY2hz.js";import{c as I}from"./lite-DaUVFjkg.js";import{B as S}from"./button-DbHsZBiM.js";import{L as h}from"./index-8yQtSuux.js";import"./preload-helper-Dp1pzeXC.js";import"./spinner-kEjbZ4J0.js";import"./use-merge-refs-BkbeGo7a.js";import"./link-DeI08F9f.js";const L=(t,n,a)=>{const o=(a-1)/2,l=Math.max(1,Math.min(Math.max(t-Math.floor(o),1),n-a+1)),u=Math.min(Math.max(t+Math.ceil(o),a),n),d=Array.from({length:u+1-l},(s,i)=>i+l);return a>4&&l>1&&d.splice(0,2,1,0),a>3&&u<n&&d.splice(-2,2,0,n),d},k=({currentPage:t=1,setCurrentPage:n,onChange:a,totalPages:o=1,showPages:l=7})=>g.useMemo(()=>{const u=t<o,d=t!==1,s=i=>c=>{if(i<1||i>o)return c.preventDefault();a==null||a(c,i),c.defaultPrevented||n==null||n(i)};return{pages:L(t,o,l).map((i,c)=>({page:i||"ellipsis",itemKey:i?`page-${i}`:`ellipsis-${c}`,buttonProps:i?{"aria-current":i===t?"page":void 0,onClick:s(i),variant:i===t?"primary":"tertiary"}:null})),prevButtonProps:{"aria-hidden":!d,onClick:s(t-1),variant:"tertiary"},nextButtonProps:{"aria-hidden":!u,onClick:s(t+1),variant:"tertiary"},hasPrev:d,hasNext:u}},[t,o,l]),_=g.forwardRef(function({"aria-label":n="Sidenavigering",asChild:a,className:o,...l},u){const d=a?b:"nav";return e.jsx(d,{"aria-label":n,className:I("ds-pagination",o),ref:u,...l})}),N=g.forwardRef(function(n,a){return e.jsx(S,{ref:a,...n})}),V=g.forwardRef(function({asChild:n,className:a,...o},l){const u=n?b:"li";return e.jsx(u,{ref:l,...o})}),z=g.forwardRef(function({asChild:n,...a},o){const l=n?b:"ul";return e.jsx(l,{ref:o,...a})}),P=Object.assign(_,{List:z,Item:V,Button:N});P.List.displayName="Pagination.List";P.Item.displayName="Pagination.Item";P.Button.displayName="Pagination.Button";const r=P,f=k;try{r.displayName="Pagination",r.__docgenInfo={description:"",displayName:"Pagination",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
