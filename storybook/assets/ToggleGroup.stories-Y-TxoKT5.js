import{r as K,j as e}from"./iframe-Dm7Vn_HN.js";import{O as P,n as U,P as W,B as N}from"./tooltip-6MlRq09s.js";import{T as b}from"./index-RdIhVcik.js";import{S as Y}from"./EnvelopeClosed-CKzDOXBp.js";import{S as q,a as J,b as Q,c as X,d as Z,e as $}from"./Paperplane-BJ3hEpfh.js";const t=P,{expect:a,within:g,userEvent:l,waitFor:s,fn:ee}=__STORYBOOK_MODULE_TEST__,te={title:"Components/ToggleGroup",component:t,tags:["autodocs"],parameters:{docs:{description:{component:"ToggleGroup allows users to select one option from a set of connected buttons."}},layout:"centered"},argTypes:{defaultValue:{control:"text",description:"Default selected item value (uncontrolled mode)."},name:{control:"text",description:"Form element name for the group.",defaultValue:"toggle-group-story"},"aria-label":{control:"text",description:"Accessible name of the group (the data-toggle-group attribute is deprecated since Digdir 1.21)."},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},value:{control:"text",description:"Selected item value (controlled mode).",table:{disable:!0}},onChange:{action:"changed",description:"Callback with selected ToggleGroup.Item value.",table:{disable:!0}},children:{control:!1}}},m={name:"Example Default",render:o=>e.jsxs(t,{...o,children:[e.jsx(t.Item,{value:"innboks",children:"Innboks"}),e.jsx(t.Item,{value:"utkast",children:"Utkast"}),e.jsx(t.Item,{value:"arkiv",children:"Arkiv"}),e.jsx(t.Item,{value:"sendt",children:"Sendt"})]}),args:{defaultValue:"innboks",name:"folder-toggle","aria-label":"Mapper","data-size":"md","data-color":"neutral"}},p={name:"Example Icon Only with Tooltip",render:o=>e.jsxs(t,{...o,children:[e.jsx(b,{content:"Venstrestilt",children:e.jsx(t.Item,{value:"option-1",children:e.jsx(X,{title:"Venstrestilt",fontSize:"1.5rem"})})}),e.jsx(b,{content:"Midtstilt",children:e.jsx(t.Item,{value:"option-2",children:e.jsx(Z,{title:"Midtstilt",fontSize:"1.5rem"})})}),e.jsx(b,{content:"Høyrestilt",children:e.jsx(t.Item,{value:"option-3",children:e.jsx($,{title:"Høyrestilt",fontSize:"1.5rem"})})})]}),args:{defaultValue:"option-1",name:"alignment-icon-toggle","aria-label":"Tekstjustering","data-size":"md","data-color":"primary-color-red"}},v={name:"Example Controlled with Icons",render:o=>{const[n,i]=K.useState("utkast");return e.jsxs(e.Fragment,{children:[e.jsxs(t,{...o,value:n,onChange:i,children:[e.jsxs(t.Item,{value:"innboks",children:[e.jsx(Y,{"aria-hidden":!0,fontSize:"1.5rem",style:{marginRight:"4px"}}),"Innboks"]}),e.jsxs(t.Item,{value:"utkast",children:[e.jsx(q,{"aria-hidden":!0,fontSize:"1.5rem",style:{marginRight:"4px"}}),"Utkast"]}),e.jsxs(t.Item,{value:"arkiv",children:[e.jsx(J,{"aria-hidden":!0,fontSize:"1.5rem",style:{marginRight:"4px"}}),"Arkiv"]}),e.jsxs(t.Item,{value:"sendt",children:[e.jsx(Q,{"aria-hidden":!0,fontSize:"1.5rem",style:{marginRight:"4px"}}),"Sendt"]})]}),e.jsx(U,{style:{margin:"var(--ds-size-4) 0 var(--ds-size-2) 0"}}),e.jsxs(W,{children:["Du har valgt: ",n]}),e.jsx(N,{"data-size":"sm",onClick:()=>i("arkiv"),style:{marginTop:"var(--ds-size-2)"},children:"Velg Arkiv"})]})},args:{name:"controlled-folder-toggle-icons","aria-label":"Mapper","data-size":"md","data-color":"secondary-color-rust"}},h={name:"Example Large Size",render:o=>e.jsxs(t,{...o,children:[e.jsx(t.Item,{value:"large1",children:"Large Option 1"}),e.jsx(t.Item,{value:"large2",children:"Large Option 2"})]}),args:{defaultValue:"large1",name:"large-toggle","aria-label":"Størrelse","data-size":"lg","data-color":"neutral"}},k={name:"Test: Interaction",render:()=>e.jsxs(t,{defaultValue:"innboks",name:"test-toggle","aria-label":"Mapper",children:[e.jsx(t.Item,{value:"innboks",children:"Innboks"}),e.jsx(t.Item,{value:"utkast",children:"Utkast"}),e.jsx(t.Item,{value:"arkiv",children:"Arkiv"})]}),play:async({canvasElement:o})=>{const n=g(o),i=n.getByRole("radio",{name:/innboks/i});a(i).toBeChecked();const c=n.getByText("Utkast");await l.click(c);const r=n.getByRole("radio",{name:/utkast/i});await s(()=>{a(r).toBeChecked()}),a(i).not.toBeChecked();const d=n.getByText("Arkiv");await l.click(d);const u=n.getByRole("radio",{name:/arkiv/i});await s(()=>{a(u).toBeChecked()}),a(r).not.toBeChecked()}},x={name:"Test: Keyboard Navigation And Callback",render:({onChange:o})=>e.jsxs(t,{onChange:o,defaultValue:"left",name:"alignment-test","aria-label":"Tekstjustering",children:[e.jsx(t.Item,{value:"left",children:"Venstre"}),e.jsx(t.Item,{value:"center",children:"Midten"}),e.jsx(t.Item,{value:"right",children:"Høyre"})]}),args:{onChange:ee()},play:async({canvasElement:o,args:n})=>{const c=g(o).getByRole("group",{name:"Tekstjustering"}),r=g(c).getByRole("radio",{name:"Venstre"}),d=g(c).getByRole("radio",{name:"Midten"}),u=g(c).getByRole("radio",{name:"Høyre"});a(r).toBeChecked(),a(r).toHaveAttribute("name","alignment-test"),a(d).toHaveAttribute("name","alignment-test"),a(u).toHaveAttribute("name","alignment-test"),r.focus(),await l.keyboard("{ArrowRight}"),await s(()=>a(d).toHaveFocus()),a(r).toBeChecked(),a(n.onChange).not.toHaveBeenCalled(),await l.keyboard("{Enter}"),await s(()=>a(d).toBeChecked()),a(n.onChange).toHaveBeenLastCalledWith("center"),await l.keyboard("{ArrowLeft}"),await s(()=>a(r).toHaveFocus()),a(d).toBeChecked(),await l.keyboard("{Enter}"),await s(()=>a(r).toBeChecked()),a(n.onChange).toHaveBeenLastCalledWith("left"),await l.keyboard("{ArrowLeft}"),await s(()=>a(u).toHaveFocus()),a(r).toBeChecked(),await l.keyboard("{Enter}"),await s(()=>a(u).toBeChecked()),a(n.onChange).toHaveBeenCalledTimes(3)}},T={name:"Test: Disabled Item Is Skipped",render:()=>e.jsxs(t,{defaultValue:"first",name:"disabled-test","aria-label":"Visning",children:[e.jsx(t.Item,{value:"first",children:"Liste"}),e.jsx(t.Item,{value:"second",disabled:!0,children:"Detaljer"}),e.jsx(t.Item,{value:"third",children:"Kort"})]}),play:async({canvasElement:o})=>{const n=g(o),i=n.getByRole("radio",{name:"Liste"}),c=n.getByRole("radio",{name:"Detaljer"}),r=n.getByRole("radio",{name:"Kort"});a(c).toBeDisabled(),i.focus(),await l.keyboard("{ArrowRight}"),await s(()=>a(r).toHaveFocus()),a(i).toBeChecked(),a(c).not.toBeChecked(),await l.keyboard("{Enter}"),await s(()=>a(r).toBeChecked())}},ae=["Default","IconOnlyWithTooltip","ControlledWithIcons","LargeSize","TestInteraction","TestKeyboardNavigationAndCallback","TestDisabledItemIsSkipped"];var I,y,f;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(f=(y=m.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var C,w,B;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(B=(w=p.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};var G,j,S;v.parameters={...v.parameters,docs:{...(G=v.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(H=(V=k.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var L,D,F;x.parameters={...x.parameters,docs:{...(L=x.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(F=(D=x.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var O,M,_;T.parameters={...T.parameters,docs:{...(O=T.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(_=(M=T.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};const ie=Object.freeze(Object.defineProperty({__proto__:null,ControlledWithIcons:v,Default:m,IconOnlyWithTooltip:p,LargeSize:h,TestDisabledItemIsSkipped:T,TestInteraction:k,TestKeyboardNavigationAndCallback:x,__namedExportsOrder:ae,default:te},Symbol.toStringTag,{value:"Module"}));export{v as C,m as D,p as I,h as L,ie as T};
