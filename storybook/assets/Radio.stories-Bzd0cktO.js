import{j as e}from"./iframe-DLmt7OJT.js";import{R as r,F as t}from"./index-CgPrrYeD.js";const{expect:s,within:D,userEvent:b}=__STORYBOOK_MODULE_TEST__,J={title:"Components/Radio",component:r,tags:["autodocs"],parameters:{docs:{description:{component:"Radio presents a set of mutually exclusive options. Use one Radio per option, grouped by the same name."}}},argTypes:{"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},disabled:{control:"boolean",description:"Disables the radio",defaultValue:!1},name:{control:"text",description:"Name used to group radios",defaultValue:"alternativ"},value:{control:"text",description:"Value of the option"},label:{control:"text",description:"Label shown next to the radio",defaultValue:"Ja"}}},o={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Er du over 18 år?"}),e.jsx(r,{...a,value:"ja",label:"Ja",name:"alternativ"}),e.jsx(r,{...a,value:"nei",label:"Nei",name:"alternativ"})]}),args:{"data-size":"md","data-color":"neutral"}},n={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Velg et alternativ"}),e.jsx(r,{...a,value:"a","aria-label":"Alternativ A",name:"aria-group"}),e.jsx(r,{...a,value:"b","aria-label":"Alternativ B",name:"aria-group"})]}),args:{"data-size":"md"},name:"With aria-label"},d={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Velg en frukt"}),e.jsx(r,{...a,value:"apple",label:"Eple",name:"frukt"}),e.jsx(r,{...a,value:"banana",label:"Banan",name:"frukt"}),e.jsx(r,{...a,value:"pear",label:"Pære",name:"frukt"})]}),args:{"data-size":"md"}},l={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Velg en farge *"}),e.jsx("p",{id:"radio-error-note",style:{color:"var(--ds-color-danger-base-default)",marginTop:4,marginBottom:8},children:"Du må velge en farge"}),e.jsx(r,{...a,value:"red",label:"Rød",name:"farge","aria-describedby":"radio-error-note"}),e.jsx(r,{...a,value:"green",label:"Grønn",name:"farge","aria-describedby":"radio-error-note"})]}),args:{"data-size":"md"}},i={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Velg en status"}),e.jsx(r,{...a,value:"on",label:"På",name:"status-ro",readOnly:!0,checked:!0}),e.jsx(r,{...a,value:"off",label:"Av",name:"status-ro",readOnly:!0})]}),args:{"data-size":"md"}},c={render:a=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Ja / Nei"}),e.jsxs("div",{style:{display:"flex",gap:"16px"},children:[e.jsx(r,{...a,value:"ja",label:"Ja",name:"inline"}),e.jsx(r,{...a,value:"nei",label:"Nei",name:"inline"})]})]}),args:{"data-size":"md"}},p={name:"Test: Interaction",render:()=>e.jsxs(t,{children:[e.jsx(t.Legend,{children:"Velg et alternativ"}),e.jsx(r,{value:"yes",label:"Ja",name:"test-radio"}),e.jsx(r,{value:"no",label:"Nei",name:"test-radio"}),e.jsx(r,{value:"maybe",label:"Kanskje",name:"test-radio"})]}),play:async({canvasElement:a})=>{const u=D(a),m=u.getByRole("radio",{name:/ja/i}),g=u.getByRole("radio",{name:/nei/i}),v=u.getByRole("radio",{name:/kanskje/i});s(m).not.toBeChecked(),s(g).not.toBeChecked(),await b.click(m),s(m).toBeChecked(),await b.click(g),s(g).toBeChecked(),s(m).not.toBeChecked(),await b.click(v),s(v).toBeChecked(),s(g).not.toBeChecked()}};var x,y,k;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
...
}`,...(k=(y=o.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var h,j,f;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => <Fieldset>
...
}`,...(A=(w=p.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};const Y=["Default","AriaLabel","Group","WithError","ReadOnly","Inline","TestInteraction"],P=Object.freeze(Object.defineProperty({__proto__:null,AriaLabel:n,Default:o,Group:d,Inline:c,ReadOnly:i,TestInteraction:p,WithError:l,__namedExportsOrder:Y,default:J},Symbol.toStringTag,{value:"Module"}));export{o as D,P as R};
