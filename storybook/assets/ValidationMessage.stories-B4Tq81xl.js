import{r as v,j as E}from"./iframe-D-CvsFF9.js";import{V as T}from"./tooltip-VS67X2YO.js";import"./preload-helper-u0ftyAaf.js";import"./XMark-DMBydpb5.js";import"./useId-CW8v2hDH.js";import"./index-Bxcx_cEw.js";import"./index-61ZyVoh1.js";const x=v.forwardRef((a,t)=>E.jsx(T,{ref:t,...a}));x.displayName="ValidationMessage";const{expect:k,within:M}=__STORYBOOK_MODULE_TEST__,O={title:"Components/ValidationMessage",component:x,tags:["autodocs"],argTypes:{"data-size":{control:"select",options:["xs","sm","md","lg"],description:"Text size"}}},e={args:{children:"Feltet er påkrevd."}},s={args:{children:"E-postadressen er ikke gyldig. Kontroller at adressen er skrevet riktig, for eksempel navn@example.com."}},r={name:"Test: Renders Message",args:{children:"Passordet må være minst 8 tegn."},play:async({canvasElement:a})=>{const u=M(a).getByText("Passordet må være minst 8 tegn.");k(u).toBeInTheDocument()}},S=["Default","LongMessage","TestRendersMessage"];var n,o,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
