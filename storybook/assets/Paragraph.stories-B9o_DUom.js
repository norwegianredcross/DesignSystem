import{j as e}from"./iframe-D1TSNH-h.js";import{P as a}from"./index-CQnO6hvH.js";import"./preload-helper-u0ftyAaf.js";import"./tooltip-nkyDKwLW.js";import"./index-V7WeXF6O.js";import"./index-DlNeZUHX.js";const{expect:o,within:k}=__STORYBOOK_MODULE_TEST__,E={title:"Components/Paragraph",component:a,tags:["autodocs"],argTypes:{"data-size":{control:"select",options:["xs","sm","md","lg","xl"],description:"Text size"},variant:{control:"select",options:["default","long"],description:"Variant tuned for short or long-form text"}}},t={args:{children:"Røde Kors hjelper mennesker i sårbare livssituasjoner — lokalt, nasjonalt og internasjonalt."}},s={render:()=>e.jsxs(e.Fragment,{children:[e.jsx(a,{"data-size":"xs",children:"Ekstra liten tekst"}),e.jsx(a,{"data-size":"sm",children:"Liten tekst"}),e.jsx(a,{"data-size":"md",children:"Medium tekst"}),e.jsx(a,{"data-size":"lg",children:"Stor tekst"})]})},r={name:"Test: Renders Text",args:{children:"Avsnittstekst","data-size":"md"},play:async({canvasElement:u})=>{const n=k(u).getByText("Avsnittstekst");o(n).toBeInTheDocument(),o(n.tagName).toBe("P")}};var i,c,p;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
