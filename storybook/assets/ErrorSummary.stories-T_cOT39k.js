import{j as e}from"./iframe-TM5PO6Gt.js";import{E as _,b as g}from"./tooltip-nTTVuOqD.js";const r=_,{expect:n,within:y,userEvent:z,waitFor:p}=__STORYBOOK_MODULE_TEST__,O={title:"Components/ErrorSummary",component:r,tags:["autodocs"],parameters:{docs:{description:{component:"ErrorSummary provides an overview of errors or omissions that need correction on a page or step."}}},argTypes:{"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},asChild:{control:"boolean",description:"Render as child element",defaultValue:!1},children:{control:!1,description:"Must contain ErrorSummary.Heading and ErrorSummary.List with Items/Links"},heading:{table:{disable:!0}}}},d={render:t=>e.jsxs(r,{...t,children:[e.jsx(r.Heading,{children:"For å gå videre må du rette opp følgende feil:"}),e.jsxs(r.List,{children:[e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#textfield-error-1",children:"Fødselsdato kan ikke være etter år 2005"})}),e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#textfield-error-2",children:"Telefonnummer kan kun inneholde siffer"})}),e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#textfield-error-3",children:"E-post må være gyldig"})})]})]}),args:{"data-size":"md"}},c={render:t=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"2rem"},children:[e.jsx(g,{id:"textfield-error-1",label:"Fornavn",error:"Fornavn må være minst 2 tegn","aria-describedby":"errorsummary-heading"}),e.jsx(g,{id:"textfield-error-2",label:"Telefon",error:"Telefonnummer kan kun inneholde siffer","aria-describedby":"errorsummary-heading"}),e.jsxs(r,{...t,children:[e.jsx(r.Heading,{id:"errorsummary-heading",children:"For å gå videre må du rette opp følgende feil:"}),e.jsxs(r.List,{children:[e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#textfield-error-1",children:"Fornavn må være minst 2 tegn"})}),e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#textfield-error-2",children:"Telefonnummer kan kun inneholde siffer"})})]})]})]}),args:{"data-size":"md"}},i={name:"Test: Mount Focus And Heading Association",render:t=>e.jsxs(r,{...t,children:[e.jsx(r.Heading,{children:"For å gå videre må du rette opp følgende feil:"}),e.jsxs(r.List,{children:[e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#felt-fodselsdato",children:"Fødselsdato kan ikke være etter år 2005"})}),e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#felt-telefon",children:"Telefonnummer kan kun inneholde siffer"})})]})]}),args:{"data-size":"md"},play:async({canvasElement:t})=>{const o=y(t),a=t.querySelector(".ds-error-summary");await p(()=>{n(a).toHaveAttribute("tabindex","-1"),n(a).toHaveFocus()});const u=o.getByRole("heading",{level:2,name:"For å gå videre må du rette opp følgende feil:"});await p(()=>{n(u).toHaveAttribute("id"),n(a).toHaveAttribute("aria-labelledby",u.id)}),n(y(a).getByRole("list")).toBeInTheDocument();const s=y(a).getAllByRole("link");n(s).toHaveLength(2),n(s[0]).toHaveAttribute("href","#felt-fodselsdato"),n(s[1]).toHaveAttribute("href","#felt-telefon")}},m={name:"Test: Links Move Focus To Fields",render:t=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"2rem"},children:[e.jsx("style",{children:".ds-error-summary { animation: none !important; }"}),e.jsx(g,{id:"test-felt-fornavn",label:"Fornavn",error:"Fornavn må være minst 2 tegn"}),e.jsx(g,{id:"test-felt-epost",label:"E-post",error:"E-post må være gyldig"}),e.jsxs(r,{...t,children:[e.jsx(r.Heading,{children:"For å gå videre må du rette opp følgende feil:"}),e.jsxs(r.List,{children:[e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#test-felt-fornavn",children:"Fornavn må være minst 2 tegn"})}),e.jsx(r.Item,{children:e.jsx(r.Link,{href:"#test-felt-epost",children:"E-post må være gyldig"})})]})]})]}),args:{"data-size":"md"},play:async({canvasElement:t})=>{const o=y(t),a=o.getByRole("textbox",{name:"Fornavn"}),u=o.getByRole("textbox",{name:"E-post"});for(const h of o.getAllByRole("link")){const l=(h.getAttribute("href")??"").slice(1),f=document.getElementById(l);n(f).toBeInstanceOf(HTMLInputElement)}const s=async h=>{const l=o.getByRole("link",{name:h});l.addEventListener("click",f=>{var v;n(f.defaultPrevented).toBe(!1),f.preventDefault();const M=(l.getAttribute("href")??"").slice(1);(v=document.getElementById(M))==null||v.focus()},{once:!0}),await z.click(l)};await s("Fornavn må være minst 2 tegn"),await p(()=>n(a).toHaveFocus()),await s("E-post må være gyldig"),await p(()=>n(u).toHaveFocus())}};var E,x,k;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
