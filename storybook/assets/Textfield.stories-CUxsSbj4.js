import{r as ae,j as e}from"./iframe-BYZX1iMY.js";import{T as re}from"./textfield-J_FGcJ9M.js";import{D as te}from"./divider-CkWizg_v.js";import{P as ne}from"./paragraph-CE465ij3.js";import{B as le}from"./button-CpVZqiwb.js";const u=re;try{u.displayName="Textfield",u.__docgenInfo={description:"",displayName:"Textfield",props:{className:{defaultValue:null,description:"Classname on the wrapper element `Field`",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:{value:"undefined"},description:"Style on the wrapper element `Field`",name:"style",required:!1,type:{name:"CSSProperties"}},label:{defaultValue:null,description:"Label",name:"label",required:!1,type:{name:"ReactNode"}},description:{defaultValue:null,description:"Description",name:"description",required:!1,type:{name:"ReactNode"}},prefix:{defaultValue:null,description:"Prefix",name:"prefix",required:!1,type:{name:"string"}},suffix:{defaultValue:null,description:"Suffix",name:"suffix",required:!1,type:{name:"string"}},error:{defaultValue:null,description:"Error message for field",name:"error",required:!1,type:{name:"ReactNode"}},counter:{defaultValue:null,description:"Uses `Field.Counter` to display a character counter\nPass a number to set a limit, or an object to configure the counter",name:"counter",required:!1,type:{name:"number | FieldCounterProps"}},"aria-label":{defaultValue:null,description:`Defines a string value that labels the current element.
