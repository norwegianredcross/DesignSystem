import{j as e}from"./iframe-Dm7Vn_HN.js";import{A as o,a as P}from"./person2-DGsA5GQ3.js";const{expect:a,within:g}=__STORYBOOK_MODULE_TEST__,C={title:"Components/Avatar",component:o,tags:["autodocs"],argTypes:{"aria-label":{control:"text",description:"The name of the person the avatar represents.",defaultValue:"Ola Nordmann"},variant:{control:"select",options:["circle","square"],description:"The shape of the avatar.",defaultValue:"circle"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Color variant.",defaultValue:"primary-color-red"},"data-size":{control:"select",options:["xs","sm","md","lg"],description:"Size of the avatar.",defaultValue:"md"},initials:{control:"text",description:"Initials to display inside the avatar."},children:{control:"text",description:"Image, icon or initials to display inside the avatar."}}},s={name:"Example Default",args:{"aria-label":"Ola Nordmann"}},l={name:"Example with Initials",args:{"aria-label":"Ola Nordmann",children:"ON"}},c={name:"Example with Image",args:{"aria-label":"Ola Nordmann",children:e.jsx("img",{src:P,alt:"",style:{width:"100%",height:"100%",objectFit:"cover"}})}},d={name:"Example Square",args:{"aria-label":"Ola Nordmann",variant:"square",children:"ON"}},r={name:"Test: Initials, Fallback And Attributes",render:()=>e.jsxs("div",{style:{display:"flex",gap:"1rem",alignItems:"center"},children:[e.jsx(o,{"aria-label":"Kari Nordmann",initials:"KN"}),e.jsx(o,{"aria-label":"Ola Nordmann",children:"ON"}),e.jsx(o,{"aria-label":"Per Hansen"}),e.jsx(o,{"aria-label":"Anne Larsen",initials:"AL",variant:"square","data-size":"lg","data-color":"secondary-color-rust"})]}),play:async({canvasElement:u})=>{const t=g(u),m=t.getByRole("img",{name:"Kari Nordmann"}),n=t.getByRole("img",{name:"Ola Nordmann"}),v=t.getByRole("img",{name:"Per Hansen"}),p=t.getByRole("img",{name:"Anne Larsen"});a(m).toHaveAttribute("data-initials","KN"),a(g(n).getByText("ON")).toBeVisible(),a(n).not.toHaveAttribute("data-initials"),a(v).not.toHaveAttribute("data-initials"),a(v.textContent).toBe(""),a(p).toHaveAttribute("data-variant","square"),a(p).toHaveAttribute("data-size","lg"),a(p).toHaveAttribute("data-color","secondary-color-rust"),a(p).toHaveAttribute("data-initials","AL")}},i={name:"Test: Image Mode Accessibility",render:()=>e.jsx(o,{"aria-label":"Ola Nordmann",children:e.jsx("img",{src:P,alt:"",style:{width:"100%",height:"100%",objectFit:"cover"}})}),play:async({canvasElement:u})=>{const t=g(u),m=t.getByRole("img",{name:"Ola Nordmann"});a(m.tagName).toBe("SPAN");const n=m.querySelector("img");a(n).toHaveAttribute("aria-hidden","true"),a(n).toHaveAttribute("alt",""),a(n.src).toContain("person2"),a(t.getAllByRole("img")).toHaveLength(1)}},K=["Default","WithInitials","WithImage","Square","TestInitialsAndAttributes","TestImageMode"];var h,b,y;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(I=(T=d.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};var B,w,E,j,R;r.parameters={...r.parameters,docs:{...(B=r.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(E=(w=r.parameters)==null?void 0:w.docs)==null?void 0:E.source},description:{story:`Tests the text modes of the Avatar: it is exposed as role="img" named via
...
variant are reflected as data attributes.`,...(R=(j=r.parameters)==null?void 0:j.docs)==null?void 0:R.description}}};var q,L,_,k,z;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
so the name is not announced twice.`,...(z=(k=i.parameters)==null?void 0:k.docs)==null?void 0:z.description}}};const D=Object.freeze(Object.defineProperty({__proto__:null,Default:s,Square:d,TestImageMode:i,TestInitialsAndAttributes:r,WithImage:c,WithInitials:l,__namedExportsOrder:K,default:C},Symbol.toStringTag,{value:"Module"}));export{D as A,s as D,d as S,c as W,l as a};
