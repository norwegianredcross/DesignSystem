...
`}try{E.displayName="DatePicker",E.__docgenInfo={description:"DatePicker-komponent for å velge en dato fra en kalender.",displayName:"DatePicker",props:{}}}catch{}const Nt=({title:n,...a})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",viewBox:"0 0 24 24",fill:"none","aria-hidden":n?void 0:!0,focusable:"false",...a,children:[n&&u.jsx("title",{children:n}),u.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M9 2.25C9.41421 2.25 9.75 2.58579 9.75 3V4.25H14.25V3C14.25 2.58579 14.5858 2.25 15 2.25C15.4142 2.25 15.75 2.58579 15.75 3V4.25H19.5C20.1904 4.25 20.75 4.80964 20.75 5.5V18.5C20.75 19.1904 20.1904 19.75 19.5 19.75H4.5C3.80964 19.75 3.25 19.1904 3.25 18.5V5.5C3.25 4.80964 3.80964 4.25 4.5 4.25H8.25V3C8.25 2.58579 8.58579 2.25 9 2.25ZM15.75 7C15.75 7.41421 15.4142 7.75 15 7.75C14.5858 7.75 14.25 7.41421 14.25 7V5.75H9.75V7C9.75 7.41421 9.41421 7.75 9 7.75C8.58579 7.75 8.25 7.41421 8.25 7V5.75H4.75V9.25H19.25V5.75H15.75V7ZM4.75 18.25V10.75H19.25V18.25H4.75ZM6.75 13C6.75 12.5858 7.08579 12.25 7.5 12.25H8.5C8.91421 12.25 9.25 12.5858 9.25 13C9.25 13.4142 8.91421 13.75 8.5 13.75H7.5C7.08579 13.75 6.75 13.4142 6.75 13ZM10.75 13C10.75 12.5858 11.0858 12.25 11.5 12.25H12.5C12.9142 12.25 13.25 12.5858 13.25 13C13.25 13.4142 12.9142 13.75 12.5 13.75H11.5C11.0858 13.75 10.75 13.4142 10.75 13ZM15.5 12.25C15.0858 12.25 14.75 12.5858 14.75 13C14.75 13.4142 15.0858 13.75 15.5 13.75H16.5C16.9142 13.75 17.25 13.4142 17.25 13C17.25 12.5858 16.9142 12.25 16.5 12.25H15.5ZM10.75 16C10.75 15.5858 11.0858 15.25 11.5 15.25H12.5C12.9142 15.25 13.25 15.5858 13.25 16C13.25 16.4142 12.9142 16.75 12.5 16.75H11.5C11.0858 16.75 10.75 16.4142 10.75 16ZM15.5 15.25C15.0858 15.25 14.75 15.5858 14.75 16C14.75 16.4142 15.0858 16.75 15.5 16.75H16.5C16.9142 16.75 17.25 16.4142 17.25 16C17.25 15.5858 16.9142 15.25 16.5 15.25H15.5ZM6.75 16C6.75 15.5858 7.08579 15.25 7.5 15.25H8.5C8.91421 15.25 9.25 15.5858 9.25 16C9.25 16.4142 8.91421 16.75 8.5 16.75H7.5C7.08579 16.75 6.75 16.4142 6.75 16Z",fill:"currentColor"})]});Nt.displayName="CalendarIcon";const{action:X}=__STORYBOOK_MODULE_ACTIONS__,{expect:Y,within:Me,userEvent:ue,fn:Wt}=__STORYBOOK_MODULE_TEST__,Yr={title:"Components/DatePicker (Calendar)",component:E,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{initialDate:{control:{type:"date"},description:"Initial month to display in the calendar."},selectedDate:{control:{type:"date"},description:"The currently selected date (primarily for standalone calendar stories)."},onDateSelect:{action:"dateSelected",description:"Callback function when a date is selected in the calendar."},"data-size":{control:"select",options:["sm","md","lg"],description:"Component size",defaultValue:"md"},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral"],description:"Color scheme",defaultValue:"neutral"}}},oe={name:"Calendar Only (Default)",render:n=>{const[a,e]=x.useState(n.selectedDate||null),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:new Date,selectedDate:null,onDateSelect:X("dateSelected")}},ie={name:"Calendar Only (Selected)",render:n=>{const[a,e]=x.useState(n.selectedDate||new Date),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:new Date,selectedDate:new Date,onDateSelect:X("dateSelected")}},ce={name:"Calendar Only (Previous Month)",render:n=>{const[a,e]=x.useState(n.selectedDate||null),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:Fa(new Date),selectedDate:null,onDateSelect:X("dateSelected")}},le={name:"Calendar Only (Custom Size/Color)",render:n=>{const[a,e]=x.useState(n.selectedDate||new Date),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:new Date,selectedDate:new Date,"data-size":"lg","data-color":"brand2",onDateSelect:X("dateSelected")}},Er=n=>{const[a,e]=x.useState(n.selectedDate&&ne(n.selectedDate)?n.selectedDate:null),[t,r]=x.useState(a?z(a,"dd.MM.yyyy",{locale:B}):""),s=d=>{e(d),X("dateSelected (Calendar)")(d)},o=(d,h)=>{r(h);const y=La(h,"dd.MM.yyyy",new Date,{locale:B});ne(y)&&h.length===10?(!a||!pe(y,a))&&(e(y),X("inputParsedAndDateSelected (Input)")(y)):h===""&&a!==null&&(e(null),X("inputCleared (Input)")())};x.useEffect(()=>{const d=a?z(a,"dd.MM.yyyy",{locale:B}):"";d!==t&&r(d)},[a,t]);const c=a?z(a,"PPP",{locale:B}):"Ingen dato valgt";return u.jsxs("div",{style:{display:"inline-block",fontFamily:"sans-serif"},children:[u.jsxs("p",{style:{marginBottom:"10px",fontSize:"14px",minHeight:"20px"},children:["Valgt dato: ",u.jsx("strong",{children:c})]}),u.jsx("div",{style:{marginBottom:"10px"},children:u.jsx(Lt,{"aria-label":"Velg dato (dd.mm.åååå)",value:t,onChange:o,placeholder:"dd.mm.åååå",suffixIcon:u.jsx(Nt,{}),"data-size":n["data-size"],"data-color":n["data-color"]})}),u.jsx(E,{...n,selectedDate:a,onDateSelect:s,initialDate:a||n.initialDate||new Date})]})},de={name:"Example Combined Input + Calendar",render:n=>u.jsx(Er,{...n}),args:{initialDate:new Date},argTypes:{initialDate:{control:{type:"date"}},selectedDate:{table:{disable:!0}},onDateSelect:{table:{disable:!0}},"data-size":{control:"select",options:["sm","md","lg"]},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral"]}}},J={name:"Test: Date Selection",render:n=>{const[a,e]=x.useState(null),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:new Date(2025,0,15),onDateSelect:Wt()},play:async({canvasElement:n,args:a})=>{const r=Me(n).getAllByRole("button").find(s=>s.textContent==="15");Y(r).toBeTruthy(),await ue.click(r),Y(a.onDateSelect).toHaveBeenCalled(),Y(r).toHaveAttribute("aria-pressed","true")}},U={name:"Test: Month Navigation",render:n=>{const[a,e]=x.useState(null);return u.jsx(E,{...n,selectedDate:a,onDateSelect:e})},args:{initialDate:new Date(2025,5,15)},play:async({canvasElement:n})=>{const a=Me(n),e=()=>{const s=n.querySelector('[class*="monthYear"]');return(s==null?void 0:s.textContent)||""};Y(e()).toContain("2025"),Y(e().toLowerCase()).toContain("juni");const t=a.getByRole("button",{name:/neste/i});await ue.click(t),Y(e().toLowerCase()).toContain("juli");const r=a.getByRole("button",{name:/forrige/i});await ue.click(r),await ue.click(r),Y(e().toLowerCase()).toContain("mai")}},ee={name:"Test: Keyboard Navigation",render:n=>{const[a,e]=x.useState(null),t=r=>{var s;e(r),(s=n.onDateSelect)==null||s.call(n,r)};return u.jsx(E,{...n,selectedDate:a,onDateSelect:t})},args:{initialDate:new Date(2025,0,15),onDateSelect:Wt()},play:async({canvasElement:n,args:a})=>{const r=Me(n).getAllByRole("button").find(s=>s.textContent==="10");Y(r).toBeTruthy(),r.focus(),await ue.keyboard("{Enter}"),Y(a.onDateSelect).toHaveBeenCalled(),Y(r).toHaveAttribute("aria-pressed","true")}},te={name:"Test: Today Highlight",render:n=>{const[a,e]=x.useState(null);return u.jsx(E,{...n,selectedDate:a,onDateSelect:e})},args:{initialDate:new Date},play:async({canvasElement:n})=>{var o;const e=new Date().getDate().toString(),t=n.querySelectorAll('[role="button"]'),r=Array.from(t).find(c=>{var y;const d=((y=c.textContent)==null?void 0:y.trim())===e,h=c.className.includes("otherMonth");return d&&!h});Y(r).toBeTruthy();const s=r.getAttribute("aria-label")||"";Y(s).toBeTruthy(),Y((o=r.textContent)==null?void 0:o.trim()).toBe(e)}};var Ie,qe,Le;oe.parameters={...oe.parameters,docs:{...(Ie=oe.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
...
}`,...(Le=(qe=oe.parameters)==null?void 0:qe.docs)==null?void 0:Le.source}}};var Be,$e,Fe;ie.parameters={...ie.parameters,docs:{...(Be=ie.parameters)==null?void 0:Be.docs,source:{originalSource:`{
...
}`,...(Fe=($e=ie.parameters)==null?void 0:$e.docs)==null?void 0:Fe.source}}};var ze,Re,Qe;ce.parameters={...ce.parameters,docs:{...(ze=ce.parameters)==null?void 0:ze.docs,source:{originalSource:`{
