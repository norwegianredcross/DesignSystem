import{j as e}from"./iframe-DTOh5CrC.js";import{U as x}from"./tooltip-D2iWfPXz.js";const r=x;try{r.displayName="SkipLink",r.__docgenInfo={description:"",displayName:"SkipLink",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}},"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},children:{defaultValue:null,description:"The content to display inside the skiplink.",name:"children",required:!0,type:{name:"ReactNode"}},href:{defaultValue:null,description:"Href of an element in the DOM the skiplink should skip to. E.g #main-content",name:"href",required:!0,type:{name:"string"}}}}}catch{}const{expect:t,within:T,userEvent:l,waitFor:p}=__STORYBOOK_MODULE_TEST__,L={title:"Components/SkipLink",component:r,tags:["autodocs"],parameters:{docs:{description:{component:"SkipLink allows keyboard users to bypass navigation and jump directly to the main content."}},notes:"To see the SkipLink, click inside the Story canvas and press the Tab key.",layout:"padded"},argTypes:{children:{control:"text",description:"The content to display inside the skiplink.",defaultValue:"Hopp til hovedinnhold"},href:{control:"text",description:"Href of the element ID to skip to (e.g., #main-content).",defaultValue:"#main-content-story"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"}}},s={render:o=>{var a;return e.jsxs(e.Fragment,{children:[e.jsx(r,{...o}),e.jsxs("main",{id:(a=o.href)==null?void 0:a.substring(1),tabIndex:-1,style:{padding:"2rem",marginTop:"1rem",border:"1px dashed #ccc",outline:"none"},children:["Region som kan motta fokus fra skiplink. (ID: ",o.href,")",e.jsx("br",{}),"(Click here and press Tab to see the SkipLink)"]})]})},args:{children:"Hopp til hovedinnhold",href:"#main-content-story","data-size":"md","data-color":"primary-color-red"}},i={name:"Test: Focus Reveal And Activation",render:o=>e.jsxs(e.Fragment,{children:[e.jsx(r,{...o}),e.jsxs("nav",{"aria-label":"Hovedmeny",children:[e.jsx("a",{href:"#unused-1",children:"Aktiviteter"})," ",e.jsx("a",{href:"#unused-2",children:"Om oss"})]}),e.jsx("main",{id:"test-hovedinnhold",tabIndex:-1,style:{padding:"2rem",border:"1px dashed #ccc",outline:"none"},children:"Hovedinnholdet på siden."})]}),args:{children:"Hopp til hovedinnhold",href:"#test-hovedinnhold"},play:async({canvasElement:o})=>{const a=T(o),n=a.getByRole("link",{name:"Hopp til hovedinnhold"});t(n).toHaveAttribute("href","#test-hovedinnhold"),t(n.offsetWidth).toBeLessThanOrEqual(1),t(n.offsetHeight).toBeLessThanOrEqual(1),await l.tab(),t(n).toHaveFocus(),await p(()=>t(n.offsetWidth).toBeGreaterThan(1)),t(n.offsetHeight).toBeGreaterThan(1);const d=a.getByText("Hovedinnholdet på siden."),b=document.getElementById((n.getAttribute("href")??"").slice(1));t(b).toBe(d),t(d.tabIndex).toBe(-1),n.addEventListener("click",c=>{t(c.defaultPrevented).toBe(!1),c.preventDefault(),d.focus()},{once:!0}),await l.keyboard("{Enter}"),await p(()=>t(d).toHaveFocus()),t(n.offsetWidth).toBeLessThanOrEqual(1)}};var h,u,m;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => <>
      <SkipLink {...args} />
...
}`,...(m=(u=s.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var f,k,g,v,y;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...(g=(k=i.parameters)==null?void 0:k.docs)==null?void 0:g.source},description:{story:`Tests the whole purpose of the SkipLink: it is visually hidden (clipped to
