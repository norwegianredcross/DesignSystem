import{j as e}from"./iframe-D-CvsFF9.js";import{m as ne,c as y,b as F,x as p,R as C,d as te}from"./tooltip-VS67X2YO.js";import{F as v}from"./index-h6HlfTMW.js";const a=ne,{expect:n,within:f,userEvent:i,waitFor:x,fn:B}=__STORYBOOK_MODULE_TEST__,ae={title:"Components/Fieldset",component:a,tags:["autodocs"],parameters:{docs:{description:{component:"Fieldset groups related form controls, often with a legend."}}},argTypes:{"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},children:{control:!1,description:"Fieldset content, typically Fieldset.Legend, Fieldset.Description, and form controls."},legend:{table:{disable:!0}},description:{table:{disable:!0}},error:{table:{disable:!0}}}},b={render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Skriv inn dine svar"}),e.jsx(a.Description,{children:"Gi en kort beskrivelse i begge feltene"}),e.jsxs(v,{children:[e.jsx(y,{id:"short-desc-label",htmlFor:"short-desc",children:"Kort beskrivelse"}),e.jsx(F,{id:"short-desc","aria-labelledby":"short-desc-label"})]}),e.jsxs(v,{children:[e.jsx(y,{id:"long-desc-label",htmlFor:"long-desc",children:"Lang beskrivelse"}),e.jsx(te,{id:"long-desc","aria-labelledby":"long-desc-label"})]})]})}),args:{"data-size":"md","data-color":"secondary-color-rust"},name:"With Textfields"},k={render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Hvilke nyhetsbrev ønsker du?"}),e.jsx(a.Description,{children:"Velg ett eller flere alternativer"}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Produktnyheter"]}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Blogginnlegg"]}),e.jsxs("label",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e.jsx("input",{type:"checkbox"})," Invitasjoner til webinar"]})]})}),args:{"data-size":"md","data-color":"neutral"},name:"With Checkbox"},u={render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{asChild:!0,children:e.jsx("h3",{style:{margin:0},children:"Hvor bor du nå?"})}),e.jsxs(v,{children:[e.jsx(y,{id:"address-line1-label",htmlFor:"address-line1",children:"Adresse"}),e.jsx(F,{id:"address-line1","aria-labelledby":"address-line1-label"})]}),e.jsxs(v,{children:[e.jsx(y,{id:"zip-label",htmlFor:"zip",children:"Postnummer"}),e.jsx(F,{id:"zip","aria-labelledby":"zip-label",size:6})]})]})}),args:{"data-size":"md"},name:"Legend as Heading"},d={name:"Test: Legend And Group Semantics",render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Kontaktinformasjon"}),e.jsx(a.Description,{children:"Vi bruker dette til å kontakte deg om medlemskapet"}),e.jsx(p,{label:"E-post",value:"epost",name:"kontakt-kanal"}),e.jsx(p,{label:"Post",value:"post",name:"kontakt-kanal"})]})}),args:{"data-size":"md"},play:async({canvasElement:t})=>{const l=f(t),r=l.getByRole("group",{name:/Kontaktinformasjon/}),o=l.getByText("Kontaktinformasjon"),s=l.getByText("Vi bruker dette til å kontakte deg om medlemskapet");await x(()=>{n(o).toHaveAttribute("id"),n(s).toHaveAttribute("id");const j=r.getAttribute("aria-labelledby")??"";n(j).toContain(o.id),n(j).toContain(s.id)});const h=await x(()=>l.getByRole("checkbox",{name:"E-post"}));n(r).toContainElement(h)}},c={name:"Test: Disabled Propagates To Children",render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Samtykker"}),e.jsx(p,{label:"Nyhetsbrev",value:"nyhetsbrev",name:"samtykke"}),e.jsx(p,{label:"SMS-varsler",value:"sms",name:"samtykke"})]})}),args:{"data-size":"md",disabled:!0,onChange:B()},play:async({canvasElement:t,args:l})=>{const r=f(t),o=await x(()=>r.getByRole("checkbox",{name:"Nyhetsbrev"})),s=r.getByRole("checkbox",{name:"SMS-varsler"});n(o).toBeDisabled(),n(s).toBeDisabled(),await i.click(o),n(o).not.toBeChecked(),n(l.onChange).not.toHaveBeenCalled()}},g={name:"Test: Checkbox Operability Within Fieldset",render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Hvilke nyhetsbrev ønsker du?"}),e.jsx(a.Description,{children:"Velg ett eller flere alternativer"}),e.jsx(p,{label:"Produktnyheter",value:"produkt",name:"nyhetsbrev"}),e.jsx(p,{label:"Blogginnlegg",value:"blogg",name:"nyhetsbrev"})]})}),args:{"data-size":"md",onChange:B()},play:async({canvasElement:t,args:l})=>{const r=f(t),o=await x(()=>r.getByRole("checkbox",{name:"Produktnyheter"})),s=r.getByRole("checkbox",{name:"Blogginnlegg"});await i.click(o),n(o).toBeChecked(),n(l.onChange).toHaveBeenCalledTimes(1),s.focus(),await i.keyboard(" "),n(s).toBeChecked(),n(l.onChange).toHaveBeenCalledTimes(2),await i.click(o),n(o).not.toBeChecked(),n(s).toBeChecked(),n(l.onChange).toHaveBeenCalledTimes(3)}},m={name:"Test: Radio Group Within Fieldset",render:t=>e.jsx("form",{children:e.jsxs(a,{...t,children:[e.jsx(a.Legend,{children:"Foretrukket kontaktmåte"}),e.jsx(C,{label:"E-post",value:"epost",name:"kontaktmaate"}),e.jsx(C,{label:"Telefon",value:"telefon",name:"kontaktmaate"}),e.jsx(C,{label:"SMS",value:"sms",name:"kontaktmaate"})]})}),args:{"data-size":"md",onChange:B()},play:async({canvasElement:t,args:l})=>{const r=f(t),o=await x(()=>r.getByRole("radio",{name:"E-post"})),s=r.getByRole("radio",{name:"Telefon"}),h=r.getByRole("radio",{name:"SMS"});await i.click(s),n(s).toBeChecked(),n(l.onChange).toHaveBeenCalledTimes(1),await i.click(h),n(h).toBeChecked(),n(s).not.toBeChecked(),await i.keyboard("{ArrowUp}"),n(s).toBeChecked(),n(s).toHaveFocus(),n(h).not.toBeChecked(),n(o).not.toBeChecked()}},se=["WithTextfields","WithCheckbox","LegendAsHeading","TestGroupSemantics","TestDisabledPropagates","TestCheckboxOperability","TestRadioGroup"];var T,w,L;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => <form>
      <Fieldset {...args}>
...
and native arrow-key navigation between radios in the same group.`,...(ee=($=m.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};const ie=Object.freeze(Object.defineProperty({__proto__:null,LegendAsHeading:u,TestCheckboxOperability:g,TestDisabledPropagates:c,TestGroupSemantics:d,TestRadioGroup:m,WithCheckbox:k,WithTextfields:b,__namedExportsOrder:se,default:ae},Symbol.toStringTag,{value:"Module"}));export{ie as F,b as W};
