import{j as e}from"./iframe-yuJj-q-m.js";import{useMDXComponents as t}from"./index-BENPqNmu.js";import{M as s,P as o,C as l}from"./WithTooltip-SK46ZJ2J-2bbRu1qe.js";import{S as d}from"./SkipLink.stories-sV-I_ayH.js";import"./preload-helper-Dp1pzeXC.js";import"./index-kBCu6VdG.js";import"./lite-DaUVFjkg.js";function i(r){const n={code:"code",h1:"h1",h2:"h2",h4:"h4",hr:"hr",p:"p",pre:"pre",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:d}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { SkipLink } from 'rk-designsystem';\r
\r
<SkipLink href="#main-content">Hopp til hovedinnhold</SkipLink>\r
\r
<main id="main-content" tabIndex={-1}>\r
  Region som kan motta fokus fra skiplink.\r
  {/* Sett fokus hit når linken følges */}\r
  {/* Sørg for outline/fokusstil ved fokus */}\r
</main>
`})}),`
`,e.jsx(n.hr,{}),`
