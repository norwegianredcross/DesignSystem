import{r as u,j as e}from"./iframe-Dm7Vn_HN.js";import{R as o,u as g,F as n}from"./index-Cb5t2Wcw.js";import{V as D}from"./tooltip-6MlRq09s.js";import"./preload-helper-u0ftyAaf.js";import"./XMark-Pg344r5d.js";import"./useId-D6PtN5qq.js";import"./index-DDyEo3cV.js";import"./index-BtGFftGE.js";const T={title:"Components/Radio/Advanced",component:o,tags:["autodocs"],parameters:{docs:{description:{component:"Radio buttons allow users to select one option from a set. Use Fieldset for grouping."}}},argTypes:{label:{control:"text",description:"Radio label"},description:{control:"text",description:"Description for field"},disabled:{control:"boolean",description:"Disables element",defaultValue:!1},readOnly:{control:"boolean",description:"Toggle readOnly",defaultValue:!1},value:{control:"text",description:"Value of the input element"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"primary-color-red"},error:{control:"text",description:"Error message for field (often used with Fieldset/hook)"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},checked:{control:!1},defaultChecked:{control:!1},name:{control:!1}}},d={render:a=>e.jsx(n,{children:e.jsx(o,{...a})}),args:{label:"Enkeltvalg",value:"single_option",name:"single-radio-group"}},i={render:a=>{const[l,t]=u.useState("jordbaer"),{getRadioProps:r}=g({name:"ice-cream-flavor",value:l,onChange:s=>t(s),disabled:a.disabled,readOnly:a.readOnly});return e.jsxs(n,{children:[e.jsx(n.Description,{children:"Velg din favorittsmak blant alternativene."}),e.jsx(o,{label:"Vanilje",...r("vanilje"),"data-size":a["data-size"],"data-color":a["data-color"]}),e.jsx(o,{label:"Jordbær",description:"Jordbær er best",...r("jordbaer"),"data-size":a["data-size"],"data-color":a["data-color"]}),e.jsx(o,{label:"Sjokolade",...r("sjokolade"),"data-size":a["data-size"],"data-color":a["data-color"]}),e.jsx(o,{label:"Jeg spiser ikke iskrem",...r("ingen"),"data-size":a["data-size"],"data-color":a["data-color"]})]})},argTypes:{label:{control:!1},description:{control:!1},value:{control:!1},checked:{control:!1},defaultChecked:{control:!1},error:{control:!1},disabled:{control:"boolean",defaultValue:!1},readOnly:{control:"boolean",defaultValue:!1},"data-size":{control:"select",options:["sm","md","lg"]},"data-color":{control:"select",options:["primary-color-red","neutral"]}},args:{disabled:!1,readOnly:!1,"data-size":"md","data-color":"primary-color-red"}},c={render:a=>{const[l,t]=u.useState(""),r=a.error||"Du må velge en smak!",{getRadioProps:s,validationMessageProps:S}=g({name:"ice-cream-error",value:l,onChange:t,error:r});return e.jsxs(n,{children:[e.jsx(n.Description,{children:"Velg din favorittsmak blant alternativene."}),e.jsx(o,{label:"Vanilje",...s("vanilje")}),e.jsx(o,{label:"Jordbær",...s("jordbaer")}),e.jsx(o,{label:"Sjokolade",...s("sjokolade")}),e.jsx(D,{...S,children:r})]})},argTypes:{label:{control:!1},description:{control:!1},value:{control:!1},checked:{control:!1},defaultChecked:{control:!1},disabled:{control:!1},readOnly:{control:!1},error:{control:"text",defaultValue:"Du må velge en smak!"}},args:{"data-size":"md","data-color":"primary-color-red",error:"Du må velge en smak!"},name:"Group with Error"},p={render:a=>{const[l,t]=u.useState("ja"),{getRadioProps:r}=g({name:"contact-inline",value:l,onChange:t});return e.jsxs(n,{children:[e.jsx(n.Description,{children:"Bekreft om du ønsker å bli kontaktet per e-post."}),e.jsxs("div",{style:{display:"flex",gap:"1rem"},children:[e.jsx(o,{label:"Ja",...r("ja"),"data-size":a["data-size"]}),e.jsx(o,{label:"Nei",...r("nei"),"data-size":a["data-size"]})]})]})},args:{"data-size":"md"}},w=["Single","RadioGroup","WithError","Inline"];var m,f,b;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(b=(f=d.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var j,k,x;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: args => {
...
}`,...(x=(k=i.parameters)==null?void 0:k.docs)==null?void 0:x.source}}};var V,v,R;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: args => {
...
}`,...(R=(v=c.parameters)==null?void 0:v.docs)==null?void 0:R.source}}};var y,h,z;p.parameters={...p.parameters,docs:{...(y=p.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
...
}`,...(z=(h=p.parameters)==null?void 0:h.docs)==null?void 0:z.source}}};export{p as Inline,i as RadioGroup,d as Single,c as WithError,w as __namedExportsOrder,T as default};
