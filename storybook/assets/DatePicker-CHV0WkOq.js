import{j as e}from"./iframe-C-f8trZc.js";import{useMDXComponents as i}from"./index-DOlcghGr.js";import{M as l,P as o,C as a,a as d}from"./WithTooltip-SK46ZJ2J-CjcHKAAu.js";import{D as c,a as s,C as h,b as j,c as x}from"./DatePicker.stories-ySDRkR1q.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DtnBSzEB.js";import"./button-s-EFVStT.js";import"./index-C5Gkf7MA.js";import"./lite-DaUVFjkg.js";import"./spinner-D4eXZ9ju.js";import"./use-merge-refs-6K5Hje1K.js";import"./index-DEIUn20h.js";function t(r){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:c}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { DatePicker } from '@rk-designsystem';\r
import { useState } from 'react';\r
\r
// For å bruke kalenderen, må du håndtere state selv.\r
const MyCalendar = () => {\r
  const [selected, setSelected] = useState<Date | null>(new Date());\r
\r
  return (\r
    <DatePicker\r
      selectedDate={selected}\r
      onDateSelect={setSelected}\r
      initialDate={new Date()}\r
    />\r
  );\r
}
`})}),`
