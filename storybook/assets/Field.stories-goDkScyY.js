import{j as e}from"./iframe-D-CvsFF9.js";import{F as n,a as W,b as R}from"./index-h6HlfTMW.js";import{c as l,F as t,b as d,d as h,e as p,V as I,I as G}from"./tooltip-VS67X2YO.js";const{expect:i,within:q,userEvent:g,waitFor:o}=__STORYBOOK_MODULE_TEST__,P={title:"Components/Field",component:n,tags:["autodocs"],parameters:{docs:{description:{component:"Field is used to structure form elements with labels, descriptions, errors, prefixes, suffixes, and counters."}}},argTypes:{position:{control:"select",options:["start","end"],description:"Position of toggle inputs (radio, checkbox, switch)",defaultValue:"start"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},children:{control:!1,description:"Field content, typically Label, Textfield, FieldDescription, etc."}}},m={name:"Example Basic",render:a=>e.jsxs(n,{...a,children:[e.jsx(l,{id:"textfield-default-label",htmlFor:"textfield-default",children:"Label"}),e.jsx(W,{children:"Short description for the field"}),e.jsx(d,{id:"textfield-default",placeholder:"Enter text...","aria-labelledby":"textfield-default-label"}),e.jsx(I,{children:"Error message"})]}),args:{"data-size":"md","data-color":"neutral"}},b={name:"Example with Counter",render:a=>e.jsxs(n,{...a,children:[e.jsx(l,{id:"textarea-counter-label",htmlFor:"textarea-counter",children:"Legg til en beskrivelse"}),e.jsx(h,{id:"textarea-counter",maxLength:50,rows:3,"aria-labelledby":"textarea-counter-label"}),e.jsx(R,{limit:50})]}),args:{"data-size":"md"}},u={name:"Example Affixes",render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1.5rem"},"data-color":a["data-color"],children:[e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example1-label",htmlFor:"affix-example1",children:"Hvor mange kroner koster det per måned?"}),e.jsx(n,{"data-size":a["data-size"],style:{display:"inline-block",width:"max-content"},children:e.jsxs(t.Affixes,{children:[e.jsx(t.Affix,{children:"NOK"}),e.jsx(d,{id:"affix-example1",type:"number","aria-labelledby":"affix-example1-label"}),e.jsx(t.Affix,{children:"pr. mnd."})]})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example2-label",htmlFor:"affix-example2",children:"Hvor mange kilo veier eplene du har valgt?"}),e.jsx(n,{"data-size":a["data-size"],style:{display:"inline-block",width:"max-content"},children:e.jsxs(t.Affixes,{children:[e.jsx(h,{id:"affix-example2",rows:2,"aria-labelledby":"affix-example2-label"}),e.jsx(t.Affix,{children:"KG"})]})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example3-label",htmlFor:"affix-example3",children:"Hvor mange kroner koster det?"}),e.jsx(n,{"data-size":a["data-size"],style:{display:"inline-block",width:"max-content"},children:e.jsxs(t.Affixes,{children:[e.jsx(t.Affix,{children:"NOK"}),e.jsxs(p,{id:"affix-example3","aria-labelledby":"affix-example3-label",children:[e.jsx(p.Option,{value:"-1",children:"Velg …"}),e.jsx(p.Option,{value:"10",children:"10"}),e.jsx(p.Option,{value:"20",children:"20"}),e.jsx(p.Option,{value:"30",children:"30"})]})]})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example4-label",htmlFor:"affix-example4",children:"No affix"}),e.jsx(n,{"data-size":a["data-size"],children:e.jsx(d,{id:"affix-example4","aria-labelledby":"affix-example4-label"})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example5-label",htmlFor:"affix-example5",children:"No affix and small size"}),e.jsx(n,{"data-size":"sm",children:e.jsx(d,{id:"affix-example5","aria-labelledby":"affix-example5-label"})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example6-label",htmlFor:"affix-example6",children:"No affix and large size"}),e.jsx(n,{"data-size":"lg",children:e.jsx(d,{id:"affix-example6","aria-labelledby":"affix-example6-label"})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example7-label",htmlFor:"affix-example7",children:"Affix and small size"}),e.jsx(n,{"data-size":"sm",style:{display:"inline-block",width:"max-content"},children:e.jsxs(t.Affixes,{children:[e.jsx(t.Affix,{children:"NOK"}),e.jsx(d,{id:"affix-example7","aria-labelledby":"affix-example7-label"}),e.jsx(t.Affix,{children:"pr. mnd."})]})})]}),e.jsxs(e.Fragment,{children:[e.jsx(l,{id:"affix-example8-label",htmlFor:"affix-example8",children:"Affix and large size"}),e.jsx(n,{"data-size":"lg",style:{display:"inline-block",width:"max-content"},children:e.jsxs(t.Affixes,{children:[e.jsx(t.Affix,{children:"NOK"}),e.jsx(d,{id:"affix-example8","aria-labelledby":"affix-example8-label"}),e.jsx(t.Affix,{children:"pr. mnd."})]})})]})]}),args:{"data-size":"md","data-color":"neutral"},argTypes:{position:{control:!1}}},c={name:"Test: Label, Description And Validation Wiring",render:a=>e.jsxs(n,{...a,children:[e.jsx(l,{children:"Fullt navn"}),e.jsx(W,{children:"Skriv både fornavn og etternavn"}),e.jsx(G,{}),e.jsx(I,{children:"Du må fylle ut navn"})]}),args:{"data-size":"md"},play:async({canvasElement:a})=>{const x=q(a),r=await o(()=>x.getByLabelText("Fullt navn")),s=x.getByText("Fullt navn");i(r).toHaveAttribute("id"),i(s).toHaveAttribute("for",r.id);const F=x.getByText("Skriv både fornavn og etternavn"),y=x.getByText("Du må fylle ut navn");await o(()=>{i(F).toHaveAttribute("id"),i(y).toHaveAttribute("id");const v=r.getAttribute("aria-describedby")??"";i(v).toContain(F.id),i(v).toContain(y.id)}),await o(()=>{i(r).toHaveAttribute("aria-invalid","true")}),await g.click(s),i(r).toHaveFocus(),await g.type(r,"Frodo Baggins"),i(r).toHaveValue("Frodo Baggins")}},f={name:"Test: Counter Counts Down While Typing",render:a=>e.jsxs(n,{...a,children:[e.jsx(l,{children:"Kort melding"}),e.jsx(h,{rows:3}),e.jsx(R,{limit:25})]}),args:{"data-size":"md"},play:async({canvasElement:a})=>{const x=q(a),r=await o(()=>x.getByLabelText("Kort melding")),s=a.querySelector('[data-field="counter"]');i(s).not.toBeNull(),await o(()=>{i(s).toHaveAttribute("data-label","25 tegn igjen"),i(s).toHaveAttribute("data-state","under")}),await g.type(r,"Røde Kors"),await o(()=>{i(s).toHaveAttribute("data-label","16 tegn igjen")}),await g.type(r," i hele Norge, hver eneste dag"),await o(()=>{i(s).toHaveAttribute("data-label","14 tegn for mye"),i(s).toHaveAttribute("data-state","over")})}},U=["DefaultTextfield","WithCounter","AffixExamples","TestCompositionWiring","TestCounterCountsDown"];var D,j,A;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Example Basic',
...
}`,...(S=(k=u.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var E,H,C,O,B;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(C=(H=c.parameters)==null?void 0:H.docs)==null?void 0:C.source},description:{story:`Tests the core composition wiring of Field: without any explicit ids,
...
input, and sets aria-invalid when a validation message is present.`,...(B=(O=c.parameters)==null?void 0:O.docs)==null?void 0:B.description}}};var N,K,V,_,M;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(V=(K=f.parameters)==null?void 0:K.docs)==null?void 0:V.source},description:{story:`Tests that FieldCounter counts down as the user types, and flips to an
"over the limit" message when the text gets too long (negative case —
no maxLength is set, so overtyping is possible).`,...(M=(_=f.parameters)==null?void 0:_.docs)==null?void 0:M.description}}};const X=Object.freeze(Object.defineProperty({__proto__:null,AffixExamples:u,DefaultTextfield:m,TestCompositionWiring:c,TestCounterCountsDown:f,WithCounter:b,__namedExportsOrder:U,default:P},Symbol.toStringTag,{value:"Module"}));export{u as A,m as D,X as F,b as W};
