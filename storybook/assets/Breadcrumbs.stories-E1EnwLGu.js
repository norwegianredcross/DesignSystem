import{r as m,j as e}from"./iframe-B-HjE-WD.js";import{c as R}from"./lite-DaUVFjkg.js";import{L as V}from"./link-ci7_xBSR.js";import{u as P}from"./use-merge-refs-DDjH8w8d.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BLsfKIQN.js";const q=m.forwardRef(({"aria-label":r="Du er her:",className:d,...t},c)=>e.jsx("nav",{"aria-label":r,className:R("ds-breadcrumbs",d),ref:c,...t})),C=m.forwardRef(function({className:d,...t},c){return e.jsx("li",{ref:c,...t})}),S=m.forwardRef(function(d,t){return e.jsx(V,{ref:t,...d})}),E=m.forwardRef(function(d,t){const c=m.useRef(null),O=P([c,t]);return m.useEffect(()=>{var f;const l=((f=c.current)==null?void 0:f.querySelectorAll(":scope > * > *"))||[],i=l[(l==null?void 0:l.length)-1];return i==null||i.setAttribute("aria-current","page"),()=>i==null?void 0:i.removeAttribute("aria-current")}),e.jsx("ol",{ref:O,...d})}),B=Object.assign(q,{List:E,Item:C,Link:S});B.List.displayName="Breadcrumbs.List";B.Item.displayName="Breadcrumbs.Item";B.Link.displayName="Breadcrumbs.Link";const n=B,o=E,s=C,a=S;try{n.displayName="Breadcrumbs",n.__docgenInfo={description:"",displayName:"Breadcrumbs",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
Select from predefined colors and colors defined using theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}},"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},"aria-label":{defaultValue:{value:"'Du er her'"},description:"Sets the screen reader label for the Breadcrumbs area",name:"aria-label",required:!1,type:{name:"string"}}}}}catch{}try{o.displayName="BreadcrumbsList",o.__docgenInfo={description:"",displayName:"BreadcrumbsList",props:{}}}catch{}try{s.displayName="BreadcrumbsItem",s.__docgenInfo={description:"",displayName:"BreadcrumbsItem",props:{}}}catch{}try{a.displayName="BreadcrumbsLink",a.__docgenInfo={description:"",displayName:"BreadcrumbsLink",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
