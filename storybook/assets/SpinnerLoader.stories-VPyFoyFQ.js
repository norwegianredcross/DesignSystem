import{j as e}from"./iframe-ChmhbHcN.js";import{S as t}from"./index-DtGaZtS8.js";import{B as f}from"./index-B24lJK8w.js";const{expect:r,within:L}=__STORYBOOK_MODULE_TEST__,j={title:"Components/SpinnerLoader",component:t,tags:["autodocs"],parameters:{docs:{description:{component:"Spinner indicates that an action is in progress, like submitting a form."}},layout:"centered"},argTypes:{"aria-label":{control:"text",description:"Accessible label describing the loading state.",defaultValue:"Henter kaffi"},"data-size":{control:"select",options:["2xs","xs","sm","md","lg","xl"],description:"Spinner size",defaultValue:"md"},"aria-hidden":{table:{disable:!0}}}},n={args:{"aria-label":"Laster innhold","data-size":"md","aria-hidden":!0}},i={render:a=>e.jsxs("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e.jsx(t,{"aria-label":a["aria-label"],"data-size":"2xs","aria-hidden":!0}),e.jsx(t,{"aria-label":a["aria-label"],"data-size":"xs","aria-hidden":!0}),e.jsx(t,{"aria-label":a["aria-label"],"data-size":"sm","aria-hidden":!0}),e.jsx(t,{"aria-label":a["aria-label"],"data-size":"md","aria-hidden":!0}),e.jsx(t,{"aria-label":a["aria-label"],"data-size":"lg","aria-hidden":!0}),e.jsx(t,{"aria-label":a["aria-label"],"data-size":"xl","aria-hidden":!0})]}),args:{"aria-label":"Laster..."},argTypes:{"data-size":{control:!1},"aria-label":{control:"text"}}},s={render:()=>e.jsx(f,{loading:!0,children:"Lagrer…"}),args:{"aria-label":"Laster..."},name:"In Button"},l={name:"Test: Accessible And Decorative Contracts",tags:["!autodocs"],render:()=>e.jsxs("div",{children:[e.jsx(t,{"aria-label":"Henter aktivitetsdata","data-size":"lg"}),e.jsx(f,{loading:!0,children:"Lagrer"})]}),play:async({canvasElement:a})=>{const d=L(a),o=d.getByRole("img",{name:"Henter aktivitetsdata"}),c=d.getByRole("button",{name:/Lagrer/}),B=c.querySelector("svg");await r(o).toHaveAttribute("viewBox","0 0 50 50"),await r(o).toHaveAttribute("data-size","lg"),await r(o.querySelectorAll("circle")).toHaveLength(2),await r(B).toHaveAttribute("aria-hidden","true"),await r(c).toHaveAttribute("aria-busy","true")}},H=["Default","Sizes","InButton","TestAccessibleAndDecorativeContracts"];var u,b,p;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    'aria-label': 'Laster innhold',
    'data-size': 'md',
    'aria-hidden': true
  }
}`,...(p=(b=n.parameters)==null?void 0:b.docs)==null?void 0:p.source}}};var g,m,x;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(x=(m=i.parameters)==null?void 0:m.docs)==null?void 0:x.source}}};var v,S,h;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(A=(z=l.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};const D=Object.freeze(Object.defineProperty({__proto__:null,Default:n,InButton:s,Sizes:i,TestAccessibleAndDecorativeContracts:l,__namedExportsOrder:H,default:j},Symbol.toStringTag,{value:"Module"}));export{D as S,i as a};
