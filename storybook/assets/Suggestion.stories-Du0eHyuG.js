import{r as p,j as t}from"./iframe-CsI9oJWj.js";import{W as Xe}from"./tooltip-Bm697Xoq.js";import{F as w}from"./index-Bqlqcl7g.js";import{L as x}from"./index-CFqsG-qT.js";import{S as Ke}from"./index-SEUpr8_Y.js";const a=Xe;a.displayName="Suggestion";try{a.displayName="Suggestion",a.__docgenInfo={description:`Suggestion-komponent for autofullfør/søkeforslag.
...
See {@link Filter} for the callback signature.`,name:"filter",required:!1,type:{name:"boolean | Filter"}},creatable:{defaultValue:{value:"false"},description:"Allows the user to create new items",name:"creatable",required:!1,type:{name:"boolean"}},onBeforeMatch:{defaultValue:null,description:"Callback when matching input value against options",name:"onBeforeMatch",required:!1,type:{name:"(event: EventBeforeMatch) => void"}},name:{defaultValue:{value:"undefined"},description:"The name of the associated form control",name:"name",required:!1,type:{name:"string"}},renderSelected:{defaultValue:{value:"({ label }) => label"},description:"Change how the selected options are rendered inside the `Chip`.",name:"renderSelected",required:!1,type:{name:"(args: { label: string; value: string; }) => ReactNode"}},multiple:{defaultValue:{value:"false"},description:"Allows the user to select multiple items",name:"multiple",required:!1,type:{name:"boolean"}},selected:{defaultValue:null,description:"The selected item of the Suggestion.\n\nIf `label` and `value` are the same, each item can be a `string`. Otherwise, each item must be a `SuggestionItem`.\n\nUsing this makes the component controlled and it must be used in combination with `onSelectedChange`.",name:"selected",required:!1,type:{name:"string | SuggestionItem | (string | SuggestionItem)[]"}},defaultSelected:{defaultValue:null,description:"Default selected item when uncontrolled",name:"defaultSelected",required:!1,type:{name:"string | SuggestionItem | (string | SuggestionItem)[]"}},onSelectedChange:{defaultValue:null,description:"Callback when selected items changes",name:"onSelectedChange",required:!1,type:{name:"((value: SuggestionItem) => void) | ((value: SuggestionItem[]) => void)"}}}}}catch{}const{expect:o,within:h,userEvent:u,waitFor:c,fn:y}=__STORYBOOK_MODULE_TEST__,Ue=(n,l)=>{const s=p.useRef(null);return p.useEffect(()=>()=>{s.current&&clearTimeout(s.current)},[]),p.useCallback((...i)=>{s.current&&clearTimeout(s.current),s.current=window.setTimeout(()=>{n(...i)},l)},[n,l])},Pe={title:"Components/Suggestion",component:a,tags:["autodocs"],parameters:{docs:{description:{component:'A searchable "select" component, with support for single or multiple selections. Use when a standard <Select> is not sufficient.'}},a11y:{test:"todo"}},argTypes:{multiple:{control:"boolean",description:"Allows the user to select multiple items",defaultValue:!1},creatable:{control:"boolean",description:"Allows the user to create new items",defaultValue:!1},filter:{control:"boolean",description:"Filter options based on input (set to false to show all). A custom filter function can also be provided.",defaultValue:!0},name:{control:"text",description:"The name of the associated form control"},selected:{table:{disable:!0}},defaultSelected:{table:{disable:!0}},onSelectedChange:{table:{disable:!0}},onBeforeMatch:{table:{disable:!0}},renderSelected:{table:{disable:!0}},children:{table:{disable:!0}}}},S=[{label:"Sogndal",value:"sogndal"},{label:"Oslo",value:"oslo"},{label:"Bergen",value:"bergen"},{label:"Trondheim",value:"trondheim"},{label:"Stavanger",value:"stavanger"}],O={render:n=>{const[l,s]=p.useState(void 0);return t.jsxs(w,{children:[t.jsx(x,{children:"Velg en destinasjon"}),t.jsxs(a,{...n,selected:l,onSelectedChange:(e=>{Array.isArray(e)||s(e)}),name:"single-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Ingen treff"}),S.map(e=>t.jsx(a.Option,{label:e.label,value:e.value,children:e.label},e.value))]})]})]})},args:{multiple:!1,creatable:!1}},V={render:n=>{const[l,s]=p.useState([S[1]]);return t.jsxs(w,{children:[t.jsx(x,{children:"Velg destinasjoner"}),t.jsxs(a,{...n,selected:l,onSelectedChange:(e=>{Array.isArray(e)&&s(e)}),name:"multi-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Ingen treff"}),S.map(e=>t.jsx(a.Option,{label:e.label,value:e.value,children:e.label},e.value))]})]})]})},args:{multiple:!0},name:"Multi-Select"},B={render:n=>{const[l,s]=p.useState(S),[e,i]=p.useState([]),d=r=>{const m=r.find(b=>b.__new__);if(m){const b={label:m.label,value:m.value};s(M=>[...M,b])}i(r)};return t.jsxs(w,{children:[t.jsx(x,{children:"Velg eller lag destinasjoner"}),t.jsxs(a,{...n,selected:e,onSelectedChange:(r=>{Array.isArray(r)&&d(r)}),name:"creatable-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Ingen treff (trykk Enter for å lage ny)"}),l.map(r=>t.jsx(a.Option,{label:r.label,value:r.value,children:r.label},r.value))]})]})]})},args:{multiple:!0,creatable:!0}},q={render:n=>{const[l,s]=p.useState(""),[e,i]=p.useState(null),[d,r]=p.useState(),b=Ue(async g=>{const v=`https://restcountries.com/v2/name/${g}?fields=name`;try{const f=await fetch(v);if(!f.ok){i([]);return}const R=await f.json();i(Array.isArray(R)?R.map(({name:Ne})=>Ne):[])}catch(f){console.error("Failed to fetch countries:",f),i([])}},500),M=g=>{const v=g.target.value;s(v),i(null);const f=v.trim();f&&b(encodeURIComponent(f))},We=g=>{if(!Array.isArray(g)&&g){const v=g;s(v.label),r(v),i(null)}};return t.jsxs(w,{lang:"en",children:[t.jsx(x,{children:"Search for countries (in english)"}),t.jsxs(a,{...n,selected:d,onSelectedChange:We,children:[t.jsx(a.Input,{onInput:M,value:l}),t.jsx(a.Clear,{}),t.jsxs(a.List,{singular:"%d country",plural:"%d countries",children:[l?t.jsx(a.Empty,{children:e?"Ingen treff":t.jsxs("span",{style:{display:"flex",alignItems:"center",gap:8},children:[t.jsx(Ke,{"aria-hidden":"true","data-size":"sm"})," Laster..."]})}):null,e==null?void 0:e.map(g=>t.jsx(a.Option,{label:g,value:g,children:g},g))]})]})]})},args:{filter:!1},name:"Async Loading"},_={render:n=>{const[l,s]=p.useState(void 0);return t.jsxs(w,{children:[t.jsx(x,{children:"Velg en destinasjon (viser alltid alle)"}),t.jsxs(a,{...n,selected:l,onSelectedChange:(e=>{Array.isArray(e)||s(e)}),name:"no-filter-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Listen er tom"}),S.map(e=>t.jsx(a.Option,{label:e.label,value:e.value,children:e.label},e.value))]})]})]})},args:{filter:!1},name:"No Filter"},C=n=>{const[l,s]=p.useState(void 0);return t.jsxs(w,{children:[t.jsx(x,{children:"Velg en destinasjon"}),t.jsxs(a,{...n,selected:l,onSelectedChange:(e=>{var i;(i=n.onSelectedChange)==null||i.call(n,e),Array.isArray(e)||s(e??void 0)}),name:"test-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Ingen treff"}),S.map(e=>t.jsx(a.Option,{label:e.label,value:e.value,children:e.label},e.value))]})]})]})},A=async n=>await c(()=>n.getByLabelText("Velg en destinasjon")),E={name:"Test: Combobox Aria Attributes",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n})=>{const l=h(n),s=await A(l),e=n.querySelector("u-datalist");await c(()=>{o(s).toHaveAttribute("role","combobox"),o(s).toHaveAttribute("aria-autocomplete","list"),o(e).toHaveAttribute("id"),o(s).toHaveAttribute("aria-controls",e==null?void 0:e.id)}),o(e).toHaveAttribute("role","listbox"),await u.click(s),await c(()=>{o(e).not.toHaveAttribute("hidden")}),o(s).toHaveAttribute("aria-expanded","true")}},k={name:"Test: Typing Filters Options",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n})=>{const l=h(n),s=await A(l);await u.click(s);const e=Array.from(n.querySelectorAll("u-option:not([data-empty])"));o(e).toHaveLength(S.length),await c(()=>{for(const i of e)o(i).toHaveAttribute("aria-hidden","false")}),await u.type(s,"berg"),await c(()=>{const i=e.find(r=>r.textContent==="Bergen"),d=e.find(r=>r.textContent==="Oslo");o(i).toHaveAttribute("aria-hidden","false"),o(i).not.toHaveAttribute("disabled"),o(d).toHaveAttribute("aria-hidden","true"),o(d).toHaveAttribute("disabled")})}},T={name:"Test: Keyboard Selection",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n,args:l})=>{const s=h(n),e=await A(s);await u.click(e),await u.type(e,"osl"),await u.keyboard("{ArrowDown}"),await c(()=>{const i=n.ownerDocument.activeElement;o(i==null?void 0:i.textContent).toBe("Oslo"),o(i).toHaveAttribute("role","option")}),await u.keyboard("{Enter}"),await c(()=>{o(l.onSelectedChange).toHaveBeenLastCalledWith({label:"Oslo",value:"oslo"}),o(e).toHaveValue("Oslo")})}},I={name:"Test: Mouse Selection",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n,args:l})=>{const s=h(n),e=await A(s),i=n.querySelector("u-datalist");await u.click(e),await u.type(e,"trond");const d=await c(()=>{const r=Array.from(n.querySelectorAll("u-option:not([data-empty])")).find(m=>m.textContent==="Trondheim");return o(r).toHaveAttribute("aria-hidden","false"),r});await u.click(d),await c(()=>{o(l.onSelectedChange).toHaveBeenLastCalledWith({label:"Trondheim",value:"trondheim"}),o(e).toHaveValue("Trondheim"),o(i).toHaveAttribute("hidden")})}},H={name:"Test: Escape Closes List",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n,args:l})=>{const s=h(n),e=await A(s),i=n.querySelector("u-datalist");await u.click(e),await c(()=>{o(i).not.toHaveAttribute("hidden")}),await u.keyboard("{Escape}"),await c(()=>{o(i).toHaveAttribute("hidden")}),o(l.onSelectedChange).not.toHaveBeenCalled(),o(e).toHaveValue("")}},j={name:"Test: Empty State",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n})=>{const l=h(n),s=await A(l);await u.click(s),await u.type(s,"finnes-ikke");const e=await c(()=>l.getByText("Ingen treff"));o(e).toBeVisible(),await c(()=>{for(const i of n.querySelectorAll("u-option:not([data-empty])"))o(i).toHaveAttribute("aria-hidden","true")})}},F={name:"Test: Clear Selection",render:C,args:{onSelectedChange:y()},play:async({canvasElement:n,args:l})=>{const s=h(n),e=await A(s);await u.click(e),await u.type(e,"sogn");const i=await c(()=>{const r=Array.from(n.querySelectorAll("u-option:not([data-empty])")).find(m=>m.textContent==="Sogndal");return o(r).toHaveAttribute("aria-hidden","false"),r});await u.click(i),await c(()=>{o(e).toHaveValue("Sogndal")});const d=await c(()=>{const r=n.querySelector('del[aria-label="Tøm"]');return o(r).toBeTruthy(),r});await u.click(d),await c(()=>{o(e).toHaveValue("")}),o(e).toHaveFocus(),await u.tab(),await c(()=>{o(l.onSelectedChange).toHaveBeenLastCalledWith(null),o(e).toHaveValue("")})}},L={name:"Test: Multi-Select Interaction",render:n=>{const[l,s]=p.useState([]);return t.jsxs(w,{children:[t.jsx(x,{children:"Velg destinasjoner"}),t.jsxs(a,{...n,selected:l,onSelectedChange:(e=>{var i;(i=n.onSelectedChange)==null||i.call(n,e),Array.isArray(e)&&s(e)}),name:"test-multi-destination",children:[t.jsx(a.Input,{}),t.jsx(a.Clear,{}),t.jsxs(a.List,{children:[t.jsx(a.Empty,{children:"Ingen treff"}),S.map(e=>t.jsx(a.Option,{label:e.label,value:e.value,children:e.label},e.value))]})]})]})},args:{multiple:!0,onSelectedChange:y()},play:async({canvasElement:n,args:l})=>{const s=h(n),e=await c(()=>s.getByLabelText("Velg destinasjoner")),i=async d=>{await u.click(e);const r=await c(()=>{const m=Array.from(n.querySelectorAll("u-option:not([data-empty])")).find(b=>b.textContent===d);return o(m).toHaveAttribute("aria-hidden","false"),m});await u.click(r)};await i("Oslo"),await c(()=>{o(l.onSelectedChange).toHaveBeenLastCalledWith([{label:"Oslo",value:"oslo"}])}),await i("Bergen"),await c(()=>{o(l.onSelectedChange).toHaveBeenLastCalledWith([{label:"Oslo",value:"oslo"},{label:"Bergen",value:"bergen"}])}),await c(()=>{const d=n.querySelectorAll('data[aria-selected="true"]');o(d).toHaveLength(2)})}};var D,W,N;O.parameters={...O.parameters,docs:{...(D=O.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: args => {
  ...
  name: 'No Filter'
}`,...(ee=(Z=_.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ne,ae,se,oe;E.parameters={...E.parameters,docs:{...(te=E.parameters)==null?void 0:te.docs,source:{originalSource:`{
...
list, Enter to select. Selection fills the input and fires the callback.`,...(Se=(me=T.parameters)==null?void 0:me.docs)==null?void 0:Se.description}}};var he,ye,be,ve,fe;I.parameters={...I.parameters,docs:{...(he=I.parameters)==null?void 0:he.docs,source:{originalSource:`{
...
fires the callback, and closes the list.`,...(fe=(ve=I.parameters)==null?void 0:ve.docs)==null?void 0:fe.description}}};var we,xe,Ce,Ae,Ee;H.parameters={...H.parameters,docs:{...(we=H.parameters)==null?void 0:we.docs,source:{originalSource:`{
