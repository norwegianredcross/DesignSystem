import{j as t,r as ne}from"./iframe-ChmhbHcN.js";import{C as ae}from"./tooltip-Dtx4fO_9.js";const r=ae,{expect:n,within:u,userEvent:c,waitFor:B,fn:b}=__STORYBOOK_MODULE_TEST__,te={title:"Components/Chip",tags:["autodocs"],parameters:{docs:{description:{component:"Chip has several variants used for selection or removal. Use Chip.Radio, Chip.Checkbox, Chip.Removable, or Chip.Button."}}}},k={render:()=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Radio,{name:"language-radio",value:"nynorsk",defaultChecked:!0,children:"Nynorsk"}),t.jsx(r.Radio,{name:"language-radio",value:"bokmaal",children:"Bokmål"}),t.jsx(r.Radio,{name:"language-radio",value:"engelsk","data-size":"lg",children:"Engelsk (Large)"}),t.jsx(r.Radio,{name:"language-radio",value:"disabled",disabled:!0,children:"Disabled"})]}),name:"Example Radio Variant"},v={render:()=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Checkbox,{name:"filter-checkbox",value:"nynorsk",defaultChecked:!0,children:"Nynorsk"}),t.jsx(r.Checkbox,{name:"filter-checkbox",value:"bokmaal","data-color":"secondary-color-rust",children:"Bokmål (Brand1)"}),t.jsx(r.Checkbox,{name:"filter-checkbox",value:"engelsk","data-size":"sm",children:"Engelsk (Small)"}),t.jsx(r.Checkbox,{name:"filter-checkbox",value:"disabled",disabled:!0,children:"Disabled"})]}),name:"Example Checkbox Variant"},C={render:()=>{const[a,e]=ne.useState(["Norge","Sverige","Danmark"]),o=i=>{e(s=>s.filter(l=>l!==i))};return t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[a.map(i=>t.jsx(r.Removable,{"aria-label":`Fjern ${i}`,onClick:()=>o(i),"data-color":"neutral","data-size":"md",children:i},i)),a.length===0&&t.jsx("p",{children:"All chips removed."})]})},name:"Example Removable Variant"},g={render:()=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Button,{onClick:()=>alert("Nynorsk clicked"),children:"Søk etter nynorsk"}),t.jsx(r.Button,{onClick:()=>alert("Bokmål clicked"),"data-color":"additional-color-ocean",children:"Søk etter bokmål (Brand2)"}),t.jsx(r.Button,{onClick:()=>alert("Engelsk clicked"),"data-size":"lg",children:"Søk etter engelsk (Large)"}),t.jsx(r.Button,{disabled:!0,children:"Disabled"})]}),name:"Example Button Variant"},d={name:"Test: Removable Chip",render:a=>{const[e,o]=ne.useState(["Norge","Sverige","Danmark"]),i=s=>{var l;(l=a.onRemove)==null||l.call(a,s),o(x=>x.filter(y=>y!==s))};return t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.map(s=>t.jsx(r.Removable,{"aria-label":`Fjern ${s}`,onClick:()=>i(s),children:s},s)),e.length===0&&t.jsx("p",{children:"Alle valg er fjernet."})]})},args:{onRemove:b()},play:async({canvasElement:a,args:e})=>{const o=u(a),i=o.getByRole("button",{name:"Fjern Sverige"});n(i).toHaveAttribute("data-removable"),n(i).toHaveTextContent("Sverige"),await c.click(i),n(e.onRemove).toHaveBeenCalledTimes(1),n(e.onRemove).toHaveBeenLastCalledWith("Sverige"),await B(()=>n(o.queryByRole("button",{name:"Fjern Sverige"})).not.toBeInTheDocument()),n(o.getByRole("button",{name:"Fjern Norge"})).toBeInTheDocument(),n(o.getByRole("button",{name:"Fjern Danmark"})).toBeInTheDocument(),o.getByRole("button",{name:"Fjern Norge"}).focus(),await c.keyboard("{Enter}"),n(e.onRemove).toHaveBeenLastCalledWith("Norge"),await B(()=>n(o.queryByRole("button",{name:"Fjern Norge"})).not.toBeInTheDocument()),n(e.onRemove).toHaveBeenCalledTimes(2)}},h={name:"Test: Radio Chips Selection",render:a=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Radio,{name:"test-language",value:"nynorsk",defaultChecked:!0,onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"nynorsk")},children:"Nynorsk"}),t.jsx(r.Radio,{name:"test-language",value:"bokmaal",onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"bokmaal")},children:"Bokmål"}),t.jsx(r.Radio,{name:"test-language",value:"engelsk",onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"engelsk")},children:"Engelsk"})]}),args:{onChange:b()},play:async({canvasElement:a,args:e})=>{const o=u(a),i=o.getByRole("radio",{name:"Nynorsk"}),s=o.getByRole("radio",{name:"Bokmål"}),l=o.getByRole("radio",{name:"Engelsk"});n(i).toBeChecked(),n(s).not.toBeChecked(),await c.click(o.getByText("Bokmål")),n(s).toBeChecked(),n(i).not.toBeChecked(),n(l).not.toBeChecked(),n(e.onChange).toHaveBeenCalledTimes(1),n(e.onChange).toHaveBeenLastCalledWith("bokmaal"),n(s).toHaveFocus(),await c.keyboard("{ArrowRight}"),n(l).toHaveFocus(),n(l).toBeChecked(),n(s).not.toBeChecked(),n(e.onChange).toHaveBeenLastCalledWith("engelsk"),await c.keyboard("{ArrowLeft}"),n(s).toHaveFocus(),n(s).toBeChecked(),n(l).not.toBeChecked();const x=[i,s,l].filter(y=>y.checked);n(x).toHaveLength(1)}},p={name:"Test: Checkbox Chips Multi-Selection",render:a=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Checkbox,{name:"test-filter",value:"norge",onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"norge")},children:"Norge"}),t.jsx(r.Checkbox,{name:"test-filter",value:"sverige",onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"sverige")},children:"Sverige"}),t.jsx(r.Checkbox,{name:"test-filter",value:"danmark",disabled:!0,onChange:()=>{var e;return(e=a.onChange)==null?void 0:e.call(a,"danmark")},children:"Danmark"})]}),args:{onChange:b()},play:async({canvasElement:a,args:e})=>{const o=u(a),i=o.getByRole("checkbox",{name:"Norge"}),s=o.getByRole("checkbox",{name:"Sverige"}),l=o.getByRole("checkbox",{name:"Danmark"});await c.click(o.getByText("Norge")),n(i).toBeChecked(),n(s).not.toBeChecked(),await c.click(o.getByText("Sverige")),n(s).toBeChecked(),n(i).toBeChecked(),n(e.onChange).toHaveBeenCalledTimes(2),i.focus(),await c.keyboard(" "),n(i).not.toBeChecked(),n(s).toBeChecked(),n(e.onChange).toHaveBeenCalledTimes(3),n(l).toBeDisabled(),await c.click(o.getByText("Danmark")),n(l).not.toBeChecked(),n(e.onChange).toHaveBeenCalledTimes(3)}},m={name:"Test: Button Chip Activation",render:a=>t.jsxs("div",{style:{display:"flex",gap:"8px"},children:[t.jsx(r.Button,{onClick:()=>{var e;return(e=a.onSearch)==null?void 0:e.call(a,"nynorsk")},children:"Søk etter nynorsk"}),t.jsx(r.Button,{disabled:!0,onClick:()=>{var e;return(e=a.onSearch)==null?void 0:e.call(a,"deaktivert")},children:"Deaktivert"})]}),args:{onSearch:b()},play:async({canvasElement:a,args:e})=>{const o=u(a),i=o.getByRole("button",{name:"Søk etter nynorsk"});n(i).toHaveAttribute("type","button"),await c.click(i),n(e.onSearch).toHaveBeenCalledTimes(1),n(e.onSearch).toHaveBeenLastCalledWith("nynorsk"),i.focus(),await c.keyboard("{Enter}"),await c.keyboard(" "),n(e.onSearch).toHaveBeenCalledTimes(3);const s=o.getByRole("button",{name:"Deaktivert"});n(s).toBeDisabled(),await c.click(s),n(e.onSearch).toHaveBeenCalledTimes(3)}},oe=["Radio","Checkbox","Removable","Button","TestRemovableChip","TestRadioChips","TestCheckboxChips","TestButtonChip"];var R,f,S;k.parameters={...k.parameters,docs:{...(R=k.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '8px'
  }}>
...
}`,...(S=(f=k.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};var T,E,j;v.parameters={...v.parameters,docs:{...(T=v.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '8px'
  }}>
...
}`,...(j=(E=v.parameters)==null?void 0:E.docs)==null?void 0:j.source}}};var w,H,D;C.parameters={...C.parameters,docs:{...(w=C.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => {
