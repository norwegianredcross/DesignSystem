import{r as Ie,j as i}from"./iframe-ChmhbHcN.js";import{T as D}from"./index-sEsi3Pym.js";import{n as Ye,P as Ue,B as Je}from"./tooltip-Dtx4fO_9.js";const{expect:t,within:l,userEvent:o,waitFor:s,fn:E}=__STORYBOOK_MODULE_TEST__,Ge={title:"Components/Textfield",component:D,tags:["autodocs"],parameters:{docs:{description:{component:"Textfield is a composed component for text input or textarea, including label, description, validation, affixes, and counter."}},layout:"padded"},argTypes:{label:{control:"text",description:"Label for the textfield (use this OR aria-label)",defaultValue:"Label"},disabled:{control:"boolean",description:"Disables the textfield",defaultValue:!1},readOnly:{control:"boolean",description:"Makes the textfield read-only",defaultValue:!1},multiline:{control:"boolean",description:"Renders a Textarea instead of Input",defaultValue:!1},description:{control:"text",description:"Description displayed below the label"},error:{control:"text",description:"Error message displayed below the input"},counter:{control:"number",description:"Enables character counter with optional limit"},prefix:{control:"text",description:"Prefix displayed before the input"},suffix:{control:"text",description:"Suffix displayed after the input"},"aria-label":{control:"text",if:{arg:"label",exists:!1}},"aria-labelledby":{control:"text"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},type:{control:"select",options:["text","number","email","password","search","tel","url","date","datetime-local","month","week","time","color","file","hidden"],description:"Input type (ignored if multiline is true)",defaultValue:"text",if:{arg:"multiline",eq:!1}},size:{control:"number",description:"HTML size attribute (input width in characters)",if:{arg:"multiline",eq:!1}},rows:{control:"number",description:"HTML rows attribute (textarea height in lines)",if:{arg:"multiline",eq:!0}},value:{control:"text",table:{disable:!0}},defaultValue:{control:"text"},name:{control:"text"},placeholder:{control:"text"},required:{control:"boolean"},maxLength:{control:"number"},id:{control:"text"},"aria-invalid":{control:"boolean"},"aria-describedby":{control:"text"}}},f={args:{label:"Navn",name:"name-default",placeholder:"Skriv inn navnet ditt"}},y={args:{label:"Beskrivelse",name:"description-multiline",multiline:!0,rows:4,placeholder:"Skriv en lengre beskrivelse..."}},h={args:{label:"Hvor mange kroner koster det per måned?",name:"cost-affix",prefix:"NOK",suffix:"pr. mnd",type:"number"},name:"With Prefix/Suffix"},x={args:{label:"Melding (maks 100 tegn)",name:"message-counter",multiline:!0,rows:3,counter:100,maxLength:100},name:"With Character Counter"},T={args:{label:"E-post",name:"email-desc",description:"Vi sender en bekreftelse til denne adressen.",type:"email"}},k={args:{label:"Telefonnummer *",name:"phone-error",error:"Telefonnummer kan kun inneholde siffer.",required:!0,type:"tel","aria-invalid":!0},name:"With Error"},w={args:{label:"Deaktivert felt",name:"disabled-field",disabled:!0,defaultValue:"Kan ikke endres"}},C={args:{label:"Kun lesbart felt",name:"readonly-field",readOnly:!0,defaultValue:"Denne verdien er satt."}},B={render:r=>{const[a,n]=Ie.useState(""),{label:e,value:H,onChange:V,...K}=r;return i.jsxs(i.Fragment,{children:[i.jsx(D,{label:"Kontroller meg!",value:a,onChange:S=>n(S.target.value),...K}),i.jsx(Ye,{style:{margin:"var(--ds-size-4) 0 var(--ds-size-2) 0"}}),i.jsxs(Ue,{style:{margin:"0"},children:["Du har skrevet inn: ",a||"(ingenting)"]}),i.jsx(Je,{onClick:()=>n("Kake"),style:{marginTop:"var(--ds-size-2)"},children:"Jeg vil ha Kake"})]})},args:{name:"controlled-field",placeholder:"Skriv noe...","data-size":"md"}},c={name:"Test: Typing Updates Value",args:{label:"Fornavn",name:"test-typing",onChange:E()},play:async({canvasElement:r,args:a})=>{const n=l(r),e=await s(()=>n.getByLabelText("Fornavn"));await o.type(e,"Frodo Baggins"),t(e).toHaveValue("Frodo Baggins"),t(a.onChange).toHaveBeenCalledTimes(13);const H=n.getByText("Fornavn");await s(()=>{t(H).toHaveAttribute("for",e.id)})}},d={name:"Test: Controlled Value",render:r=>{const[a,n]=Ie.useState(""),{label:e,value:H,onChange:V,...K}=r;return i.jsxs(i.Fragment,{children:[i.jsx(D,{label:"Kontrollert felt",value:a,onChange:S=>{n(S.target.value),V==null||V(S)},...K}),i.jsxs(Ue,{"data-testid":"mirror",children:["Verdi: ",a||"(ingenting)"]}),i.jsx(Je,{onClick:()=>n("Kake"),children:"Sett til Kake"})]})},args:{name:"test-controlled",onChange:E()},play:async({canvasElement:r,args:a})=>{const n=l(r),e=await s(()=>n.getByLabelText("Kontrollert felt"));await o.type(e,"Bergen"),t(e).toHaveValue("Bergen"),t(n.getByTestId("mirror")).toHaveTextContent("Verdi: Bergen"),t(a.onChange).toHaveBeenCalled(),await o.click(n.getByRole("button",{name:"Sett til Kake"})),t(e).toHaveValue("Kake"),t(n.getByTestId("mirror")).toHaveTextContent("Verdi: Kake")}},u={name:"Test: Description Association",args:{label:"E-post",name:"test-description",description:"Vi sender en bekreftelse til denne adressen.",type:"email"},play:async({canvasElement:r})=>{const a=l(r),n=await s(()=>a.getByLabelText("E-post")),e=a.getByText("Vi sender en bekreftelse til denne adressen.");await s(()=>{t(e).toHaveAttribute("id"),t(n.getAttribute("aria-describedby")).toContain(e.id)})}},p={name:"Test: Error State",args:{label:"Telefonnummer",name:"test-error",type:"tel",required:!0,error:"Telefonnummer kan kun inneholde siffer."},play:async({canvasElement:r})=>{const a=l(r),n=await s(()=>a.getByLabelText(/Telefonnummer/));t(n).toHaveAttribute("aria-invalid","true"),t(n).toBeRequired();const e=a.getByText("Telefonnummer kan kun inneholde siffer.");t(e).toBeVisible(),await s(()=>{t(e).toHaveAttribute("id"),t(n.getAttribute("aria-describedby")).toContain(e.id)})}},m={name:"Test: Disabled State",args:{label:"Deaktivert felt",name:"test-disabled",disabled:!0,defaultValue:"Kan ikke endres",onChange:E()},play:async({canvasElement:r,args:a})=>{const n=l(r),e=await s(()=>n.getByLabelText("Deaktivert felt"));t(e).toBeDisabled(),t(e).toHaveValue("Kan ikke endres"),await o.type(e,"ny tekst"),t(e).toHaveValue("Kan ikke endres"),t(a.onChange).not.toHaveBeenCalled()}},g={name:"Test: ReadOnly State",args:{label:"Kun lesbart felt",name:"test-readonly",readOnly:!0,defaultValue:"Denne verdien er satt.",onChange:E()},play:async({canvasElement:r,args:a})=>{const n=l(r),e=await s(()=>n.getByLabelText("Kun lesbart felt"));t(e).toHaveAttribute("readonly"),await o.click(e),t(e).toHaveFocus(),await o.keyboard("ny tekst"),t(e).toHaveValue("Denne verdien er satt."),t(a.onChange).not.toHaveBeenCalled()}},b={name:"Test: Prefix And Suffix",args:{label:"Hvor mange kroner koster det per måned?",name:"test-affixes",prefix:"NOK",suffix:"pr. mnd",multiline:!1,type:"number"},play:async({canvasElement:r})=>{const a=l(r),n=await s(()=>a.getByLabelText("Hvor mange kroner koster det per måned?"));t(a.getByText("NOK")).toBeVisible(),t(a.getByText("pr. mnd")).toBeVisible(),await o.type(n,"150"),t(n).toHaveValue(150)}},v={name:"Test: Character Counter",args:{label:"Melding",name:"test-counter",multiline:!0,rows:3,counter:40},play:async({canvasElement:r})=>{const a=l(r),n=await s(()=>a.getByLabelText("Melding")),e=r.querySelector('[data-field="counter"]');t(e).not.toBeNull(),await s(()=>{t(e).toHaveAttribute("data-label","40 tegn igjen")}),await o.type(n,"Røde Kors"),await s(()=>{t(e).toHaveAttribute("data-label","31 tegn igjen")}),await o.type(n," hjelper mennesker i nød i hele Norge idag"),await s(()=>{t(e).toHaveAttribute("data-label","11 tegn for mye"),t(e).toHaveAttribute("data-state","over")})}},Qe=["Default","Multiline","WithAffixes","WithCounter","WithDescription","WithError","Disabled","ReadOnly","Controlled","TestTypingUpdatesValue","TestControlledValue","TestDescriptionAssociation","TestErrorState","TestDisabledState","TestReadOnlyState","TestAffixes","TestCharacterCounter"];var A,F,L;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    label: 'Navn',
    name: 'name-default',
...
}`,...(te=(ee=C.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ne,ae,re;B.parameters={...B.parameters,docs:{...(ne=B.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: args => {
...
}`,...(re=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:re.source}}};var se,ie,oe,le,ce;c.parameters={...c.parameters,docs:{...(se=c.parameters)==null?void 0:se.docs,source:{originalSource:`{
...
and the message is linked to the input via aria-describedby.`,...(Ce=(we=p.parameters)==null?void 0:we.docs)==null?void 0:Ce.description}}};var Be,Ve,Se,Ee,He;m.parameters={...m.parameters,docs:{...(Be=m.parameters)==null?void 0:Be.docs,source:{originalSource:`{
...
}`,...(Se=(Ve=m.parameters)==null?void 0:Ve.docs)==null?void 0:Se.source},description:{story:"Tests that a disabled field cannot be edited and fires no change events.",...(He=(Ee=m.parameters)==null?void 0:Ee.docs)==null?void 0:He.description}}};var Ke,De,Ae,Fe,Le;g.parameters={...g.parameters,docs:{...(Ke=g.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
