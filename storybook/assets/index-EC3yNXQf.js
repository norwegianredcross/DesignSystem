import{r as i,j as d}from"./iframe-DJ_T1ny6.js";const b="_crossCorner_1caiu_1",C="_shape_1caiu_6",a={crossCorner:b,shape:C};function y(e){return`
.${e.crossCorner} {
...
Velg fra forhåndsdefinerte farger og farger definert med theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}},"data-size":{defaultValue:null,description:"Endrer størrelse for underliggende Designsystemet-komponenter. Velg fra forhåndsdefinerte størrelser.",name:"data-size",required:!1,type:{name:"Size"}},position:{defaultValue:{value:"top-left"},description:"Which corner the graphic points to.",name:"position",required:!1,type:{name:"enum",value:[{value:'"top-left"'},{value:'"top-right"'},{value:'"bottom-left"'},{value:'"bottom-right"'}]}},size:{defaultValue:{value:"md"},description:`Size of the graphic.
