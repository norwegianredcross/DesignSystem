import{r as g,j as e}from"./iframe-DzHbI1Bv.js";import{S as b}from"./index-B-a3BGFc.js";import{c as I}from"./lite-DaUVFjkg.js";import{B as S}from"./button-BtbJBmjo.js";import{L as h}from"./index-Dd1HA862.js";import"./preload-helper-Dp1pzeXC.js";import"./spinner-C6XrOK33.js";import"./use-merge-refs-B76l2vM2.js";import"./link-Cg5LduE9.js";const L=(t,n,a)=>{const o=(a-1)/2,l=Math.max(1,Math.min(Math.max(t-Math.floor(o),1),n-a+1)),u=Math.min(Math.max(t+Math.ceil(o),a),n),d=Array.from({length:u+1-l},(s,r)=>r+l);return a>4&&l>1&&d.splice(0,2,1,0),a>3&&u<n&&d.splice(-2,2,0,n),d},k=({currentPage:t=1,setCurrentPage:n,onChange:a,totalPages:o=1,showPages:l=7})=>g.useMemo(()=>{const u=t<o,d=t!==1,s=r=>c=>{if(r<1||r>o)return c.preventDefault();a==null||a(c,r),c.defaultPrevented||n==null||n(r)};return{pages:L(t,o,l).map((r,c)=>({page:r||"ellipsis",itemKey:r?`page-${r}`:`ellipsis-${c}`,buttonProps:r?{"aria-current":r===t?"page":void 0,onClick:s(r),variant:r===t?"primary":"tertiary"}:null})),prevButtonProps:{"aria-disabled":!d,onClick:s(t-1),variant:"tertiary"},nextButtonProps:{"aria-disabled":!u,onClick:s(t+1),variant:"tertiary"},hasPrev:d,hasNext:u}},[t,o,l]),_=g.forwardRef(function({"aria-label":n="Sidenavigering",asChild:a,className:o,...l},u){const d=a?b:"nav";return e.jsx(d,{"aria-label":n,className:I("ds-pagination",o),ref:u,...l})}),N=g.forwardRef(function(n,a){return e.jsx(S,{ref:a,...n})}),V=g.forwardRef(function({asChild:n,className:a,...o},l){const u=n?b:"li";return e.jsx(u,{ref:l,...o})}),z=g.forwardRef(function({asChild:n,...a},o){const l=n?b:"ul";return e.jsx(l,{ref:o,...a})}),P=Object.assign(_,{List:z,Item:V,Button:N});P.List.displayName="Pagination.List";P.Item.displayName="Pagination.Item";P.Button.displayName="Pagination.Button";const i=P,f=k;try{i.displayName="Pagination",i.__docgenInfo={description:"",displayName:"Pagination",props:{"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
