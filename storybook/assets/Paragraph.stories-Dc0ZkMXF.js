import{j as e}from"./iframe-DLmt7OJT.js";import{P as a}from"./index-CB8JedzC.js";import"./preload-helper-u0ftyAaf.js";import"./tooltip-ChEB5Za3.js";import"./index-YoGTWfrN.js";import"./index-gwsQKT5p.js";const{expect:o,within:k}=__STORYBOOK_MODULE_TEST__,E={title:"Components/Paragraph",component:a,tags:["autodocs"],argTypes:{"data-size":{control:"select",options:["xs","sm","md","lg","xl"],description:"Text size"},variant:{control:"select",options:["default","long"],description:"Variant tuned for short or long-form text"}}},t={args:{children:"Røde Kors hjelper mennesker i sårbare livssituasjoner — lokalt, nasjonalt og internasjonalt."}},s={render:()=>e.jsxs(e.Fragment,{children:[e.jsx(a,{"data-size":"xs",children:"Ekstra liten tekst"}),e.jsx(a,{"data-size":"sm",children:"Liten tekst"}),e.jsx(a,{"data-size":"md",children:"Medium tekst"}),e.jsx(a,{"data-size":"lg",children:"Stor tekst"})]})},r={name:"Test: Renders Text",args:{children:"Avsnittstekst","data-size":"md"},play:async({canvasElement:u})=>{const n=k(u).getByText("Avsnittstekst");o(n).toBeInTheDocument(),o(n.tagName).toBe("P")}};var i,c,p;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
