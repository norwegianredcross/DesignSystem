import{r as p,j as e}from"./iframe-eEhiF2zd.js";import{c as m}from"./lite-DaUVFjkg.js";const u=p.forwardRef(function({children:o,className:d,...c},l){return e.jsx("a",{className:m("ds-skip-link",d),...c,ref:l,children:o})}),r=u;try{r.displayName="SkipLink",r.__docgenInfo={description:"",displayName:"SkipLink",props:{"data-size":{defaultValue:null,description:"Changes size for descendant Designsystemet components. Select from predefined sizes.",name:"data-size",required:!1,type:{name:"Size"}},"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
