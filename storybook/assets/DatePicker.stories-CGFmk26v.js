...
`}try{D.displayName="DatePicker",D.__docgenInfo={description:`DatePicker-komponent for å velge en dato fra en kalender.
...
PageUp/PageDown mellom måneder.`,displayName:"DatePicker",props:{}}}catch{}const St=({title:e,...t})=>s.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",viewBox:"0 0 24 24",fill:"none","aria-hidden":e?void 0:!0,focusable:"false",...t,children:[e&&s.jsx("title",{children:e}),s.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M9 2.25C9.41421 2.25 9.75 2.58579 9.75 3V4.25H14.25V3C14.25 2.58579 14.5858 2.25 15 2.25C15.4142 2.25 15.75 2.58579 15.75 3V4.25H19.5C20.1904 4.25 20.75 4.80964 20.75 5.5V18.5C20.75 19.1904 20.1904 19.75 19.5 19.75H4.5C3.80964 19.75 3.25 19.1904 3.25 18.5V5.5C3.25 4.80964 3.80964 4.25 4.5 4.25H8.25V3C8.25 2.58579 8.58579 2.25 9 2.25ZM15.75 7C15.75 7.41421 15.4142 7.75 15 7.75C14.5858 7.75 14.25 7.41421 14.25 7V5.75H9.75V7C9.75 7.41421 9.41421 7.75 9 7.75C8.58579 7.75 8.25 7.41421 8.25 7V5.75H4.75V9.25H19.25V5.75H15.75V7ZM4.75 18.25V10.75H19.25V18.25H4.75ZM6.75 13C6.75 12.5858 7.08579 12.25 7.5 12.25H8.5C8.91421 12.25 9.25 12.5858 9.25 13C9.25 13.4142 8.91421 13.75 8.5 13.75H7.5C7.08579 13.75 6.75 13.4142 6.75 13ZM10.75 13C10.75 12.5858 11.0858 12.25 11.5 12.25H12.5C12.9142 12.25 13.25 12.5858 13.25 13C13.25 13.4142 12.9142 13.75 12.5 13.75H11.5C11.0858 13.75 10.75 13.4142 10.75 13ZM15.5 12.25C15.0858 12.25 14.75 12.5858 14.75 13C14.75 13.4142 15.0858 13.75 15.5 13.75H16.5C16.9142 13.75 17.25 13.4142 17.25 13C17.25 12.5858 16.9142 12.25 16.5 12.25H15.5ZM10.75 16C10.75 15.5858 11.0858 15.25 11.5 15.25H12.5C12.9142 15.25 13.25 15.5858 13.25 16C13.25 16.4142 12.9142 16.75 12.5 16.75H11.5C11.0858 16.75 10.75 16.4142 10.75 16ZM15.5 15.25C15.0858 15.25 14.75 15.5858 14.75 16C14.75 16.4142 15.0858 16.75 15.5 16.75H16.5C16.9142 16.75 17.25 16.4142 17.25 16C17.25 15.5858 16.9142 15.25 16.5 15.25H15.5ZM6.75 16C6.75 15.5858 7.08579 15.25 7.5 15.25H8.5C8.91421 15.25 9.25 15.5858 9.25 16C9.25 16.4142 8.91421 16.75 8.5 16.75H7.5C7.08579 16.75 6.75 16.4142 6.75 16Z",fill:"currentColor"})]});St.displayName="CalendarIcon";const{action:H}=__STORYBOOK_MODULE_ACTIONS__,{expect:l,within:V,userEvent:S,fn:ge}=__STORYBOOK_MODULE_TEST__,ln={title:"Components/DatePicker",component:D,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{initialDate:{control:{type:"date"},description:"Initial month to display in the calendar."},selectedDate:{control:{type:"date"},description:"The currently selected date (primarily for standalone calendar stories)."},onDateSelect:{action:"dateSelected",description:"Callback function when a date is selected in the calendar."},"data-size":{control:"select",options:["sm","md","lg"],description:"Component size",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Color scheme",defaultValue:"neutral"}}},Z={name:"Calendar Only (Default)",render:e=>{const[t,a]=m.useState(e.selectedDate||null),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date,selectedDate:null,onDateSelect:H("dateSelected")}},J={name:"Calendar Only (Selected)",render:e=>{const[t,a]=m.useState(e.selectedDate||new Date),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date(2026,5,15),selectedDate:new Date(2026,5,15),onDateSelect:H("dateSelected")}},ee={name:"Calendar Only (Previous Month)",render:e=>{const[t,a]=m.useState(e.selectedDate||null),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:ma(new Date),selectedDate:null,onDateSelect:H("dateSelected")}},te={name:"Calendar Only (Custom Size/Color)",render:e=>{const[t,a]=m.useState(e.selectedDate||new Date),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date,selectedDate:new Date,"data-size":"lg","data-color":"additional-color-ocean",onDateSelect:H("dateSelected")}},dn=e=>{const[t,a]=m.useState(e.selectedDate&&O(e.selectedDate)?e.selectedDate:null),[n,r]=m.useState(t?k(t,"dd.MM.yyyy",{locale:U}):""),o=u=>{a(u),H("dateSelected (Calendar)")(u)},h=(u,w)=>{r(w);const y=Xt(w,"dd.MM.yyyy",new Date,{locale:U});O(y)&&w.length===10?(!t||!le(y,t))&&(a(y),H("inputParsedAndDateSelected (Input)")(y)):w===""&&t!==null&&(a(null),H("inputCleared (Input)")())};m.useEffect(()=>{const u=t?k(t,"dd.MM.yyyy",{locale:U}):"";u!==n&&r(u)},[t,n]);const g=t?k(t,"PPP",{locale:U}):"Ingen dato valgt";return s.jsxs("div",{style:{display:"inline-block",fontFamily:"sans-serif"},children:[s.jsxs("p",{style:{marginBottom:"10px",fontSize:"14px",minHeight:"20px"},children:["Valgt dato: ",s.jsx("strong",{children:g})]}),s.jsx("div",{style:{marginBottom:"10px"},children:s.jsx(Kt,{"aria-label":"Velg dato (dd.mm.åååå)",value:n,onChange:h,placeholder:"dd.mm.åååå",suffixIcon:s.jsx(St,{}),"data-size":e["data-size"],"data-color":e["data-color"]})}),s.jsx(D,{...e,selectedDate:t,onDateSelect:o,initialDate:t||e.initialDate||new Date})]})},ae={name:"Example Combined Input + Calendar",render:e=>s.jsx(dn,{...e}),args:{initialDate:new Date},argTypes:{initialDate:{control:{type:"date"}},selectedDate:{table:{disable:!0}},onDateSelect:{table:{disable:!0}},"data-size":{control:"select",options:["sm","md","lg"]},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"]}}},A={name:"Test: Date Selection",render:e=>{const[t,a]=m.useState(null),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date(2025,0,15),onDateSelect:ge()},play:async({canvasElement:e,args:t})=>{const n=V(e).getByRole("gridcell",{name:"15. januar 2025"});await S.click(n),l(t.onDateSelect).toHaveBeenCalled(),l(n).toHaveAttribute("aria-selected","true")}},I={name:"Test: Grid Semantics",render:e=>s.jsx(D,{...e}),args:{initialDate:new Date(2025,0,15)},play:async({canvasElement:e})=>{const t=V(e),a=t.getByRole("grid",{name:/januar 2025/i});l(a).toBeInTheDocument(),l(t.getAllByRole("columnheader").length).toBe(7),l(t.getAllByRole("row").length).toBe(6);const n=a.querySelectorAll('[tabindex="0"]');l(n.length).toBe(1),l(n[0]).toHaveAccessibleName("15. januar 2025");const r=a.querySelectorAll('[aria-disabled="true"]');l(r.length).toBeGreaterThan(0),r.forEach(o=>{l(o).not.toHaveAttribute("tabindex")})}},W={name:"Test: Arrow Key Navigation",render:e=>{const[t,a]=m.useState(null),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date(2025,0,15),onDateSelect:ge()},play:async({canvasElement:e,args:t})=>{const a=V(e),n=e.ownerDocument,r=()=>{var h;return(h=n.activeElement)==null?void 0:h.getAttribute("data-date")};a.getByRole("gridcell",{name:"15. januar 2025"}).focus(),await S.keyboard("{ArrowRight}"),l(r()).toBe("2025-01-16"),await S.keyboard("{ArrowDown}"),l(r()).toBe("2025-01-23"),await S.keyboard("{ArrowLeft}"),l(r()).toBe("2025-01-22"),await S.keyboard("{ArrowUp}"),l(r()).toBe("2025-01-15"),a.getByRole("gridcell",{name:"31. januar 2025"}).focus(),await S.keyboard("{ArrowRight}"),l(r()).toBe("2025-02-01"),l(a.getByRole("grid",{name:/februar 2025/i})).toBeInTheDocument(),await S.keyboard("{PageDown}"),l(r()).toBe("2025-03-01"),await S.keyboard("{Enter}"),l(t.onDateSelect).toHaveBeenCalled();const o=t.onDateSelect.mock.lastCall[0];l(o.getFullYear()).toBe(2025),l(o.getMonth()).toBe(2),l(o.getDate()).toBe(1)}},Y={name:"Test: Month Navigation",render:e=>{const[t,a]=m.useState(null);return s.jsx(D,{...e,selectedDate:t,onDateSelect:a})},args:{initialDate:new Date(2025,5,15)},play:async({canvasElement:e})=>{const t=V(e),a=()=>{const o=e.querySelector('[class*="monthYear"]');return(o==null?void 0:o.textContent)||""};l(a()).toContain("2025"),l(a().toLowerCase()).toContain("juni");const n=t.getByRole("button",{name:/neste/i});await S.click(n),l(a().toLowerCase()).toContain("juli");const r=t.getByRole("button",{name:/forrige/i});await S.click(r),await S.click(r),l(a().toLowerCase()).toContain("mai")}},q={name:"Test: Space Selection",render:e=>{const[t,a]=m.useState(null),n=r=>{var o;a(r),(o=e.onDateSelect)==null||o.call(e,r)};return s.jsx(D,{...e,selectedDate:t,onDateSelect:n})},args:{initialDate:new Date(2025,0,15),onDateSelect:ge()},play:async({canvasElement:e,args:t})=>{const n=V(e).getByRole("gridcell",{name:"10. januar 2025"});n.focus(),await S.keyboard(" "),l(t.onDateSelect).toHaveBeenCalled(),l(n).toHaveAttribute("aria-selected","true")}},F={name:"Test: Today Highlight",render:e=>{const[t,a]=m.useState(null);return s.jsx(D,{...e,selectedDate:t,onDateSelect:a})},args:{initialDate:new Date},play:async({canvasElement:e})=>{var n;const t=e.querySelectorAll('[aria-current="date"]');l(t.length).toBe(1);const a=t[0];l((n=a.textContent)==null?void 0:n.trim()).toBe(new Date().getDate().toString()),l(a).not.toHaveAttribute("aria-disabled")}},un=()=>{const{setLanguage:e}=Ht();return s.jsx("button",{type:"button",onClick:()=>e("EN"),children:"Switch to English"})},ne={name:"Test: Follows UI Language",render:e=>s.jsxs(Ot,{children:[s.jsx(un,{}),s.jsx(D,{...e})]}),args:{initialDate:new Date(2025,0,15)},play:async({canvasElement:e})=>{const t=V(e);l(t.getByRole("grid",{name:/januar 2025/i})).toBeInTheDocument(),l(t.getAllByRole("columnheader")[0]).toHaveTextContent(/^Ma/),await S.click(t.getByRole("button",{name:"Switch to English"}));const a=await t.findByRole("grid",{name:/january 2025/i});l(a).toBeInTheDocument(),l(t.getByRole("gridcell",{name:"15 January 2025"})).toBeInTheDocument(),l(t.getAllByRole("columnheader")[0]).toHaveTextContent(/^Mo/)}};var Ce,ke,Me;Z.parameters={...Z.parameters,docs:{...(Ce=Z.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
...
}`,...(Me=(ke=Z.parameters)==null?void 0:ke.docs)==null?void 0:Me.source}}};var Be,Ee,Pe;J.parameters={...J.parameters,docs:{...(Be=J.parameters)==null?void 0:Be.docs,source:{originalSource:`{
...
}`,...(Pe=(Ee=J.parameters)==null?void 0:Ee.docs)==null?void 0:Pe.source}}};var Te,je,Oe;ee.parameters={...ee.parameters,docs:{...(Te=ee.parameters)==null?void 0:Te.docs,source:{originalSource:`{
...
}`,...(Le=(ze=ae.parameters)==null?void 0:ze.docs)==null?void 0:Le.source}}};var Ae,Ie,We,Ye,qe;A.parameters={...A.parameters,docs:{...(Ae=A.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
...
}`,...(We=(Ie=A.parameters)==null?void 0:Ie.docs)==null?void 0:We.source},description:{story:`Tests that clicking a date cell triggers the onDateSelect callback
and visually marks the date as selected.`,...(qe=(Ye=A.parameters)==null?void 0:Ye.docs)==null?void 0:qe.description}}};var Fe,$e,Ve,Ge,Qe;I.parameters={...I.parameters,docs:{...(Fe=I.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
...
}`,...(Ve=($e=I.parameters)==null?void 0:$e.docs)==null?void 0:Ve.source},description:{story:`The calendar follows the ARIA grid pattern: one grid labelled by the
month header, 7 column headers, a single tab stop (roving tabindex),
and out-of-month cells disabled in every modality.`,...(Qe=(Ge=I.parameters)==null?void 0:Ge.docs)==null?void 0:Qe.description}}};var Ke,Xe,Ue,Ze,Je;W.parameters={...W.parameters,docs:{...(Ke=W.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
...
}`,...(Ue=(Xe=W.parameters)==null?void 0:Xe.docs)==null?void 0:Ue.source},description:{story:`Arrow keys move focus between days, End jumps to the end of the week,
PageDown moves a month ahead (the view follows), and Enter selects the
focused day.`,...(Je=(Ze=W.parameters)==null?void 0:Ze.docs)==null?void 0:Je.description}}};var et,tt,at,nt,rt;Y.parameters={...Y.parameters,docs:{...(et=Y.parameters)==null?void 0:et.docs,source:{originalSource:`{
