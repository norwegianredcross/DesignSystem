import{j as b}from"./iframe-C7Cua5rS.js";import{A as v}from"./index-CEW2ddQh.js";const x="/DesignSystem/storybook/assets/person2-CvwgDb6X.jpg",f={title:"Components/Avatar",component:v,tags:["autodocs"],argTypes:{"aria-label":{control:"text",description:"The name of the person the avatar represents.",defaultValue:"Ola Nordmann"},variant:{control:"select",options:["circle","square"],description:"The shape of the avatar.",defaultValue:"circle"},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral"],description:"Color variant.",defaultValue:"accent"},"data-size":{control:"select",options:["xs","sm","md","lg"],description:"Size of the avatar.",defaultValue:"md"},initials:{control:"text",description:"Initials to display inside the avatar."},children:{control:"text",description:"Image, icon or initials to display inside the avatar."}}},a={name:"Example Default",args:{"aria-label":"Ola Nordmann"}},e={name:"Example with Initials",args:{"aria-label":"Ola Nordmann",children:"ON"}},r={name:"Example with Image",args:{"aria-label":"Ola Nordmann",children:b.jsx("img",{src:x,alt:"",style:{width:"100%",height:"100%",objectFit:"cover"}})}},t={name:"Example Square",args:{"aria-label":"Ola Nordmann",variant:"square",children:"ON"}};var n,s,o;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  name: 'Example Default',
  args: {
    'aria-label': 'Ola Nordmann'
  }
}`,...(o=(s=a.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};var l,i,c;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
