import{r as re,j as e}from"./iframe-DtUUsz2V.js";import{T as B}from"./index-Cs0Ed6Gf.js";import{D as ae}from"./divider-DW566pQM.js";import{P as te}from"./paragraph-K2zLUaXX.js";import{B as ne}from"./button-0vAQLlQA.js";const le={title:"Components/Textfield",component:B,tags:["autodocs"],parameters:{docs:{description:{component:"Textfield is a composed component for text input or textarea, including label, description, validation, affixes, and counter."}},layout:"padded"},argTypes:{label:{control:"text",description:"Label for the textfield (use this OR aria-label)",defaultValue:"Label"},disabled:{control:"boolean",description:"Disables the textfield",defaultValue:!1},readOnly:{control:"boolean",description:"Makes the textfield read-only",defaultValue:!1},multiline:{control:"boolean",description:"Renders a Textarea instead of Input",defaultValue:!1},description:{control:"text",description:"Description displayed below the label"},error:{control:"text",description:"Error message displayed below the input"},counter:{control:"number",description:"Enables character counter with optional limit"},prefix:{control:"text",description:"Prefix displayed before the input"},suffix:{control:"text",description:"Suffix displayed after the input"},"aria-label":{control:"text",if:{arg:"label",exists:!1}},"aria-labelledby":{control:"text"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},type:{control:"select",options:["text","number","email","password","search","tel","url","date","datetime-local","month","week","time","color","file","hidden"],description:"Input type (ignored if multiline is true)",defaultValue:"text",if:{arg:"multiline",eq:!1}},size:{control:"number",description:"HTML size attribute (input width in characters)",if:{arg:"multiline",eq:!1}},rows:{control:"number",description:"HTML rows attribute (textarea height in lines)",if:{arg:"multiline",eq:!0}},value:{control:"text",table:{disable:!0}},defaultValue:{control:"text"},name:{control:"text"},placeholder:{control:"text"},required:{control:"boolean"},maxLength:{control:"number"},id:{control:"text"},"aria-invalid":{control:"boolean"},"aria-describedby":{control:"text"}}},r={args:{label:"Navn",name:"name-default",placeholder:"Skriv inn navnet ditt"}},a={args:{label:"Beskrivelse",name:"description-multiline",multiline:!0,rows:4,placeholder:"Skriv en lengre beskrivelse..."}},t={args:{label:"Hvor mange kroner koster det per måned?",name:"cost-affix",prefix:"NOK",suffix:"pr. mnd",type:"number"},name:"With Prefix/Suffix"},n={args:{label:"Melding (maks 100 tegn)",name:"message-counter",multiline:!0,rows:3,counter:100,maxLength:100},name:"With Character Counter"},l={args:{label:"E-post",name:"email-desc",description:"Vi sender en bekreftelse til denne adressen.",type:"email"}},i={args:{label:"Telefonnummer *",name:"phone-error",error:"Telefonnummer kan kun inneholde siffer.",required:!0,type:"tel","aria-invalid":!0},name:"With Error"},s={args:{label:"Deaktivert felt",name:"disabled-field",disabled:!0,defaultValue:"Kan ikke endres"}},o={args:{label:"Kun lesbart felt",name:"readonly-field",readOnly:!0,defaultValue:"Denne verdien er satt."}},d={render:H=>{const[c,u]=re.useState(""),{name:_,"data-size":I,placeholder:N,required:A,disabled:J,readOnly:F,multiline:G,maxLength:Q,counter:U,prefix:X,suffix:Y,error:Z,description:$}=H;return e.jsxs(e.Fragment,{children:[e.jsx(B,{label:"Kontroller meg!",value:c,onChange:ee=>u(ee.target.value),name:_,"data-size":I,placeholder:N,required:A,disabled:J,readOnly:F,multiline:G,maxLength:Q,counter:U,prefix:X,suffix:Y,error:Z,description:$}),e.jsx(ae,{style:{margin:"var(--ds-size-4) 0 var(--ds-size-2) 0"}}),e.jsxs(te,{style:{margin:"0"},children:["Du har skrevet inn: ",c||"(ingenting)"]}),e.jsx(ne,{onClick:()=>u("Kake"),style:{marginTop:"var(--ds-size-2)"},children:"Jeg vil ha Kake"})]})},args:{name:"controlled-field",placeholder:"Skriv noe...","data-size":"md"}};var m,p,f;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(b=(x=a.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var h,v,y;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(v=t.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var k,S,T;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(T=(S=n.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var D,z,C;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    label: 'E-post',
    name: 'email-desc',
...
}`,...(C=(z=l.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};var E,V,O;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    label: 'Telefonnummer *',
    name: 'phone-error',
  ...
  name: 'With Error'
}`,...(O=(V=i.parameters)==null?void 0:V.docs)==null?void 0:O.source}}};var W,L,w;s.parameters={...s.parameters,docs:{...(W=s.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
...
}`,...(w=(L=s.parameters)==null?void 0:L.docs)==null?void 0:w.source}}};var K,M,P;o.parameters={...o.parameters,docs:{...(K=o.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
...
}`,...(P=(M=o.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};var q,j,R;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: args => {
...
}`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.source}}};const ie=["Default","Multiline","WithAffixes","WithCounter","WithDescription","WithError","Disabled","ReadOnly","Controlled"],me=Object.freeze(Object.defineProperty({__proto__:null,Controlled:d,Default:r,Disabled:s,Multiline:a,ReadOnly:o,WithAffixes:t,WithCounter:n,WithDescription:l,WithError:i,__namedExportsOrder:ie,default:le},Symbol.toStringTag,{value:"Module"}));export{d as C,s as D,a as M,o as R,me as T,t as W,n as a,l as b,i as c};
