import{r as S,j as e}from"./iframe-ChmhbHcN.js";import{S as t}from"./index-C-QHkFeK.js";import{F as P,c as R}from"./tooltip-Dtx4fO_9.js";const{expect:p,within:q,userEvent:m,waitFor:H}=__STORYBOOK_MODULE_TEST__,K={title:"Components/Search",component:t,tags:["autodocs"],parameters:{docs:{description:{component:"Search allows users to find content using keywords. It consists of an input field, optionally with clear and search buttons."}}},argTypes:{"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},"data-color":{control:"select",options:["primary-color-red","secondary-color-orange","secondary-color-rust","secondary-color-pink","additional-color-ocean","additional-color-jungle","neutral"],description:"Changes color for descendant Designsystemet components.",defaultValue:"neutral"},children:{control:!1},placeholder:{control:"text",description:"Placeholder text for the Search.Input field",defaultValue:"Søk...",table:{category:"Story Controls"}},label:{control:"text",description:"External label text (used with Label component)",table:{category:"Story Controls"}},buttonVariant:{control:"select",options:["primary","secondary","tertiary"],description:"Variant for the Search.Button",defaultValue:"primary",table:{category:"Story Controls"}},showClearButton:{control:"boolean",description:"Show the Search.Clear button",defaultValue:!0,table:{category:"Story Controls"}},showSearchButton:{control:"boolean",description:"Show the Search.Button",defaultValue:!0,table:{category:"Story Controls"}}}},l={render:a=>e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:a.placeholder}),a.showClearButton&&e.jsx(t.Clear,{}),a.showSearchButton&&e.jsx(t.Button,{variant:a.buttonVariant})]}),args:{placeholder:"Søk her...",buttonVariant:"primary",showClearButton:!0,showSearchButton:!0,"data-size":"md","data-color":"neutral"}},s={render:a=>e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:a.placeholder}),a.showClearButton&&e.jsx(t.Clear,{})]}),args:{placeholder:"Søk med ikon...",showClearButton:!0,showSearchButton:!1,"data-size":"md","data-color":"neutral"},name:"Without Button"},c={render:a=>e.jsxs(P,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(R,{id:"search-with-label-label",htmlFor:"search-with-label",children:a.label}),e.jsxs(t,{children:[e.jsx(t.Input,{id:"search-with-label","aria-labelledby":"search-with-label-label",placeholder:a.placeholder}),a.showClearButton&&e.jsx(t.Clear,{}),a.showSearchButton&&e.jsx(t.Button,{variant:a.buttonVariant})]})]}),args:{label:"Søk etter katter",placeholder:"f.eks. Norsk skogkatt",buttonVariant:"secondary",showClearButton:!0,showSearchButton:!0,"data-size":"md","data-color":"neutral"},name:"With Label"},i={render:a=>{const[r,n]=S.useState("Jeg vil ha Pizza");return e.jsxs("div",{style:{width:"300px"},children:[e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Kontrollert søk",placeholder:a.placeholder,value:r,onChange:o=>n(o.target.value)}),a.showClearButton&&e.jsx(t.Clear,{onClick:()=>n("")}),a.showSearchButton&&e.jsx(t.Button,{variant:a.buttonVariant,onClick:()=>alert(`Searching for: ${r}`)})]}),e.jsxs("p",{style:{marginTop:"8px",fontSize:"0.8em"},children:["Du har skrevet inn: ",r]})]})},args:{placeholder:"Skriv her...",buttonVariant:"primary",showClearButton:!0,showSearchButton:!0,"data-size":"md","data-color":"neutral"}},d={render:a=>{const[r,n]=S.useState("");return e.jsxs("form",{onSubmit:o=>{o.preventDefault();const O=new FormData(o.currentTarget);n(O.get("search-term"))},style:{width:"300px"},children:[e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Skjemasøk",placeholder:a.placeholder,name:"search-term"}),a.showClearButton&&e.jsx(t.Clear,{}),a.showSearchButton&&e.jsx(t.Button,{variant:a.buttonVariant})]}),r&&e.jsxs("p",{style:{marginTop:"8px",fontSize:"0.8em"},children:["Submitted value: ",r]})]})},args:{placeholder:"Søk i skjema...",buttonVariant:"primary",showClearButton:!0,showSearchButton:!0,"data-size":"md","data-color":"neutral"},name:"Within Form"},u={render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",width:320},children:[e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:"Primær knapp"}),e.jsx(t.Clear,{}),e.jsx(t.Button,{variant:"primary"})]}),e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:"Sekundær knapp"}),e.jsx(t.Clear,{}),e.jsx(t.Button,{variant:"secondary"})]}),e.jsxs(t,{"data-size":a["data-size"],"data-color":a["data-color"],children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:"Tertiær knapp"}),e.jsx(t.Clear,{}),e.jsx(t.Button,{variant:"tertiary"})]})]}),args:{"data-size":"md","data-color":"neutral"}},h={name:"Test: Interaction",render:()=>{const[a,r]=S.useState("");return e.jsxs(t,{"data-size":"md","data-sr-clear":"Fjern søketekst",children:[e.jsx(t.Input,{"aria-label":"Søk",placeholder:"Søk her...",value:a,onChange:n=>r(n.target.value)}),e.jsx(t.Clear,{"aria-label":"Fjern søketekst",onClick:()=>r("")}),e.jsx(t.Button,{variant:"primary"})]})},play:async({canvasElement:a})=>{const r=q(a),n=r.getByRole("searchbox",{name:/søk/i});p(n).toBeInTheDocument(),await m.type(n,"test query"),p(n).toHaveValue("test query");const o=r.getByRole("button",{name:"Fjern søketekst"});await m.click(o),await H(()=>{p(n).toHaveValue("")})}},J=["Default","WithoutButton","WithLabel","Controlled","WithinForm","Variants","TestInteraction"];var b,x,g;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(g=(x=l.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};var k,w,B;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => <Search data-size={args['data-size']} data-color={args['data-color']}>
      <Search.Input aria-label="Søk" placeholder={args.placeholder} />
      {args.showClearButton && <Search.Clear />}
    </Search>,
  ...
  name: 'Without Button'
}`,...(B=(w=s.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};var y,C,j;c.parameters={...c.parameters,docs:{...(y=c.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...
  name: 'With Label'
}`,...(j=(C=c.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};var v,z,V;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => {
...
}`,...(V=(z=i.parameters)==null?void 0:z.docs)==null?void 0:V.source}}};var f,F,I;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
  ...
  name: 'Within Form'
}`,...(I=(F=d.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var T,D,E;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...(E=(D=u.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var W,_,L;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: 'Test: Interaction',
  render: () => {
    const [value, setValue] = useState('');
    return <Search data-size="md" data-sr-clear="Fjern søketekst">
...
}`,...(L=(_=h.parameters)==null?void 0:_.docs)==null?void 0:L.source}}};const $=Object.freeze(Object.defineProperty({__proto__:null,Controlled:i,Default:l,TestInteraction:h,Variants:u,WithLabel:c,WithinForm:d,WithoutButton:s,__namedExportsOrder:J,default:K},Symbol.toStringTag,{value:"Module"}));export{i as C,l as D,$ as S,s as W,c as a,d as b};
