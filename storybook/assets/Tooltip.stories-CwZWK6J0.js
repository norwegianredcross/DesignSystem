import{j as t}from"./iframe-D-CvsFF9.js";import{T as n}from"./index-B6ELJcrF.js";import{B as a}from"./tooltip-VS67X2YO.js";const{expect:r,within:A,userEvent:d}=__STORYBOOK_MODULE_TEST__,E={title:"Components/Tooltip",component:n,tags:["autodocs"],parameters:{docs:{description:{component:"Tooltip displays brief information on hover or focus, often explaining icons or providing secondary details."}},layout:"centered"},argTypes:{content:{control:"text",description:"Content displayed inside the tooltip.",defaultValue:"Tooltip text"},placement:{control:"select",options:["top","right","bottom","left"],description:"Placement of the tooltip relative to the trigger.",defaultValue:"top"},"data-size":{control:"select",options:["sm","md","lg"],description:"Changes size for descendant Designsystemet components.",defaultValue:"md"},children:{control:"text",description:"The trigger element (string or React element).",defaultValue:"My trigger (string)"},open:{control:"boolean",description:"Manually controls the open state (overrides internal state).",table:{disable:!0}}}},i={render:e=>t.jsx(n,{...e,children:e.children}),args:{content:"This tooltip explains the trigger text.",children:"Hover or focus me (string)",placement:"top"},name:"String Trigger"},s={render:e=>t.jsx(n,{...e,children:t.jsx(a,{children:"My trigger (button)"})}),args:{content:"This tooltip is triggered by the button.",placement:"bottom"},name:"Button Trigger"},c={render:e=>t.jsxs("div",{style:{display:"flex",gap:"20px",padding:"40px"},children:[t.jsx(n,{...e,placement:"top",content:"Top Tooltip",children:t.jsx(a,{children:"Top"})}),t.jsx(n,{...e,placement:"bottom",content:"Bottom Tooltip",children:t.jsx(a,{children:"Bottom"})}),t.jsx(n,{...e,placement:"left",content:"Left Tooltip",children:t.jsx(a,{children:"Left"})}),t.jsx(n,{...e,placement:"right",content:"Right Tooltip",children:t.jsx(a,{children:"Right"})})]}),args:{content:"Tooltip content"},argTypes:{placement:{control:!1},children:{control:!1}}},l={name:"Test: Interaction",render:()=>t.jsx(n,{content:"Tooltip message",children:t.jsx(a,{children:"Hover me"})}),play:async({canvasElement:e})=>{const o=A(e).getByRole("button",{name:"Hover me"});r(o).toHaveAccessibleDescription("Tooltip message"),r(o).toHaveAttribute("data-tooltip","Tooltip message")}},p={name:"Test: Keyboard Focus Contract",render:()=>t.jsxs(t.Fragment,{children:[t.jsx(a,{children:"Før"}),t.jsx(n,{content:"Forklaring av lagring",placement:"bottom",autoPlacement:!1,children:t.jsx(a,{children:"Lagre"})})]}),play:async({canvasElement:e})=>{const g=A(e),o=g.getByRole("button",{name:"Lagre"});await d.tab(),r(g.getByRole("button",{name:"Før"})).toHaveFocus(),await d.tab(),r(o).toHaveFocus(),r(o).toHaveAccessibleDescription("Forklaring av lagring"),r(o).toHaveAttribute("data-tooltip","Forklaring av lagring"),r(o).toHaveAttribute("data-placement","bottom"),r(o).toHaveAttribute("data-autoplacement","false")}},_=["DefaultStringTrigger","ButtonTrigger","Placements","TestInteraction","TestKeyboardFocusContract"];var m,u,T;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
