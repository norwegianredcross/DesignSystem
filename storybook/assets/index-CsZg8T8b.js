import{r as i,j as d}from"./iframe-BPQh94wS.js";const b="_crossCorner_1caiu_1",C="_shape_1caiu_6",a={crossCorner:b,shape:C};function y(e){return`
.${e.crossCorner} {
...
Velg fra forhåndsdefinerte farger og farger definert med theme.designsystemet.no.`,name:"data-color",required:!1,type:{name:"Color"}},position:{defaultValue:{value:"top-left"},description:"Which corner the graphic points to.",name:"position",required:!1,type:{name:"enum",value:[{value:'"top-right"'},{value:'"top-left"'},{value:'"bottom-right"'},{value:'"bottom-left"'}]}},size:{defaultValue:{value:"md"},description:`Size of the graphic.
