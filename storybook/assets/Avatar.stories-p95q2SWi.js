import{j as b}from"./iframe-iYGyT3PB.js";import{A as v}from"./index-DvMoqBGZ.js";const f=""+new URL("person2-CvwgDb6X.jpg",import.meta.url).href,x={title:"Components/Avatar",component:v,tags:["autodocs"],argTypes:{"aria-label":{control:"text",description:"The name of the person the avatar represents.",defaultValue:"Ola Nordmann"},variant:{control:"select",options:["circle","square"],description:"The shape of the avatar.",defaultValue:"circle"},"data-color":{control:"select",options:["accent","brand1","brand2","brand3","neutral"],description:"Color variant.",defaultValue:"accent"},"data-size":{control:"select",options:["xs","sm","md","lg"],description:"Size of the avatar.",defaultValue:"md"},initials:{control:"text",description:"Initials to display inside the avatar."},children:{control:"text",description:"Image, icon or initials to display inside the avatar."}}},a={name:"Example Default",args:{"aria-label":"Ola Nordmann"}},e={name:"Example with Initials",args:{"aria-label":"Ola Nordmann",children:"ON"}},r={name:"Example with Image",args:{"aria-label":"Ola Nordmann",children:b.jsx("img",{src:f,alt:"",style:{width:"100%",height:"100%",objectFit:"cover"}})}},t={name:"Example Square",args:{"aria-label":"Ola Nordmann",variant:"square",children:"ON"}};var n,o,s;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
