import{r as i,j as e}from"./iframe-BcmQD90_.js";import{c as W}from"./lite-DaUVFjkg.js";import{R as $,a as K}from"./roving-focus-item-CgXA4ZjU.js";import{B as L}from"./button-BuWqsItz.js";import{T as I}from"./index-BgUbn0sI.js";import{S as Y,a as J,b as Q,c as X,d as Z,e as ee}from"./Paperplane-C5hLTeLs.js";import{S as te}from"./EnvelopeClosed-BHiYlAXW.js";import{D as oe}from"./divider-DbC1XlRS.js";import{P as ae}from"./paragraph-D3Li0xZn.js";const P=i.createContext({}),re=i.forwardRef(function({children:r,variant:n="primary",value:o,defaultValue:l,onChange:s,name:d,className:f,...h},U){const q=i.useId(),M=o!==void 0,[N,H]=i.useState(l);let k=s;return M||(k=T=>{H(T),s==null||s(T)},o=N),e.jsx(P.Provider,{value:{variant:n,value:o,defaultValue:l,name:d??`togglegroup-name-${q}`,onChange:k},children:e.jsx($,{asChild:!0,activeValue:o,orientation:"ambiguous",children:e.jsxs("div",{className:W("ds-toggle-group",f),role:"radiogroup","data-variant":n,ref:U,...h,children:[d&&e.jsx("input",{type:"hidden",name:d,value:o}),r]})})})}),ne=a=>{const{...r}=a,n=i.useId(),o=i.useContext(P),l=a.value??n,s=o.value===l,d=o.variant,f=`togglegroup-item-${i.useId()}`;return{...r,active:s,value:l,variant:d,buttonProps:{id:f,"aria-checked":s,"aria-current":s,role:"radio",name:o.name,onClick:()=>{var h;(h=o.onChange)==null||h.call(o,l)}}}},le=i.forwardRef(function(r,n){const{active:o,buttonProps:l,value:s,variant:d}=ne(r);return e.jsx(K,{asChild:!0,value:s,children:e.jsx(L,{variant:o?d:"tertiary",ref:n,...r,...l})})}),F=Object.assign(re,{Item:le});F.Item.displayName="ToggleGroup.Item";const t=F;try{t.displayName="ToggleGroup",t.__docgenInfo={description:"",displayName:"ToggleGroup",props:{"data-color":{defaultValue:null,description:`Changes color for descendant Designsystemet components.
