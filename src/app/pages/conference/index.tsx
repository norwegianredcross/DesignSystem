// src/pages/Conference/index.tsx
"use client";
...
import conferenceHeroImage from "../../assets/imageconference.png";
import cardImageConf1 from "../../assets/Image1.png";
import cardImageConf2 from "../../assets/Image2.png";
import cardImageConf3 from "../../assets/Image3.png";

const conferenceNavLinks = [
  { id: "booking", href: "#", label: "Booking" },
  { id: "lokalene", href: "#", label: "Lokalene" },
  { id: "priser", href: "#", label: "Priser" },
  { id: "meny", href: "#", label: "Meny og servering" },
  { id: "miljo", href: "#", label: "Miljøtiltak" },
  { id: "kontakt", href: "#", label: "Kontakt oss" },
  { id: "home", href: "/", label: "Hjem" },
];
...
const ConferencePage: React.FC = () => {
  console.log("[Client] ConferencePage rendering...");

  const handleBookingClick = () => {
    alert("Book nå button clicked!");
  };
  ...
  return (
    <div>
      <Header
        logo={logoSvg}
        links={conferenceNavLinks}
        variant="conference"
      />

      <div className={styles.heroContainer}>
        <Image
          src={conferenceHeroImage}
          alt="Moderne konferanserom med utsikt over byen"
          width={1920}
          height={960}
          style={{
            width: "100%",
      ...
      <main className={styles.contentContainer}>
        <h1 className={styles.headingXl}>
          Velkommen til Røde Kors konferansesenter - midt i hjertet av Oslo
        </h1>
        <h2 className={styles.headingLg}>Våre lokaler</h2>

        <div className={`${styles.cardRowContainer} ${styles.imageCardRow}`}>
          <Card
            asChild
            data-color="neutral"
            variant="tinted"
          ...
          >
            <a
              href="/conference/lokalene/henry-dunant"
            ...
            >
              <CardBlock style={{ padding: 0 }}>
                <div className={styles.cardImageWrapper}>
                  <Image
                    src={cardImageConf1}
                    alt="Henry Dunant-salen konferanserom"
                    fill
              ...
              <CardBlock>
                <>
                  <Tag data-color="neutral">200 personer</Tag>
                  <h3 className="ds-heading--sm">Henry Dunant-salen</h3>
                </>
              </CardBlock>
            </a>
          </Card>
          ...
          >
            <a
              href="/conference/lokalene/noytralitet"
              rel="noopener noreferrer"
            >
              <CardBlock style={{ padding: 0 }}>
                <div className={styles.cardImageWrapper}>
              ...
              <CardBlock>
                <>
                  <Tag data-color="neutral">40 personer</Tag>
                  <h3 className="ds-heading--xs">Nøytralitet</h3>
                </>
              </CardBlock>
            </a>
          </Card>
          ...
          >
            <a
              href="/conference/lokalene/frivillighet"
              rel="noopener noreferrer"
            >
              <CardBlock style={{ padding: 0 }}>
                <div className={styles.cardImageWrapper}>
              ...
              <CardBlock>
                <>
                  <Tag data-color="neutral">24 personer</Tag>
                  <h3 className="ds-heading--xs">Frivillighet</h3>
                </>
              </CardBlock>
            </a>
          </Card>
        ...
        <h2 className={styles.headingLg}>Nyttig informasjon</h2>
        ...
        <div className={styles.cardRowContainer}>
          ...
          >
            <a href="/conference/meny" target="_blank" rel="noopener noreferrer">
              <CardBlock>
                <h3 className="ds-heading--xs">Meny og servering</h3>
                <p>
          ...
          >
            <a
              href="/conference/priser"
              target="_blank"
              rel="noopener noreferrer"
            >
              <CardBlock>
                <h3 className="ds-heading--xs">Priser og betingelser</h3>
                <p>
                  Most provide as with carried business are much better more the
                  perfected designer. Writing slightly explain desk unable at
                  supposedly about this
          ...
          >
            <a
              href="/conference/kontakt"
              target="_blank"
              rel="noopener noreferrer"
            >
              <CardBlock>
                <h3 className="ds-heading--xs">Kontakt oss</h3>
                <p>
                  Most provide as with carried business are much better more the
                  perfected designer. Writing slightly explain desk unable at
                  supposedly about this
