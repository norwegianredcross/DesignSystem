...
<Canvas of={DialogStories.ProgrammaticRef} />
...
<Canvas of={DialogStories.CloseOnBackdrop} />
...
<Canvas of={DialogStories.DefaultTrigger} />
...
{/* Denne seksjonen er fjernet for å stoppe krasjen. 
  De andre filene dine (Checkbox, Breadcrumbs) bruker en 
  statisk liste her, ikke den importerte CssVariables-komponenten.
*/}